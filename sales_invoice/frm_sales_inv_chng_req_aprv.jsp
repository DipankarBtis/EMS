...
function refresh()
{
	...
	var url = "../sales_invoice/frm_sales_inv_chng_req_aprv.jsp?&u="+u+"&month="+month+"&year="+year;
...
sales_inv.setCallFlag("SALES_INVOICE_CHANGE_REQUEST_APPROVAL");
...
Vector VACTION_FLAG = sales_inv.getVACTION_FLAG();
Vector VSEQ_NO = sales_inv.getVSEQ_NO();
Vector VREMAINING_DAYS = sales_inv.getVREMAINING_DAYS();
Vector VCOUNT = sales_inv.getVCOUNT();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	Sales Invoice Change Request/Approval
					    </div>
					</div>
				</div>
														...
														<div class="table-responsive">
															...
															<thead id="tbsearch<%=j%>">
																<tr>
																	...
																	<th class="tbser<%=j%>" rowspan="2"><%if(heading.equals("LP_HEAD")) {%>Contract Period<%}else{%>Billing Period<%} %></th>
...
<input type="hidden" name="option" value="SALES_INVOICE_CHANGE_ACTION">
...
<input type="hidden" name="segment" value="RLNG">
