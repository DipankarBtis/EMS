...
function enableNewValues(obj)
{
	...
	if(obj.value=="IMB")
	{
		if(obj.checked)
		{
			...
			document.getElementById("imb_tr2").style.display="";
		}
		else
		{
										...
										<tbody>
											...
											<tr style="display: none;" id="imb_tr1">
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="imb_qty" value="<%=imb_qty%>" readOnly>
											...
											<tr style="display: none;" id="imb_tr2">
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="imb_amt" value="<%=imb_amt%>" 
											...
											<tr style="display: none;" id="ovrun_tr1">
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="ovrun_qty" value="<%=ovrun_qty%>" readOnly>
															<span class="input-group-text">MMBTU</span>
														</div>
													</div>
												</td>
											...
											<tr style="display: none;" id="ovrun_tr2">
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="ovrun_amt" value="<%=ovrun_amt%>" 
															onblur="negNumber(this);checkNumber1(this,12,2);imbShipCalc();" readOnly>
															<span class="input-group-text"><%=invoice_raised_in_nm%></span>
														</div>
													</div>
											...
											<tr style="display: none;" id="ship_tr1">
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="ship_or_pay_qty" value="<%=ship_or_pay_qty%>" readOnly>
															<span class="input-group-text">MMBTU</span>
														</div>
													</div>
												</td>
											...
											<tr style="display: none;" id="ship_tr2">
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="ship_or_pay_amt" value="<%=ship_or_pay_amt%>" 
															onblur="negNumber(this);checkNumber1(this,12,2);imbShipCalc();" readOnly>
															<span class="input-group-text"><%=invoice_raised_in_nm%></span>
														</div>
													</div>
											...
											<tr>
												...
												<td align="center">
													<div style="width:200px;">
														...
														<input type="hidden" class="form-control form-control-sm" name="gross_include_transport_tariff" value="<%=gross_include_transport_tariff %>" readOnly>
													</div>
												</td>
											</tr>
											<tr>
											      	...
											      	<%}else{ %>
											      		<div class="form-group row">
											      			<div class="col-sm-12 col-xs-12 col-md-12">	
			    												<div class="col-12">
																	<div class="input-group input-group-sm" >
												      					<input class="form-control form-control-sm" style="background:#99ffcc;" value="<%=att_file_name%>">
													      				<span class="input-group-text" <%if(!operation.equals("PREPARE")) {%>style="pointer-events: auto;"<%} %>>
																			<a href="<%=annexure_path+"/"+owner_cd+"_"+financial_year+"_"+bu_state_tin+"_"+invoice_seq+"/"+att_file_name%>" download>
																				<font color="black"><i class="fa fa-download fa-lg"></i></font>
																			</a>
																		</span>
																		<span class="input-group-text"><i class="fa fa-trash-o fa-lg" style="color:red;" onclick="doDeleteAnnexure('<%=att_file_name%>','<%=owner_cd+"_"+financial_year+"_"+bu_state_tin+"_"+invoice_seq%>');"></i></span>
													      			</div>
													      		</div>
												      		</div>
											      		</div>
