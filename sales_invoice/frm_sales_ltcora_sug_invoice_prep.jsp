...
function refresh(accroid)
{
	...
	var url = "../sales_invoice/frm_sales_ltcora_sug_invoice_prep.jsp?&u="+u+"&month="+month+"&year="+year+
		...
		temp_period_st_dt,temp_period_end_dt,cargo_no,operation,accroid,inv_flag)
{
	...
	var url = "frm_generate_ltcora_sug_invoice.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+cont_type+"&cont_no="+cont_no+
...
function refershPar(sub_msg,msg_type,accroid)
{
	...
	if(flag)
	{
		var url = "frm_sales_ltcora_sug_invoice_prep.jsp?&u="+u+"&pdf_type="+pdf_type+
...
sales_inv.setCallFlag("LTCORA_SUG_INV_PREPARATION_LIST");
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	LTCORA(Sell) SUG Invoice Generation
					    </div>
					</div>
				</div>
