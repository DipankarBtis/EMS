...
sales_inv.setCallFlag("LP_INVOICE_DETAIL");
...
sales_inv.setExist_financial_year(exist_fin_yr);
sales_inv.setOri_invoice_seq(ori_inv_seq);
...
String ori_inv_dt=sales_inv.getOri_inv_dt();
...
<table border="0" width="100%" align="center" cellpadding="2" cellspacing="0">
	...
	<tr valign="middle">
		<td colspan="7">
			<div align="left">
				<font size="1px" face="Arial">
				<script>document.write(window.opener.document.forms[0].remark1.value.replaceAll("\n","<br>"));</script>
				</font>
			</div>
		</td>
	</tr>
