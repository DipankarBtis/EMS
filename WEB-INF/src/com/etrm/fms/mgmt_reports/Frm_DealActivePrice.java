...
//Status	  		: Developing
@WebServlet("/servlet/Frm_DealActivePrice")
public class Frm_DealActivePrice extends HttpServlet
{
	static String db_src_file_name="Frm_DealActivePrice.java";
	public static  Connection dbcon;

	public static String servletName = "Frm_DealActivePrice";
	...
	private void InsertUpdateContVariablePriceConfigDetail(HttpServletRequest request) throws SQLException
	{
		...
		try
		{
			...
			String price_deci=request.getParameter("price_deci")==null?"1":request.getParameter("price_deci");
			String prem_disc_rate=request.getParameter("prem_disc_rate")==null?"0":request.getParameter("prem_disc_rate");
			...
			String MIN_formula_desc[] = request.getParameterValues("MIN_formula_desc");	// SagarB20260212
...
//							dbcon.commit();
							...
							new_value = "CP="+counterparty_cd+"#CPABBR="+counterparty_abbr+"#CONTNO="+mapped_cont_no+"#SLOPE="+slope+"#CONSTANT="+constant+"#CURVE_NM="+curve_nm[0]+"#VP="+"Y"+"#CONTREFNO="+cont_ref+"#CONT_STATUS="+cont_status+"#PRICE_DECI="+price_deci+"#FINAL_PRICE_DECI="+final_price_deci+"#PREM_DISC_RATE="+prem_disc_rate;

//							System.out.println(price_deci+"__"+prem_disc_rate+"=="+final_price_deci);
//							System.out.println(new_value);
//							dbcon.commit();
						}
						
						// SagarB20260212
//						else if(opal_min.equals("MIN") || opal_min.equals("MAX") || opal_min.equals("AVG"))
						else if(opal_min.equals("MIN") || opal_min.equals("MAX") || opal_min.equals("AVG") || opal_min.equals("MIN_ADV"))
						{
							...
							if(curve_nm != null && Min_slope != null && Min_constant != null)
							{
								...
								for(int i=0; i<curve_nm.length;i++)
								{
									...
									stmt2.setString(16, Min_price_deci[i]);
									//	stmt1.setString(22, final_price_deci);
									stmt2.setString(17, Min_prem_disc_rate[i]);
									stmt2.setString(18, MIN_formula_desc[i]);	// SagarB20260212
									stmt2.executeUpdate();
							...
							new_value = "CP="+counterparty_cd+"#CPABBR="+counterparty_abbr+"#CONTNO="+mapped_cont_no+"#SLOPE="+new_Min_slope+"#CONSTANT="+new_Min_constant+"#CURVE_NM="+new_curve_nm+"#VP="+"Y"+"#CONTREFNO="+cont_ref+"#CONT_STATUS="+cont_status+"#PRICE_DECI="+price_deci+"#FINAL_PRICE_DECI="+final_price_deci+"#PREM_DISC_RATE="+prem_disc_rate;
						}
					}
				}
			}
...
//					else if(opal_min.equals("MIN") || opal_min.equals("MAX") || opal_min.equals("AVG"))
					else if(opal_min.equals("MIN") || opal_min.equals("MAX") || opal_min.equals("AVG") || opal_min.equals("MIN_ADV"))
					{
						...
						stmt1.setString(22, final_price_deci);
						stmt1.setString(23, prem_disc_rate);
						stmt1.setString(24, formula_desc);	// SagarB20260212
						stmt1.executeQuery();
			...
			url = "../mgmt_reports/frm_config_variable_price.jsp?msg="+msg+"&msg_type="+msg_type+"&counterparty_cd="+counterparty_cd+
