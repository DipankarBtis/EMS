...
function refresh(active_status)
{
	...
	var url = "../contract_master/frm_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&agreement_type="+agreement_type;
...
{ 
	...
	if(flag && flg)
	{
		if(trim(from_dt)!="" && trim(to_dt)!="")
		{
			...
			{
			var url = "../contract_master/frm_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+
...
function setValue(countpty_cd,agmt_no,agmt_rev_no,agmt_type)
{
	window.opener.setContDetail(countpty_cd,agmt_no,agmt_rev_no,agmt_type);
	window.close();	
}
</script>
</head>
