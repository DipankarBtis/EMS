...
function refresh(active_status)
{
	...
	var url = "../contract_master/frm_contract_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&contract_type="+contract_type+"&clearance="+clearance;
...
function refresh_date()
{
	...
	if(flag && flg)
	{
		if(trim(from_dt)!="" && trim(to_dt)!="")
		{
			...
			{
			var url = "../contract_master/frm_contract_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&contract_type="+contract_type+
...
contract.setCallFlag("CONTRACT_LIST");
if(fcc_flag!=null && fcc_flag.equals("Y"))
{
	contract.setCallFlag("CONTRACT_LIST_FCC");
}
