...
function refresh()
{
	...
	var url = "frm_dlng_cont_reopen_req.jsp?u="+u+
...
var newWindow;
function doSubmit(counterpty_cd,agmtNo,agmtRev,contNo,contRev,contract_type,cont_map,approval_type,tcq_sign,tcq,rate,rate_unit,var_tcq,counterparty_abbr,clsr_dt,clsr_nt)
{
	...
	//+"&end_dt="+end_dt+"&use_flag="+use_flag+"&start_dt="+start_dt+"&closure_eff_dt="+clsr_eff_dt.value+"&closure_note="+closure_note.value;
...
contract.setCallFlag("DLNG_CONT_REOPEN_REQUEST");
