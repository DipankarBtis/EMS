								...
								<table class="table table-bordered" id="example">
									<thead>
										<tr valign="top">
											...
											<!-- <th>Contract Name</th> -->
											<th>Status<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_Status" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div></th>
