...
function fcc(fcc_flg)
{
	...
	if(flag)
	{
		...
		if(a)
		{
			...
			document.getElementById("loading").style.visibility = "visible";
			document.forms[0].option.value="DLNG_CONT_FCC"
			document.forms[0].submit();
		}
	}
	else
...
%>
<body style="pointer-events: none;"  onload="setValues('<%=strTransCd%>','<%=strTrans%>','<%=strPlant%>','<%=strBuPlant%>','<%=strPlantChrg%>','<%=strGxBuPlant%>','<%=strFillStaCd%>','<%=strFillStaAbbr%>');liabilityShows();billingShows();messurmentShows();off_spec_gasShows();terminatorShows();">
				...
				<div class="card-body cdbody">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<select class="form-select form-select-sm" name="counterparty_cd" style="pointer-events: auto;" onchange="refresh('<%=opration%>','<%=clearance%>');">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4"> 
				    		...
				    		<%}else{ %>
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    		<%} %>
				    				<select class="form-select form-select-sm" name="contract_type" style="pointer-events: auto;" onchange="refresh('<%=opration%>','<%=clearance%>');" <%if(opration.equals("MODIFY") && (!cont_no.equals("0") && !cont_no.equals(""))){ %>style="pointer-events: none;"<%} %>>
					...
					<div class="row m-b-5" <%if(!opration.equals("MODIFY")){ %>style="display:none;"<%} %>>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
				    			...
				    			<div class="col">
				    				<input type="button" name="security_btn" class="btn btn-sm config_btn" style="pointer-events: auto;" value="Security Config" onclick="securityPreReceipt('<%=contract_type%>','<%=agmt_no%>','<%=agmt_rev_no%>','<%=cont_no%>','<%=cont_rev_no%>');">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">								
				    			<div class="col">
				    				<input type="button" name="credit_exceed_btn" class="btn btn-sm config_btn" value="Credit Exceed Config" style="pointer-events: auto;" onclick="creditExceedDaysConfig('<%=contract_type%>','<%=agmt_no%>','<%=agmt_rev_no%>','<%=cont_no%>','<%=cont_rev_no%>');">
				  				</div>				  				
				  			</div>
						</div>
					</div>
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4"> 
							<div class="form-group row">
				    			...
				    			<div class="col">
				    				<input type="button" class="btn btn-sm config_btn" value="Variable Price Config" style="pointer-events: auto;" onclick="variablePriceConfig('<%=contract_type%>','<%=agmt_no%>','<%=agmt_rev_no%>','<%=cont_no%>','<%=cont_rev_no%>','<%=cont_ref_no%>','<%=cont_status%>');">
				  				</div>
				  				<%} %>
				  			</div> 
						</div>
					...
					<div class="row m-b-5" <%if((opration.equals("INSERT") || (cont_no.equals("0") || cont_no.equals(""))) || !is_allocated.equals("Y")){%>style="display:none;"<%} %>>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			...
				    			<div class="col-auto">
				    				<input type="button" class="btn btn-sm request_btn" value="TCQ Change Request" onclick="" <%if(!fcc_flg.equals("Y")){%>disabled<%} %>>
				    			</div>
				  			</div>
						</div>						
					</div>
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
				    			...
				    			<%if(opration.equals("MODIFY")){ %>
				    			<div class="col">
				    				<input type="button" class="btn btn-sm config_btn" value="Variable DCQ Config" style="pointer-events: auto;" onclick="variableDCQ('<%=contract_type%>','<%=agmt_no%>','<%=agmt_rev_no%>','<%=cont_no%>','<%=cont_rev_no%>');">
				    			</div>			    		
				    			<%} %>	
				  			</div>
						</div>
				    			...
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<%if(VTRUCK_TRANS_CD.size() > 0) {%>
					    				<%for(int i=0; i<VTRUCK_TRANS_CD.size(); i++){ %>
					    					<input type="checkbox" class="form-check-input" name="chk_truck_trans" value="<%=VTRUCK_TRANS_CD.elementAt(i)%>">&nbsp;<%=VTRUCK_TRANS_ABBR.elementAt(i)%>&nbsp;&nbsp;
					    				<%}%>
				    				<%}else{ %>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			<div id="liability_div2" class="col-sm-12 col-xs-12 col-md-12">
				    				<input type="button" class="btn btn-sm config_btn" value="Configure Liability" style="pointer-events: auto;" <%if(opration.equals("MODIFY")){ %>onclick="openLiabilityClause();"<%} else {%> disabled <%} %>>&nbsp;
				    				<%if(opration.equals("MODIFY")){ %>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			<div id="billing_flag_div1" class="col-sm-12 col-xs-12 col-md-12">
						      		<input type="button" class="btn btn-sm config_btn" value="Configure Billing" style="pointer-events: auto;" <%if(opration.equals("MODIFY")){ %>onclick="openBillingDtl();"<%} else {%> disabled <%} %>>
				    			</div>
				  			</div>
						</div>
					</div>
						...
						<div class="row m-b-5">
							...
							<div class="col-sm-4 col-xs-4 col-md-4">  
								<div class="form-group row">
					    			...
					    			<%}else{ %>
					    				<input type="radio" name="ff" onclick="fcc('Y');" disabled <%if(fcc_flg.equals("Y")){ %>checked<%} %>>&nbsp;Yes&nbsp;&nbsp;
					    				<input type="radio" name="ff" onclick="fcc('N');" disabled <%if(fcc_flg.equals("N")){ %>checked<%} %>>&nbsp;No
					    			<%} %>
...
<input type="hidden" name="tcq_request_flag" value="<%=tcq_request_flag%>">
<input type="hidden" name="price_change_request_flag" value="<%=price_change_request_flag%>">
