...
contract.setCallFlag("AGREEMENT_BILLING_DTL");
...
String disp_agmt_no = contract.getDisp_agmt_no();
...
%>
<body onload="setBillingPeriod(document.forms[0].billing_flag);setExchgVal(document.forms[0].exchng_rate);enablechk();setValues('<%=sat_days%>');showDispState();setPlantState('<%=strPlant%>','<%=holiday_state%>');">
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	<%=couterparty_abbr%> [<%=disp_agmt_no%>] Billing Details
					    </div>
					</div>
				</div>
...
<input type="hidden" name="option" value="AGREEMENT_BILLING_DTL">
