								...
								<%	k=0;
									...
									%>				
										<tr>
											...
											<td style="mso-number-format:'\@';"><%= VCONT_REF.elementAt(i) %></td><!--HM20250829 : Added format to the contract ref as Per Vijay's Feedback for IDX Ref. -->
									...
									<%} %>
										<%}else{ %>
											<tr>
												<td colspan="28" align="center"><%=utilmsg.infoMessage("<b>No Contract is Available!</b>") %></td>
											</tr>
									<%} %>		
								</tbody>
							</table>
