...
function refresh()
{
	...
	var url = "frm_dlng_tcq_request.jsp?counterparty_cd="+counterparty_cd+"&u="+u+
...
contract.setCallFlag("DLNG_TCQ_MODIFICATION_REQUEST");
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
						<div class="topheader">
				    		Contract (DLNG) TCQ Modification Request
	   	 				</div>
				    </div>
				</div>
