...
%>
<body style="pointer-events: none;" onload="setBillingPeriod(document.forms[0].billing_flag);setBillingDays(document.forms[0].freq);setExchgVal(document.forms[0].exchng_rate);enablechk();setValues('<%=sat_days%>');showDispState();setPlantState('<%=strPlant%>','<%=holiday_state%>');">
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    <%=couterparty_abbr%> [<%=display_map_id%>] 
					     Billing Details
