...
function refresh_rpt(msg,msg_type)
{
	...
	var url = "rpt_seller_nomination_to_customer.jsp?gas_dt="+gas_dt+"&contract_type="+mst_contract_type+"&msg="+msg+"&msg_type="+msg_type+"&u="+u;
...
function printAllPDF()
{
	...
	if(flag==true)
	{
		url = "rpt_view_seller_nomination_to_customer.jsp?gas_dt="+gas_dt+"&contract_type="+all_contract_type+
...
function sendAllMail()
{
	...
	if(flag==true)
	{
		...
		if(a)
		{
			url = "frm_seller_nom_to_cust_send_mail.jsp?gas_dt="+gas_dt+"&contract_type="+all_contract_type+
			"&counterparty_cd="+all_counterparty_cd+"&agmt_no="+all_agmt_no+"&cont_no="+all_cont_no+"&plant_seq="+all_plant_seq+	
							...
							<table class="table table-bordered table-hover" id="filterbysearch">
								<thead>
									<tr>
										...
										<th rowspan="2">Contract Type<div align="center"><input class="form-control form-control-sm" type="text" id="cont_type" onkeyup="Search(this,'2');" placeholder="Search.." style="width:100px"/></div></th>
										<th rowspan="2">Contract#<br>[Contract/Trade Ref#]<div align="center"><input class="form-control form-control-sm" type="text" id="contract" onkeyup="Search(this,'3');" placeholder="Search.." style="width:100px"/></div></th>
										<th rowspan="2">Plant Name<div align="center"><input class="form-control form-control-sm" type="text" id="plant_nm" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div></th>
									...
									%>
										<tr>
											...
											<td align="center">
												...
												<%}else{ %>
												<input type="button" class="btn btn-warning btn-sm com-btn" value="Submit" disabled>
												<%} %>
											</td>
											<td align="center">
