...
function exportToXls()
{
    ...
    var filename = owner_abbr+"_"+"Customer Allocation (By Contract And Plant)- "+from_dt+"To"+to_dt+".xls";
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
						<div class="topheader">
				    		Customer Allocation (By Contract And Plant)
	   	 				</div>
	   	 				<div>
				  			...
				  			<div class="col">
								...
								<script>
								    <% if(agmt_no != null && !agmt_no.equals("")) { %>
									   document.forms[0].deal_no.value="<%=agmt_no%>:<%=cont_no%>:<%=cont_type%>:<%=cargo_no%>"
									<% } %>
								</script>
				  			</div>
				  		</div>
