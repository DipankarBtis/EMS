...
function openContList()
{
	...
	if(flag)
	{
		...
		{
			newWindow = window.open("frm_dlng_fcc_cont_list.jsp?counterparty_cd="+counterparty_cd+"&clearance="+clearance+"&contract_type="+contract_type,"Supply Contract List","top=10,left=10,width=1100,height=600,scrollbars=1");
		}
		else
		{
			newWindow.close();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	DLNG SN/LOA/IGX (Finance Check & Control)
					    </div>
					</div>
				</div>
