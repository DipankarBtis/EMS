...
String file_nm="SellerNomination_RevisionWise_"+gas_dt.replaceAll("/", "")+".xls";
%>
<body>
<%
...
<tr>
	<td align="left" colspan="14">
		<font size="4"><b>Seller Nomination Revision Wise - Gas Day <%=gas_dt%></b></font>
	</td>
</tr>
	...
	%>
		...
		if(index > 0){ %>
			...
			%>
				...
				<tr>
					<td colspan="14"><b><%=VTRANSPORTER_ABBR.elementAt(i)%>&nbsp;-&nbsp;<%=VTRANSPORTER_PLANT_ABBR.elementAt(j)%></b></td>
				</tr>
				<tr>
					...
					<th rowspan="2">DCQ</th>
					<th rowspan="2">Buyer Nomination (Rev)(MMBTU)</th>
...
<%}else{ %>
	<tr>
		<td colspan="13">
			<div align="center">
			<b>No Seller Nomination Done for Selected Gas Day!</b>
			</div>
		</td>
	</tr>
<%} %>
