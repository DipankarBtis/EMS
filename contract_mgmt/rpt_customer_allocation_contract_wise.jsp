...
Vector VTOTAL_MMBTU = cont_mgmt.getVTOTAL_MMBTU();
Vector VTOTAL_SCM = cont_mgmt.getVTOTAL_SCM();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    ...
					    <a href="../contract_mgmt/xls_customer_allocation_contract_wise.jsp?fileName=Customer Allocation Contract Wise <%=sysdate %>.xls&segmentType=<%=segmentType%>&counterparty_cd=<%=counterparty_cd %>&from_dt=<%=from_dt%>&to_dt=<%=to_dt %>&sysdate=<%=sysdate%>&buplant_abbr=<%=sel_bu_plant_abbr%>&sel_bu_plant=<%=sel_bu_plant %>" download="Incident Tracker">
								...
								<%}%>
									<tr>
										...
										<%for(int i=0; i<VSTART_DT.size(); i++){ %>
											...
											<td align="right"><b><%=VTOTAL_SCM.elementAt(i) %></b></td>
										<%} %>
									</tr>
								</tbody>
							</table>
