...
String buplant_abbr=request.getParameter("buplant_abbr")==null?"":request.getParameter("buplant_abbr");//RG20250922 for adding BU filter
String owner_cd="";
...
<table  width="100%" border="1">
	<tr>
		<th nowrap="nowrap" style="font-size: 21" colspan="<%=x %>" rowspan="" align="left">Customer Allocation - Contract Wise (Generated For <%=from_dt%> To <%=to_dt%>) <%if(!sel_bu_plant.equals("0") && (!sel_bu_plant.equals(""))) {%> For Business Unit: <%=buplant_abbr%><%} %></th>
	</tr>
	<tr></tr>
</table>
<%} %>
