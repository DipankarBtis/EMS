																		...
																		<tr>
																			...
																			<td align="center">
																				<div style="width:100px;">
																					...
																					<%-- onpaste="doPaste('<%=j%>','<%=l%>');"  --%>
																					onblur="negNumber(this);checkNumber1(this,9,2);checkQty('<%=l%>');checkTCQ('<%=l%>');calculateSCM('<%=j%>','<%=l%>');totalQty();" disabled>
																			...
																			%>
																				<tr>
																					<td>
																						...
																						onclick="setSubEnableDisabled(this,'<%=l%>','<%=q%>');calculateSCM('<%=j%>','<%=l%>');totalSubQty('<%=l%>');checkSubQty('<%=l%>','<%=q%>');checkTCQ('<%=l%>');totalQty();" disabled>
																					...
																					<td align="center">
																						<div style="width:100px;">
																							...
																							onblur="negNumber(this);checkNumber1(this,9,2);calculateSCM('<%=j%>','<%=l%>');totalSubQty('<%=l%>');checkSubQty('<%=l%>','<%=q%>');checkTCQ('<%=l%>');totalQty();" disabled>
																						</div>
																					</td>
																					<td align="center">
																						<div style="width:100px;">
