...
function refresh()
{
	...
	var url = "rpt_buyer_nom_revision_wise.jsp?gas_dt="+gas_dt+"&u="+u;
...
function exportToXls()
{
	...
	var url = "xls_buyer_nom_revision_wise.jsp?gas_dt="+gas_dt;
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	Daily Buyer Nomination (Revision Wise)
					    </div>
					    <div>
