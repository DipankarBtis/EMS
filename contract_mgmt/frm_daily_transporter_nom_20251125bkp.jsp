																	...
																	%>
																		<tr>
																			<td align="center" valign="middle">
																				<input type="checkbox" class="form-check-input" name="chk" onclick="setEnableDisabled(this,'<%=l%>');calculateSCM('<%=l%>');totalQty();" <%if(VIS_GTC.elementAt(l).toString().equals("0")){ %>style="pointer-events: none;"<%} %>>
																			</td>
																			<td align="center">
