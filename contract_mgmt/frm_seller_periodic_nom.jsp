		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="card cardmain">
				...
				<%if(!counterparty_cd.equals("") && !counterparty_cd.equals("0")){ %>
																			...
																			%>
																				<tr>
																					...
																					<td align="right">
																						...
																						<input type="hidden" name="is_allocation" id="is_allocation_<%=l%>" value="<%=VIS_ALLOCATION_DONE.elementAt(l)%>" disabled>
																					</td>
																					<td align="right">
																					...
																					%>
																						<tr>
																							<td>
																								...
																								onclick="setSubEnableDisabled(this,'<%=l%>','<%=q%>');calculateSCM('<%=j%>','<%=l%>');totalSubQty('<%=l%>');checkSubQty('<%=l%>','<%=q%>');" disabled>
																							...
																							<td align="center">
																								<div style="width:100px;">
																									...
																									onblur="negNumber(this);checkNumber1(this,9,2);calculateSCM('<%=j%>','<%=l%>');totalSubQty('<%=l%>');checkSubQty('<%=l%>','<%=q%>');" disabled>
																									<%-- checkTCQ('<%=l%>'); --%>
																								</div>
																							</td>
																							<td align="center">
					...
					<div class="card-body cdbody">
						<div align="center">
							<%=utilmsg.infoMessage("<b>Buyer Nomination is Pending!</b>")%>
						</div>
					</div>
					<%} %>
				<%}else{ %>
