...
function refresh(flag)
{
	...
	var u = document.forms[0].u.value;
		...
		var url = "rpt_sectorwise_sale.jsp?year="+year+"&rd_val="+rd_val+"&bu_seq="+bu_seq+"&bu_abbr="+bu_abbr+"&u="+u;		// SagarB20250922 Added this variable for showing BU list
...
String bu_abbr=request.getParameter("bu_abbr")==null?"0":request.getParameter("bu_abbr");	// SagarB20250922 Added this variable for showing BU ABBR
...
//SagarB20250922 Added this Vectors for showing BU list
Vector VBU_PLANT_SEQ = sector.getVBU_PLANT_SEQ();
Vector VBU_PLANT_ABBR = sector.getVBU_PLANT_ABBR();
				...
				<div class="card cardmain">
					<div class="card-header cdheader">
						<div class="d-flex justify-content-between">
						    ...
						    <a href="../contract_mgmt/xls_sectorwise_sales.jsp?fileName=SectorWise Sales Report.xls&company_cd=<%=comp_cd %>&year=<%=year %>&rd_val=<%=rd_val %>&bu_seq=<%= bu_seq %>&bu_abbr=<%= bu_abbr %>" download="SectorWise Sales Report.xls" >			<!--  SagarB20250922 Added this variable for showing BU list -->
						...
						<div class="row m-b-5">
							<div class="col-sm-3 col-sm-3 col-xs-3">  
								<!-- <div class="d-flex justify-content-between"> -->
									<div class="form-group row">
										...
										<div class="col">
											<select class="form-select form-select-sm" name="year" id="year" > <!--  onchange="refresh(document.forms[0].rd.value);"> -->		<!-- SagarB20250925 Removed onchange function -->
							...
							<div class="col-sm-3 col-sm-3 col-xs-3"> 
								<div class="form-group row">
									<div class="col-auto">
										&nbsp;&nbsp;&nbsp;
										<input type="radio" name="rd" value="Q" <%if(rd_val.equals("Q")){ %> checked="checked" <%} %>  >
										<label class="form-label"><b>Quaterly</b></label>
										&nbsp;&nbsp;&nbsp;
										<input type="radio" name="rd" value="M" <%if(rd_val.equals("M")){ %> checked="checked" <%} %>  >
										<label class="form-label"><b>Monthly</b> </label> 	
									</div>
								</div>
							</div>								
							<div class="col-sm-3 col-sm-3 col-xs-3"> 
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<div class="form-group row">	
									<div class="col-auto">
										<input type="button" class="btn btn-warning com-btn" value="Apply Filters" onclick="refresh(document.forms[0].rd.value);">
						  			</div>
								</div>
							</div>
						</div>
