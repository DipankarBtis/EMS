...
{
	cont_mgmt.setCallFlag("VIEW_SELLER_NOMINATION_TO_CUSTOMER");
...
HashMap view_seller_nomination_to_customer_data = cont_mgmt.getView_seller_nomination_to_customer_data();
HashMap view_seller_nomination_to_customer_info = cont_mgmt.getView_seller_nomination_to_customer_info();
...
<table width="80%" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<td colspan="6"><div align="right"><font size=2.5 face="Arial"><b>Seq No:</b>&nbsp;<%=view_seller_nomination_to_customer_info.get("seq_no")%></font></div></td>	
	</tr>
	<tr>
...
<table width="80%" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<td colspan="6"><div align="center"><font size=2.5 face="Arial"><u><b>Subject:</b>&nbsp;
			Seller Nomination for <%=view_seller_nomination_to_customer_info.get("customer_abbr")%>
...
<table width="80%" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<td colspan="6"><div align="left"><font size=2.5 face="Arial">
...
<table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<td colspan="6" style="background: #c2d1f0;"><div align="center"><font size="3px" face="Arial"><b>SELLER NOMINATION&nbsp;(<%=owner_abbr%> - <%=view_seller_nomination_to_customer_info.get("customer_abbr")%>&nbsp;:&nbsp;<%=view_seller_nomination_to_customer_info.get("plant_nm")%>)</b></font></div></td>
	</tr>
</table>
<br>
<table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0">	
	<tr valign="bottom">
		<td><div align="center"><font size="2.5px" face="Arial"><b>Gas Day</b></font></div></td>
		<td><div align="center"><font size="2.5px" face="Arial"><b>Delivery Point</b></font></div></td>
		<td><div align="center"><font size="2.5px" face="Arial"><b>Seller Nominated MMBTU</b></font></div></td>
	</tr>
	<%
	if(view_seller_nomination_to_customer_data.containsKey("v_gas_dt"))
	{
	    ...
	    <% }%>
	    <tr>
	    	<td align="right" colspan="2"><font size="2.5px" face="Arial"><b>Total</b></font></td>
	    	<td>
				<div align="right">
...
<%
	...
	response.setHeader("content-Disposition","inline; filename=Seller_NominationToCustomer_"+gas_dt.replaceAll("/", "")+".xls");
%>
<table>
	<tr>
		<td colspan="15">
...
pdfFile.setCallFlag("PDF_SELLER_NOMINATION_TO_CUSTOMER");
...
for(int i=0;i<all_counterparty_cd.length;i++)
{
	...
	cont_mgmt.setAgmt_no(all_agmt_no[i]);
	cont_mgmt.setCont_no(all_cont_no[i]);
	...
	cont_mgmt.setCargo_no(all_cargo_no[i]);
	cont_mgmt.init();
	
	view_seller_nomination_to_customer_data = cont_mgmt.getView_seller_nomination_to_customer_data();
	view_seller_nomination_to_customer_info = cont_mgmt.getView_seller_nomination_to_customer_info();
	HttpServletRequest req = request;
