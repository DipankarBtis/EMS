...
function refresh()
{
	...
	if(flag)
	{
		var url = "rpt_allocation_transfer.jsp?&u="+u+"&from_dt="+from_dt+"&to_dt="+to_dt;
...
function exportToXls()
{
	...
	var url = "xls_allocation_transfer.jsp?fileName="+comp_abbr+"Allocation Transfer Report "+sysdate+".xls&from_dt="+from_dt.value+"&to_dt="+to_dt.value;
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="card cardmain">
				...
				<div class="card-body cdbody">
					<div class="row ">
						<div align="center"><%=utilmsg.infoMessage("<b>Note: Negative value indicates MMBTU returned to Cargo!</b>") %></div>
   					</div>
   				</div>
			</div>
		</div>
