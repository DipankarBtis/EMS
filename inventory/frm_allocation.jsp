								...
								<%if(VCONT_NO.size()>0){ %>
									<%for(int i=0; i<VCOUNTERPARTY_CD.size(); i++){ %>
										...
										<tr>
											...
											<td rowspan="<%=rowspan%>"><%=VCONTRACT_TYPE_NM.elementAt(i) %></td>
											<%} %>
											<td align="center" style="background:#e6e6e6;">
												<%-- <%=VSEL_TRADER_ABBR.elementAt(j)%> --%>
												<%=VSEL_TRADER_NM.elementAt(j)%>
											</td>
											<td align="center" style="background:#e6e6e6;">
											...
											<td align="center" style="background:#e6e6e6;">
												<div style="width:120px;">
													<input type="text" size="10" name="dis_sel_cont_type<%=i%>" id="dis_sel_cont_type<%=i%>_<%=j%>" class="form-control form-control-sm" value="<%=VSEL_CONT_TYPE_NM.elementAt(j) %>"  readOnly>
												</div>
											</td>
											<td align="center" style="background:#e6e6e6;">
