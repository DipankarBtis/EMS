...
derv_inv.setCallFlag("SEND_CRDR_DERV_INVOICE_MAIL");
...
derv_inv.setMail_pdf_type(mail_pdf_type);
derv_inv.setInv_type(invoice_type);
derv_inv.setCrdr_type(crdr_type);
derv_inv.init();

Vector VMAIL_PDF_TYPE = derv_inv.getVMAIL_PDF_TYPE();
Vector VMAIL_PDF_TYPE_NM = derv_inv.getVMAIL_PDF_TYPE_NM();
Vector VMAIL_FROM_LIST = derv_inv.getVMAIL_FROM_LIST();
Vector VMAIL_TO_LIST = derv_inv.getVMAIL_TO_LIST();
Vector VMAIL_CC_LIST = derv_inv.getVMAIL_CC_LIST();
Vector VMAIL_BCC_LIST = derv_inv.getVMAIL_BCC_LIST();
Vector VMAIL_SUBJECT = derv_inv.getVMAIL_SUBJECT();
Vector VMAIL_ATTACHMENT = derv_inv.getVMAIL_ATTACHMENT();
Vector VMAIL_ATTACHMENT_PATH = derv_inv.getVMAIL_ATTACHMENT_PATH();
Vector VMAIL_BODY = derv_inv.getVMAIL_BODY();
Vector VMAIL_ANNEXURE_ATTACHMENT_PATH = derv_inv.getVMAIL_ANNEXURE_ATTACHMENT_PATH();
Vector VMAIL_ANNEXURE_ATTACHMENT_FLAG = derv_inv.getVMAIL_ANNEXURE_ATTACHMENT_FLAG();
...
{
	path="/"+CommonVariable.work_dir+owner_cd+"/"+CommonVariable.derv_remittance_path;
}
else
{
	path="/"+CommonVariable.work_dir+owner_cd+"/"+CommonVariable.signed_derv_inv_path;
}
											...
											<div class="col">
												<div class="row">
													<div class="col-12">
														...
														<input type="hidden" class="form-control" size="100" name="pdf_type" id="pdf_type<%=i%>" readonly="readonly" style="background-color: white;" value="<%=VMAIL_PDF_TYPE.elementAt(i)%>" >
													</div>
													<div class="col-12">
														<div class="input-group mb-1">				
...
<input type="hidden" name="option" value="SEND_CRDR_DERV_INVOICE_MAIL">
...
<input type="hidden" name="mail_inv_type" value="<%=mail_pdf_type%>">
