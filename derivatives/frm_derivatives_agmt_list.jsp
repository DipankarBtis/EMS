...
function refresh(active_status)
{
	...
	var url = "../derivatives/frm_derivatives_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&agreement_type="+agreement_type;
...
function refresh_date()
{
	...
	if(flag && flg)
	{
		if(trim(from_dt)!="" && trim(to_dt)!="")
		{
			...
			{
			var url = "../derivatives/frm_derivatives_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+
...
<jsp:useBean class="com.etrm.fms.derivatives.DataBean_Derivarives_mst" id="db_derivatives" scope="request"></jsp:useBean>
...
db_derivatives.setActive_status(active_status);
db_derivatives.setFrom_dt(from_dt);
db_derivatives.setTo_dt(to_dt);
db_derivatives.init();
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="card cardmain">
				<div class="card-header cdheader">
					 <div class="topheader">
				    	Derivatives Master Agreement List
				    </div>
				</div>
							...
							<table class="table table-bordered ems_sorttbl" id="ems_table0">
								<thead  id="ems_tbsort0">
									<tr valign="top">
										...
										<th class="ems_thsort0">Agreement#</th>
										<th class="ems_thsort0">Agreement Rev#</th>
										<th class="ems_thsort0">Agreement Ref#</th>
										<th class="ems_thsort0">Agreement Name</th>
								...
								<%if(VBUYER_CD.size() > 0){ %>
									...
									<tr>
										<td align="center"><input type="radio"
										 onclick="setValue('<%=VBUYER_CD.elementAt(i) %>','<%=VAGMT_NO.elementAt(i)%>','<%=VAGMT_REV_NO.elementAt(i)%>','<%=agreement_type%>','<%=VAGMT_NAME.elementAt(i) %>')"></td>
