...
function refresh()
{
	...
	if(flag==true)
	{
		var url = "rpt_derv_mtm_accrual.jsp?u="+u+"&report_dt="+report_dt.value;
		if(execute_access=="Y")
		{
...
function exportToXls()
{
	...
	var url = "xls_derv_mtm_accrual.jsp?fileName= Derivatives MTM Report.xls&report_dt="+report_dt;
