...
String taxStructCd =request.getParameter("taxStructCd")==null?"":request.getParameter("taxStructCd");

dbmaster.setCallFlag("CRDR_TAX_STRUCTURE_LIST");
dbmaster.setComp_cd(owner_cd);
dbmaster.setTax_category(type);
dbmaster.setTax_struct_cd(taxStructCd);
