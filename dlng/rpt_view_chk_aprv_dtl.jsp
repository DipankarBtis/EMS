...
dlng_inv.setCallFlag("DLNG_SALES_INVOICE_REPORT");
...
String new_tds_amt=dlng_inv.getNew_tds_amt();
String new_tds_factor =dlng_inv.getNew_tds_factor();
String new_tds_struct_cd =dlng_inv.getNew_tds_struct_cd();
String new_tds_struct_dt=dlng_inv.getNew_tds_struct_dt();
String new_applicable_abbr=dlng_inv.getNew_applicable_abbr();
			...
			<tr valign="middle" <%if(activity_value.equals("Y")) {%>style="display: none;"<%} %>>
				<td>
					<div align="center">
						...
						<br/><br/>
						<div style="display: none;">Refine TDS : <input type="radio" name="tds_rd" value="Y" onClick="enableTDS(this);">&nbsp;<b>Yes</b>&nbsp;&nbsp;&nbsp;&nbsp;
