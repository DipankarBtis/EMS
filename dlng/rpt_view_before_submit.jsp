...
if(sub_tax_struct!=null && sub_tax_struct!=undefined)
{
	if(sub_tax_struct.length!=undefined)
	{
		...
		{
			display+="<tr valign='top'><td><div align='center'><font size='1.5px' face='Arial'></font></div></td><td><div align='right'><font size='1.5px' face='Arial'>"+sub_tax_struct[i].value+"</font></div></td><td><div align='center'><font size='1.5px' face='Arial'><%=invoice_raised_in_nm%></font></div></td><td><div align='right'><font size='1.5px' face='Arial'></font></div></td><td><div align='right'><font size='1.5px' face='Arial'></font></div></td><td><div align='left'><font size='1.5px' face='Arial'>"+sub_tax_amt[i].value+"&nbsp;</font></div></td></tr>";
		}
	}
	else
	{
		...
		<td colspan="7">
			<div align="center">
				<font size="1px" face="Arial">
					...
					<%}else if(contract_type.equals("O")){ %> LTCORA Agreement executed on <%=agmtSigningDt%> & CN (<%=contRef%>) executed on <%=signingDt%>
					<%}else if(contract_type.equals("Q")){ %> LTCORA Agreement executed on <%=agmtSigningDt%>
					<%} %> 
					<br>
			...
			<div align="center">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b><%=owner_abbr%>
								<%if(contract_type.equals("Q") || contract_type.equals("O")) {%> Tax<%} %>
