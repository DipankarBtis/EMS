...
for(int i=0; i<pdf_type.length; i++)
{
	...
	pdfFile.setCallFlag("PDF_DLNG_SVC_INVOICE");
	pdfFile.init();
	
	String file_url = pdfFile.getFile_url();
	file_nm = pdfFile.getFile_nm();
	pdfpath = file_url+"/work_data"+owner_cd+""+CommonVariable.dlng_service_inv_path+""+file_nm;
}
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="ratio ratio-1x1">
							  <iframe src="<%=pdfpath%>" title="DLNG Service Invoice PDF" allowfullscreen width="100%"></iframe>
							</div>
						</div>
					</div>
				</div>
