	...
	if(from_dt!=null && to_dt!=null)
   	{
	   	if(trim(from_dt)!="" && trim(to_dt)!="")
	   	{
         	...
         	{	
				...
				if(value!=1)
				{
					var url = "rpt_dlng_cutomer_allocation.jsp?from_dt="+from_dt+"&to_dt="+to_dt+"&counterparty_cd="+counterparty_cd+"&bu_seq="+bu_seq+"&u="+u;	// SagarB20250922 Added this variable for showing BU list
...
function exportToXls()
{
	...
	var url = "xls_dlng_cutomer_allocation.jsp?from_dt="+from_dt+"&to_dt="+to_dt+"&counterparty_cd="+counterparty_cd+"&bu_seq="+bu_seq+"&bu_abbr="+bu_abbr;		// SagarB20250922 Added bu_seq variable for showing BU list
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="card cardmain">
				...
				<div class="card-body cdbody">
					<div class="row m-b-5">
						<div class="col-sm-3 col-xs-3 col-md-3">  	<!-- SagarB20250926 Changed col-sm-6 col-xs-6 col-md-6 to col-sm-3 col-xs-3 col-md-3  -->
							<div class="form-group row">
								<div class="col-auto">
