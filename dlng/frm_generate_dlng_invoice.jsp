							...
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				      				<select class="form-select form-select-sm" name="driver_cd">
										...
										<option value="<%=VDRIVER_CD.elementAt(i)%>"><%=VDRIVER_NM.elementAt(i) %></option>
										<%} %>
									</select>
									<script>
										document.forms[0].driver_cd.value='<%=linked_driver_cd%>'
									</script>
				    			</div>
				  			</div>
						</div>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
									...
									<script>
										document.forms[0].check_post_cd.value='<%=linked_checkpost_cd%>'
									</script>
				    			</div>
				  			</div>
						</div>
