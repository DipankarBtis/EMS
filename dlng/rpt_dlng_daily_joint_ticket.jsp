...
function refresh()
{
	...
	var url = "rpt_dlng_daily_joint_ticket.jsp?gas_dt="+gas_dt+"&u="+u;
...
function refresh_rpt(msg,msg_type)
{
	...
	var url = "rpt_dlng_daily_joint_ticket.jsp?gas_dt="+gas_dt+"&msg="+msg+"&msg_type="+msg_type+"&u="+u;
...
function viewJT(index,counterparty_cd,contract_type,plant_seq,bu_plant_seq,file,pdf_name)
{
	...
	if(file=="XLS")
	{
		url = "rpt_dlng_view_joint_ticket.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+contract_type+"&plant_seq="+plant_seq+
	...
	else
	{
		if(trim(contact_person_cd)!="")
		{
			...
			if(file=="MAIL")
			{
				url = "frm_dlng_send_mail.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+contract_type+"&plant_seq="+plant_seq+
				"&bu_plant_seq="+bu_plant_seq+"&gas_dt="+gas_dt+"&contact_person_cd="+contact_person_cd+"&file="+file+"&u="+u;
...
function printAllPDF()
{
	...
	if(flag==true)
	{
		url = "rpt_dlng_view_joint_ticket.jsp?gas_dt="+gas_dt+"&contract_type="+all_contract_type+
...
function sendAllMail()
{
	...
	if(flag==true)
	{
		...
		if(a)
		{
			url = "frm_dlng_send_mail.jsp?gas_dt="+gas_dt+"&contract_type="+all_contract_type+
			"&counterparty_cd="+all_counterparty_cd+"&plant_seq="+all_plant_seq+	
			"&contact_person_cd="+all_contact_person_cd+"&file="+file+"&bu_plant_seq="+all_bu_seq+"&u="+u;
...
dlng.setCallFlag("DLNG_JOINT_TICKET");
...
Vector VSELLER_NOM = dlng.getVSELLER_NOM();
							...
							<table class="table table-bordered table-hover" id="filterbysearch">
								<thead>
									<tr>
										...
										<th rowspan="2">Customer Plant<div align="center"><input class="form-control form-control-sm" type="text" id="plant" onkeyup="Search(this,'2');" placeholder="Search.." style="width:100px"/></div></th>
										<th rowspan="2">Business Unit<div align="center"><input class="form-control form-control-sm" type="text" id="bu" onkeyup="Search(this,'3');" placeholder="Search.." style="width:100px"/></div></th>
										<th rowspan="2">Contract Type<div align="center"><input class="form-control form-control-sm" type="text" id="contract_type" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div></th>
