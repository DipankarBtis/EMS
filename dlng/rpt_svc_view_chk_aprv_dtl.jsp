	...
	<tr valign="middle">
		<td colspan="7">
			<div align="center">
				<font size="1px" face="Arial">
					In respect of 
					<%if(contract_type.equals("O")){ %> LTCORA Agreement executed on <%=agmtSigningDt%> & CN (<%=contRef%>) executed on <%=signingDt%>
					<%}else if(contract_type.equals("Q")){ %> LTCORA Agreement executed on <%=agmtSigningDt%>
					<%}else{ %>Transport Management Service Agreement (<%=contRef%>) executed on <%=signingDt%> 
					<%} %>
					<br>
...
<table border="0" width="100%" align="center" cellpadding="2" cellspacing="0">
	...
	<tr valign="middle">
		<td colspan="7">
			<div align="left">
				<font size="1px" face="Arial"><%remark_2 =remark_2.replaceAll("\n", "<br>");%><%=remark_2 %></font>
			</div>
		</td>
	</tr>
	<tr valign="middle"><td colspan="7"><div align="center">&nbsp;</div></td></tr>
