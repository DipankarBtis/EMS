...
<jsp:useBean class="com.etrm.fms.dlng.DataBean_DLNG_Invoice" id="accounting" scope="request"></jsp:useBean>
...
accounting.setCallFlag("DLNG_RECEIVABLE_TRACKING");
...
%>
	<table width="100%" border="1">
		<tr>
			<th colspan="28" rowspan="2" align="left">DLNG Receivable Tracking (<%=month%>/<%=year%> - <%=month_to%>/<%=year_to%>)</th>
		</tr>
	</table>
	<table width="100%" border="1">
		<thead>
