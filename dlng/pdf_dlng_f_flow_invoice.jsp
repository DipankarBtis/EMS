...
for(int i=0; i<pdf_type.length; i++)
{
	...
	pdfFile.setCallFlag("DLNG_F_FLOW_INVOICE");
	pdfFile.init();
	
	String file_url = pdfFile.getFile_url();
	file_nm = pdfFile.getFile_nm();
	pdfpath = file_url+"/"+CommonVariable.work_dir+owner_cd+""+CommonVariable.dlng_freeflow_inv_path+""+file_nm;
}	
