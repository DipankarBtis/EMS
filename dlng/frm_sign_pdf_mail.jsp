...
{
	path ="/"+CommonVariable.work_dir+owner_cd+"/"+CommonVariable.signed_dlng_freeflow_inv_path;
...
if(mail_inv_type.equals("SVC"))
{
	path ="/"+CommonVariable.work_dir+owner_cd+"/"+CommonVariable.signed_dlng_service_inv_path;
}
													...
													<div class="col-12">
														...
														<div class="input-group mb-1">				
															...
															<%for(int k=0;k<((Vector)VMAIL_ATTACHMENT.elementAt(i)).size();k++){ %>
																<a href="../<%=CommonVariable.work_dir+owner_cd%>//<%=VMAIL_ATTACHMENT_PATH.elementAt(i)%><%=((Vector)VMAIL_ATTACHMENT.elementAt(i)).elementAt(k)%>">
																	<i class="fa fa-file-excel-o" style="color:green;"></i>&nbsp;<%=((Vector)VMAIL_ATTACHMENT.elementAt(i)).elementAt(k)%>
																</a>
															<%} %>
															</span>
															<%}else{%>
														...
														<%for(int k=0;k<((Vector)VMAIL_ATTACHMENT.elementAt(i)).size();k++){ %>
															...
															<%if(VMAIL_PDF_TYPE_NM.elementAt(i).equals("Form 402")) {%>
																value="<%=file402_path%><%=File.separator%><%=((Vector)VMAIL_ATTACHMENT.elementAt(i)).elementAt(k)%>" 
															<%}else{ %>
																<%if(((Vector)VMAIL_ANNEXURE_ATTACHMENT_FLAG.elementAt(i)).elementAt(k).equals("Y")){ %>
