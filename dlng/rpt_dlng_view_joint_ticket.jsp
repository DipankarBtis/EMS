...
{
	dlng.setCallFlag("DLNG_VIEW_JOINT_TICKET");
...
HashMap view_join_ticket_data = dlng.getView_join_ticket_data();
HashMap view_join_ticket_info = dlng.getView_join_ticket_info();
...
<table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<td colspan="6" style="background: #c2d1f0;"><div align="center"><font size="3px" face="Arial"><b>DLNG JOINT TICKET&nbsp;(<%=owner_abbr%> - <%=view_join_ticket_info.get("customer_abbr")%>&nbsp;:&nbsp;<%=view_join_ticket_info.get("plant_nm")%>)</b></font></div></td>
	</tr>
</table>
<br>
<table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0">	
	<tr valign="bottom">
		...
		<td rowspan="2"><div align="center"><font size="1.5px" face="Arial"><b>Truck</b></font></div></td>
	</tr>
	<tr> 
		<td><div align="center"><font size="1.5px" face="Arial"><b>MMBTU</b></font></div></td>
		<td><div align="center"><font size="1.5px" face="Arial"><b>MT</b></font></div></td>	
	</tr>
	<%
		...
		<td colspan="1" width="20%">
			<div align="left">
				<font size="2px" face="Arial">
					<br><br><br><br><br><%=view_join_ticket_info.get("emp_nm")%>
...
<%
	...
	response.setHeader("content-Disposition","inline; filename=DLNG_JoinTicket_"+gas_dt.replaceAll("/", "")+".xls");
%>
<table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr>
...
pdfFile.setCallFlag("DLNG_PDF_JOINT_TICKET");
...
for(int i=0;i<all_counterparty_cd.length;i++)
{
	...
	dlng.setBu_plant_seq(all_bu_plant_seq[i]);
	dlng.init();
	
	view_join_ticket_data = dlng.getView_join_ticket_data();
	view_join_ticket_info = dlng.getView_join_ticket_info();
	HttpServletRequest req = request;
