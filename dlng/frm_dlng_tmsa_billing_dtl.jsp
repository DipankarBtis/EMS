...
dlng.setCallFlag("TMSA_BILLING_DTL");
dlng.setComp_cd(owner_cd);
dlng.setCont_start_dt(start_dt);
dlng.setCont_end_dt(end_dt);
...
String display_agmt_id=dlng.getDisplay_agmt_id();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader"> 
					    	TMSA <%=contpty_abbr %> [<%=display_agmt_id %>] Billing Details
					    </div>
					</div>
				</div>
...
<input type="hidden" name="option" value="TMSA_BILLING_DTL">
