...
String fileName =owner_abbr+"_TransactionChargeActualsReport.xls";
...
%>
	<span style="font-weight: bold;font-size: 40px;"><%=owner_abbr%> Transaction Charge Actuals Report</span>
	<br><br>
	<%int i=0;int k=0;
	...
	<table border="1">
		...
		<%}else{ %>
			<tr>
				<td colspan="23" align="center"><b>No Remittance is Generated for Selected Period!</b></td>
			</tr>
		<%} %>
		</tbody>
	</table>
