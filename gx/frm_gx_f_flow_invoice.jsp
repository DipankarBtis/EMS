...
function doSubmit()
{
	...
	var gross_amt_inr = document.forms[0].gross_amt_inr.value; //JD
				...
				<div class="card-body cdbody">
					<div class="row m-b-5" <%if(opration.equals("MODIFY")){%>style="pointer-events: none;"<%}%>>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
								<div class="col-auto">  	
					    			<label class="form-label"><b>On behalf of Counterparty</b></label>
					  			</div>
								<div class="col">  
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
				    		...
				    		<%} %>
				    				<select class="form-select form-select-sm" name="invoice_type" onchange="refresh('<%=opration%>');">
										...
										<option value="LP">Late Payment Invoice (LP)</option>
