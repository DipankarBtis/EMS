						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="table-responsive">
								<table class="table table-bordered table-hover">
											...
											<tr>
												...
												<td align="center">
													...
													onclick="openActivity1('<%=VCOUNTERPTY_CD.elementAt(i)%>','<%=VGX_COUNTERPTY_CD.elementAt(i) %>','<%=VAGMT_NO.elementAt(i)%>',
															...
															'<%=VCONTRACT_TYPE.elementAt(i)%>','<%=VGX_BU_PLANT_SEQ.elementAt(i)%>','<%=VBU_PLANT_SEQ.elementAt(i)%>','<%=VINVOICE_TYPE.elementAt(i)%>','<%=VTYPE.elementAt(i)%>','')"
													style="color:black;">
													</i>
													<%}else{ %>
													...
													onclick="openActivity1('<%=VCOUNTERPTY_CD.elementAt(i)%>','<%=VGX_COUNTERPTY_CD.elementAt(i) %>','<%=VAGMT_NO.elementAt(i)%>',
															'<%=VAGMT_REV_NO.elementAt(i)%>','<%=VCONT_NO.elementAt(i)%>','<%=VCONT_REV_NO.elementAt(i)%>',
															'<%=VCONTRACT_TYPE.elementAt(i)%>','<%=VGX_BU_PLANT_SEQ.elementAt(i)%>','<%=VBU_PLANT_SEQ.elementAt(i)%>','<%=VINVOICE_TYPE.elementAt(i)%>','<%=VTYPE.elementAt(i)%>','PREPARE')"
												...
												<td align="center">
													...
													onclick="openActivity1('<%=VCOUNTERPTY_CD.elementAt(i)%>','<%=VGX_COUNTERPTY_CD.elementAt(i) %>','<%=VAGMT_NO.elementAt(i)%>',
														'<%=VAGMT_REV_NO.elementAt(i)%>','<%=VCONT_NO.elementAt(i)%>','<%=VCONT_REV_NO.elementAt(i)%>',
														'<%=VCONTRACT_TYPE.elementAt(i)%>','<%=VGX_BU_PLANT_SEQ.elementAt(i)%>','<%=VBU_PLANT_SEQ.elementAt(i)%>','<%=VINVOICE_TYPE.elementAt(i)%>','<%=VTYPE.elementAt(i)%>','CHECK')"
												...
												<td align="center">
													...
													onclick="openActivity1('<%=VCOUNTERPTY_CD.elementAt(i)%>','<%=VGX_COUNTERPTY_CD.elementAt(i) %>','<%=VAGMT_NO.elementAt(i)%>',
														'<%=VAGMT_REV_NO.elementAt(i)%>','<%=VCONT_NO.elementAt(i)%>','<%=VCONT_REV_NO.elementAt(i)%>',
														'<%=VCONTRACT_TYPE.elementAt(i)%>','<%=VGX_BU_PLANT_SEQ.elementAt(i)%>','<%=VBU_PLANT_SEQ.elementAt(i)%>','<%=VINVOICE_TYPE.elementAt(i)%>','<%=VTYPE.elementAt(i)%>','AUTHORIZE')"
												...
												<td align="center">
													...
													onclick="openActivity1('<%=VCOUNTERPTY_CD.elementAt(i)%>','<%=VGX_COUNTERPTY_CD.elementAt(i) %>','<%=VAGMT_NO.elementAt(i)%>',
														'<%=VAGMT_REV_NO.elementAt(i)%>','<%=VCONT_NO.elementAt(i)%>','<%=VCONT_REV_NO.elementAt(i)%>',
														'<%=VCONTRACT_TYPE.elementAt(i)%>','<%=VGX_BU_PLANT_SEQ.elementAt(i)%>','<%=VBU_PLANT_SEQ.elementAt(i)%>','<%=VINVOICE_TYPE.elementAt(i)%>','<%=VTYPE.elementAt(i)%>','APPROVE')"
												...
												<td align="center">
													...
													<i class="fa <%if(!VSAP_APPROVAL_FLAG.elementAt(i).equals("Y")){ %>fa-file-code-o<%}else{%>fa-eye<%} %> fa-2x" 
													 ...
													 '<%=VCONT_NO.elementAt(i)%>','<%=VPDF_INV_FLAG.elementAt(i)%>','<%=VREMITTANCE_NO.elementAt(i)%>');"
													style="<%if(!VAPPROVE_FLAG_CHECK.elementAt(i).equals("Y")){ %>
														pointer-events: none; opacity: .65; color: gray;
														<%} else{%>
												...
												<td align="center">
													<i class="fa fa-envelope-o fa-2x" 
														onclick="openMailBody('<%=VCOUNTERPTY_CD.elementAt(i)%>','<%=VGX_COUNTERPTY_CD.elementAt(i)%>','<%=VAGMT_NO.elementAt(i)%>',
															...
															'<%=VCONT_REV_NO.elementAt(i)%>','<%=VCONTRACT_TYPE.elementAt(i)%>',
															'<%=VGX_BU_PLANT_SEQ.elementAt(i)%>','<%=VBU_PLANT_SEQ.elementAt(i)%>',
															'<%=VFINANCIAL_YEAR.elementAt(i) %>','<%=VINVOICE_SEQ.elementAt(i)%>','<%=VINVOICE_TYPE.elementAt(i)%>','<%=VTYPE.elementAt(i)%>','S');"
									...
									<%}else{ %>
										<tr>
											<td colspan="19" align="center"><%=utilmsg.infoMessage("<b>No Contract is Ready for Generate!</b>")%></td>
										</tr>
									<%} %>
									</tbody>
								</table>
							...
							<div class="table-responsive">
								<table class="table table-bordered table-hover">
									...
									<%if(VOTH_COUNTERPTY_CD.size() > 0){ %>
										...
										<tr>
											<td align="center" title="<%=VOTH_COUNTERPTY_NM.elementAt(i)%>"><%=VOTH_COUNTERPTY_ABBR.elementAt(i)%></td>						
											<td align="center">	<%=VOTH_GX_COUNTERPTY_ABBR.elementAt(i)%></td>
											<td align="center">	<%=VOTH_CONTRACT_TYPE_NM.elementAt(i)%></td>	
											<td align="center">
											...
											<%}else{%>											
												...
												onclick="doGenXML('<%=VOTH_COUNTERPTY_CD.elementAt(i)%>','<%=VOTH_INVOICE_NO.elementAt(i)%>',
													 ...
													 '<%=VOTH_CONT_NO.elementAt(i)%>','<%=VOTH_PDF_INV_FLAG.elementAt(i)%>','<%=VOTH_INVOICE_NO.elementAt(i)%>');"
											...
											<td align="center">
												<i class="fa fa-envelope-o fa-2x" 
													onclick="openMailBody('<%=VOTH_COUNTERPTY_CD.elementAt(i)%>','<%=VOTH_GX_COUNTERPTY_CD.elementAt(i)%>',
														...
														'<%=VOTH_FINANCIAL_YEAR.elementAt(i) %>','<%=VOTH_INVOICE_SEQ.elementAt(i)%>','<%=VOTH_INVOICE_TYPE.elementAt(i)%>','<%=VOTH_TYPE.elementAt(i)%>','F');"
									...
									<%}else{ %>
										<tr>
											<td align="center" colspan="19"><%=utilmsg.infoMessage("<b>No Invoice is Generated!</b>") %></td>
										</tr>
									<%} %>
									</tbody>
								</table>
