...
function refresh()
{
	...
	var url = "frm_trader_contract_duration_modification.jsp?customer_cd="+customer_cd+"&u="+u;;
...
<jsp:useBean class="com.etrm.fms.purchase.DataBean_Trader_Contract_Mst" id="contract" scope="page"/>
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	Trader Contract Duration Modification
					    </div>
	    			</div>
	    		</div>
							...
							<div class="form-group row">
				    			...
				    			<div class="col">
				    				<select class="form-select form-select-sm" name="customer_cd" id="customer_cd" onchange="refresh();"> 
					   				...
					   				<input type="hidden" name="counterparty_cd" value="<%=customer_cd%>">
				    			</div>
				    		</div>
				    	</div>
				    	<div class="col-sm-4 col-xs-4 col-md-4"></div>
