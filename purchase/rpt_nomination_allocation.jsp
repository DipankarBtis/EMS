...
String contRef = purchase.getContRef();//JD
...
{
	displayContNm=cont_name+"("+contRef+")("+start_dt+" - "+end_dt+")"; //JD
}

String total_buyer_mmbtu = purchase.getTotal_buyer_mmbtu();
String total_buyer_scm = purchase.getTotal_buyer_scm();
String total_seller_mmbtu = purchase.getTotal_seller_mmbtu();
String total_seller_scm = purchase.getTotal_seller_scm();
String total_alloc_mmbtu = purchase.getTotal_alloc_mmbtu();
String total_alloc_scm = purchase.getTotal_alloc_scm();
%>
<body>
							...
							<table class="table table-bordered table-hover">
								...
								<%} %>	
									<tr>
										...
										<td align="right"><b><%=total_buyer_scm %></b></td>
										<td align="right"><b><%=total_seller_mmbtu %></b></td>
										<td align="right"><b><%=total_seller_scm %></b></td>
										<td align="right"><b><%=total_alloc_mmbtu %></b></td>
										<td align="right"><b><%=total_alloc_scm %></b></td>
									</tr>
								</tbody>
							</table>
						</div>
