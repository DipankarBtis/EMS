...
<jsp:useBean class="com.etrm.fms.purchase.DataBean_Trader_Contract_Mst" id="cont" scope="request"></jsp:useBean>
...
cont.setCallFlag("TRADER_CONT_LIABILITY_CLAUSE");
...
String counterparty_abbr =cont.getCounterparty_abbr();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	<%=counterparty_abbr%> [<%=display_map_id%>] Liability Clause
					    </div>
					</div>
				</div>
...
<input type="hidden" name="option" value="TRADER_CONT_LIABILITY_CLAUSE">
