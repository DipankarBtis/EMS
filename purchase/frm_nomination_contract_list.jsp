...
function refresh(active_status)
{
	...
	var url = "../purchase/frm_nomination_contract_list.jsp?active_status="+active_status+"&gas_dt="+gas_dt+"&nomination_freq="+nomination_freq+"&nomination_type="+nomination_type;
...
function refresh_date()
{
	...
	if(flag && flg)
	{
		if(trim(from_dt)!="" && trim(to_dt)!="")
		{
			...
			{
			var url = "../purchase/frm_nomination_contract_list.jsp?active_status="+active_status+"&gas_dt="+gas_dt+"&nomination_freq="+nomination_freq+
