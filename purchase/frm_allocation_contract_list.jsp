...
function refresh(active_status)
{
	...
	var url = "../purchase/frm_allocation_contract_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&clearance="+clearance;
...
function refresh_date()
{
	...
	if(flag && flg)
	{
		if(trim(from_dt)!="" && trim(to_dt)!="")
		{
			...
			{
			var url = "../purchase/frm_allocation_contract_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+
