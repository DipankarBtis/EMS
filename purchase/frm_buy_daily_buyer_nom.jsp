...
function refresh()
{
	...
	var url = "frm_buy_daily_buyer_nom.jsp?gas_dt="+gas_dt+"&u="+u;
...
purchase.setCallFlag("BUY_DAILY_BUYER_NOM");
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	Daily Buyer Nomination (Purchase)
					    </div>
					</div>
				</div>
							...
							<table class="table table-bordered table-hover" id="example">
								...
								<%if(VCOUNTERPARTY_PLANT_SEQ.size()>0){ %>
									...
									<tr>
										...
										<td align="center" valign="middle"><%=VCOUNTERPARTY_ABBR.elementAt(i) %>
											<span 
								...
								<%}else{ %>
									<tr>
										<td colspan="14" align="center"><%=utilmsg.infoMessage("<b>Contract Detail is not Available for the Selected Gas Day!</b>")%></td>
									</tr>
								<%} %>
								</tbody>
							</table>
