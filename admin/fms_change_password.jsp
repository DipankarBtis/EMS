...
{
	//minimum=document.forms[0].pid_min_length.value;
	//maximum=document.forms[0].pid_max_length.value;
...
<form method="post" action="../servlet/Frm_admin" autocomplete="off">
				...
				<div class="card-body cdbody">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-8 col-xs-8 col-md-8">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				      				<input type="password" class="form-control form-control-sm" name="current_pwd" value="" maxLength="40" placeholder="Current Password..." autocomplete="off"> <!-- onblur="isPassExist();"> -->
				    			</div>
				  			</div>
						</div>
					</div>
					<div class="row m-b-5">
						...
						<div class="col-sm-8 col-xs-8 col-md-8">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				      				<input type="password" class="form-control form-control-sm" name="new_pwd" value="" maxLength="40" placeholder="New Password..." 
				      				onblur="passwd_std_chk(this.value,this,'<%=pid_min_length%>','<%=pid_max_length%>');" autocomplete="new-password">
				    			</div>
				  			</div>
						</div>
					</div>
					<div class="row m-b-5">
						...
						<div class="col-sm-8 col-xs-8 col-md-8">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				      				<input type="password" class="form-control form-control-sm" name="confirm_pwd" value="" placeholder="Confirm Password..." autocomplete="new-password">
				    			</div>
				  			</div>
						</div>
					</div>
