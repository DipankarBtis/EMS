...
dbadmin.setCallFlag("ACTIVE_USER_LIST");
...
Vector V_EMP_STATUS = dbadmin.getV_EMP_STATUS();
%>
<body>
<form action="">
								...
								<%if(VEMP_CD.size() > 0){ %>
									...
									<tr>
										...
										<td style="text-align:center">
											<%if(V_EMP_STATUS.elementAt(i).equals("Y")){ %>
												<i title="Enabled" class="fa fa-user fa-lg" aria-hidden="true"></i>
    										<%}else if(V_EMP_STATUS.elementAt(i).equals("N")){ %>
    											<i title="Disabled" style="color: red"  class="fa fa-user-times fa-lg"  aria-hidden="true"></i>
    										<%}else if(V_EMP_STATUS.elementAt(i).equals("D")){ %>
   												<i title="Dormant" style="color: #ff9933"  class="fa fa-user-circle-o fa-lg" aria-hidden="true"></i>
    										<%}else if(V_EMP_STATUS.elementAt(i).equals("R")){ %>
