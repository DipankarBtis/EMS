...
String sei_central = dbadmin.getSei_central();
							...
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<div class="d-flex justify-content-end">
				    					<div><input type="checkbox" class="form-check-input" name="sei_central" value="Y" <%if(sei_central.equals("Y")){ %>checked<%} %>>&nbsp;SEI Central&nbsp;<span style="color:var(--top_header_font_color);"><i class="fa fa-universal-access" aria-hidden="true"></i></span></div>
				    				</div>
				    			</div>
				    		</div>
				    	</div>
