...
<table width="100%" border="1">	
	...
	<thead>
		<tr>
			<br><th colspan="20" rowspan="2" align="left">Incident Tracker Report (generated on <%=sysdate%>)</th>		
		</tr>
		<br>
		<tr></tr>
		<br>
	...
	<tbody>
		...
		<tr valign="top">
			...
			<td><%= VINCIDENT_EVENT_DTL.elementAt(i)%></td>
			...
			<%-- <td><%= VENT_PROFILE.elementAt(i)%></td> --%>
