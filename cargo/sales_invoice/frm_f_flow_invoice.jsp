...
function doSubmit()
{
	...
	if(invoice_type == "CR" || invoice_type == "DR")
	{
			...
			<div class="card cardmain">
						...
						<div class="col-sm-12 col-xs-12 col-md-12">
							<div class="table-responsive">
								<table class="table table-bordered table-hover">
									...
									<tbody <%if(opration.equals("MODIFY")){%>style="pointer-events: none;"<%}%>>
										<tr>
											<td align="center">
				...
				<div class="card-body cdbody">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
				    			<label class="form-label"><b>Sub Invoice Type<span class="s-red">*</span></b></label>
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				   ...
				   <div class="row m-b-5">
				    	...
				    	<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
				    			<label class="form-label"><b>Invoiced MMBTU<span class="s-red">*</span></b></label>
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
