...
function openContList()
{
	...
	{
		newWindow = window.open("frm_cn_contract_list.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+contract_type,"CN Contract List","top=10,left=10,width=1100,height=600,scrollbars=1");
	}
	else
	{
		newWindow.close();
													...
													<div class="form-group row">
														...
														<div style="width:100px;" >
															...
															onclick="variablePriceConfig('<%=contract_type%>','<%=agmt_no%>','<%=agmt_rev_no%>','<%=cont_no%>',
																						...
																						'<%=VCARGO_START_DT.elementAt(i) %>','<%=VCARGO_END_DT.elementAt(i) %>','<%=VCARGO_NO.elementAt(i)%>');">
														</div>
													</div>
												</div>
											</td>
