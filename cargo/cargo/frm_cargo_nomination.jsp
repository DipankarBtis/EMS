...
function doSubmitBl()
{
	...
	if(trim(bl_qty)=="" || bl_qty==0)
	{
		msg+="Please Enter BL MMBTU!\n";
		flag=false;
	}
...
function doSubmitBoe()
{
	...
	if(trim(boe_qty)=="" || boe_qty==0)
	{
		msg+="Please Enter BOE Quantity!\n";
		flag=false;
	}
...
function setContractDetail(cont_full_no,entity_type,entity_name,ref_no)
{
	if(entity_type == "V")
	{
		var disp_vessel_cont_dtl = document.forms[0].disp_vessel_cont_dtl.value =entity_name+"-"+cont_full_no+" ("+ref_no+")";
		var vessel_cont_dtl = document.forms[0].vessel_cont_dtl.value =cont_full_no;
	...
	else if(entity_type == "H")
	{
		...
		var cha_cont_dtl = document.forms[0].cha_cont_dtl.value =cont_full_no;
	...
	else if(entity_type == "S")
	{
		...
		var surveyor_cont_dtl = document.forms[0].surveyor_cont_dtl.value =cont_full_no;
