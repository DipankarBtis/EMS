...
function openContList()
{
	...
	{
		newWindow = window.open("frm_cn_contract_list_fcc.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+contract_type,"CN Contract List","top=10,left=10,width=1100,height=600,scrollbars=1");
	}
	else
	{
		newWindow.close();
