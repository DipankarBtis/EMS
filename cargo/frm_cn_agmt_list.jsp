...
function refresh(active_status)
{
	...
	var url = "../cargo/frm_cn_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&agreement_type="+agreement_type;
...
function refresh_date()
{
	...
	if(flag && flg)
	{
		if(trim(from_dt)!="" && trim(to_dt)!="")
		{
			...
			{
			var url = "../cargo/frm_cn_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+
...
agmt_list.setActive_status(active_status);
agmt_list.setFrom_dt(from_dt);
agmt_list.setTo_dt(to_dt);
agmt_list.init();
