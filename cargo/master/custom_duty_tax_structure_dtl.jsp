											...
											<td align="center">
												<div style="width:100px;">
													<div class="input-group input-group-sm" >
														<input type="text" class="form-control form-control-sm date fmsdtpick" name="eff_dt" id="eff_dt" value="" onchange="checkEffectiveDate(this,document.forms[0].tax_struct_eff_dt);" style="background:<%//=VSER_COLOR.elementAt(i)%>" autocomplete="off">
