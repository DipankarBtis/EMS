...
function setBankDtl(bank_eff_dt,bank_name,bank_account_no,bank_branch,bank_state,ifsc_code)
{
						...
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<div class="col-auto">
				    				...
				    				onclick="setBankDtl('<%=bank_eff_dt%>','<%=bank_name%>','<%=bank_account_no%>','<%=bank_branch%>','<%=bank_state%>','<%=ifsc_code%>');">
				    			</div>
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
      		...
      		<div class="modal-body mdbody">
      			<div class="cdbody">
	      			<div class="row m-b-5 subheader">
						<div class="col-sm-12 col-xs-12 col-md-12">
							<div class="form-group row" align="left">
				    			<label class="form-label"><b>Bank Detail(s)</b></label>
				  			</div>
						</div>
					</div>
					<div class="row m-b-5">
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								...
								<%}else{ %>
									<tr>
										<td align="center" colspan="3"><%=utilmsg.infoMessage("<b>Bank Detail is Not Config!</b>") %></td>
									</tr>
								<%} %>
								</tbody>
							</table>
