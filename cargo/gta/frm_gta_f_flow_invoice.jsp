...
function refresh(opration)
{
	...
	if(flag)
	{
		var url = "frm_gta_f_flow_invoice.jsp?u="+u+"&counterparty_cd="+counterparty_cd+
				...
				"&period_start_dt="+period_start_dt+"&period_end_dt="+period_end_dt+"&mapping_id="+mapping_id+"&activity_type="+activity_type+
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	GTA Free Flow Invoice Generation
					    </div>
					</div>
				</div>
								...
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th colspan="1">Transporter Detail</th>
									...
									<tbody>
										<tr>
											...
											<td align="center">
												<div style="width:150px;">
													<select class="form-select form-select-sm" name="billing_cycle" onchange="refresh('<%=opration%>');">
												...
												<div style="width:250px;">
													<div class="row m-b-5">
														<div class="col">
									      				...
									      				<div class="col">
										      				<div class="input-group input-group-sm">
										      					<input type="text" class="form-control form-control-sm date <%if(billing_cycle.equals("8")){ %>fmsdtpick<%}%>" name="period_end_dt" value="<%=period_enddt %>" maxLength="10" 
										      					onchange="validateDate(this);checkStartEndDate('T');refresh('<%=opration%>');" <%if(!billing_cycle.equals("8")){ %>readonly<%} %>>
										      					<span class="input-group-text"><i class="fa fa-calendar fa-lg"></i></span>
										      				</div>
							      						</div>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
				    		...
				    		<%} %>
				    				...
				    				<%if(invoice_type.equals("IC")){ %>
				    					<option value="IC">Imbalance Charge</option>
				    				<%}else if(invoice_type.equals("TC")){ %>
				    					<option value="TC">Transmission Charge</option>
				    				<%}else{ %>
										<option value="0">--Select--</option>
