...
{
	remittance.setCallFlag("GTA_FINAL_PRINT_FFLOW_INVOICE_PDF");
	...
	remittance.setTrans_counterparty_cd(trans_counterparty_cd);
	remittance.init();
}
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="ratio ratio-1x1">
							  <iframe src="<%=pdfpath%>" title="GTA Remittance PDF" allowfullscreen width="100%"></iframe>
							</div>
						</div>
					</div>
				</div>
