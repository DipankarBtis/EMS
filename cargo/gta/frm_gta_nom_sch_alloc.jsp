						...
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<div class="col-sm-12 col-xs-12 col-md-12">
									<label class="form-label"><b>GTC Type</b></label>
								</div>
							</div>
						</div>
								...
								<%for(int i=0;i<VGAS_DT.size(); i++){ %>
									<tr>
										<td align="center" valign="middle">
											<input type="checkbox" class="form-check-input" name="chk" onclick="setEnableDisabled(this,'<%=i%>');calculateSCM('<%=i%>');" <%if(VIS_DONE.elementAt(i).equals("N")){ %>style="pointer-events: none;"<%} %>>
										...
										<td align="center">
											<div style="width:100px;">
												...
												onpaste="doPaste('E','<%=i%>');"
												onblur="negNumber(this);checkNumber1(this,11,3);checkQty('<%=i%>');calculateSCM('<%=i%>');" disabled>
										...
										<td align="center">
											<div style="width:100px;">
												...
												style="text-align:right;background:<%=VNOM_COLOR.elementAt(i)%>" 
												onpaste="doPaste('X','<%=i%>');"
												onblur="negNumber(this);checkNumber1(this,10,3);checkQty('<%=i%>');calculateSCM('<%=i%>');" disabled>
