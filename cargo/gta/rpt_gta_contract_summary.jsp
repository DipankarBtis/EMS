...
function exportToXls()
{
	...
	var url = "xls_gta_contract_summary.jsp?fileName=GTC Summary Report.xls&counterparty_cd="+counterparty_cd+"&segmentType="+segmentType+"&from_dt="+from_dt+"&to_dt="+to_dt+
	"&customer_cd="+customer_cd;
