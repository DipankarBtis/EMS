...
function openContList()
{
	...
	{
		newWindow = window.open("frm_contract_list_fcc.jsp?counterparty_cd="+counterparty_cd+"&clearance="+clearance+"&contract_type="+contract_type,"Supply Contract List","top=10,left=10,width=1100,height=600,scrollbars=1");
	}
	else
	{
		newWindow.close();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	Gas Supply Contract (Finance Check & Control)
					    </div>
					</div>
				</div>
