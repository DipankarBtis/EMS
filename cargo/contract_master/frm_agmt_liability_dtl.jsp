...
<jsp:useBean class="com.etrm.fms.contract_master.DataBean_ContractMaster" id="agmt" scope="request"></jsp:useBean>
...
String disp_agmt_no = utilBean.NewAgmtMappingId(owner_cd, counterparty_cd, agmt_no, agmt_rev_no, agreement_type);

agmt.setCallFlag("AGMT_LIABILITY_CLAUSE");
agmt.setComp_cd(owner_cd);
agmt.setCont_start_dt(start_dt);
//agmt.setCont_end_dt(end_dt);
agmt.setCounterparty_cd(counterparty_cd);
agmt.setAgmt_no(agmt_no);
agmt.setAgmt_rev_no(agmt_rev_no);
agmt.setAgreement_type(agreement_type);
agmt.init();

String liab_lq_damg=agmt.getLiab_lq_damg();
String ld_price_per=agmt.getLd_price_per();
String ld_promise=agmt.getLd_promise();
String ld_low_per=agmt.getLd_low_per();
String ld_chk=agmt.getLd_chk();
String remark=agmt.getRemark();
String liab_take_pay=agmt.getLiab_take_pay();
String top_price_per=agmt.getTop_price_per();
String top_promise=agmt.getTop_promise();
String top_per=agmt.getTop_per();
String top_chk=agmt.getTop_chk();
String top_obligation=agmt.getTop_obligation();
String top_remark=agmt.getTop_remark();
String liab_makeup=agmt.getLiab_makeup();
String mug_price_per=agmt.getMug_price_per();
String mug_period_per=agmt.getMug_period_per();
String recovery_day=agmt.getRecovery_day();
String mug_remark=agmt.getMug_remark();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	<%=utilBean.getCounterpartyABBR(counterparty_cd)%> [<%=disp_agmt_no%>] Liability Clause
					    </div>
					</div>
				</div>
...
<input type="hidden" name="option" value="AGMT_LIABILITY_CLAUSE">
