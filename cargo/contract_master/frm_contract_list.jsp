								...
								<table class="table table-bordered" id="example">
									<thead>
										<tr valign="top">
											...
											<th><%if(contract_type.equals("X")){ %>Trade Ref#<%}else{ %>Contract Ref#<%} %><br><input class="form-control form-control-sm" type="text" id="table_Contract_Ref" onkeyup="Search(this,'3');" placeholder="Search.." style="width:100px"/></th>
											<th>Contract Name</th>
