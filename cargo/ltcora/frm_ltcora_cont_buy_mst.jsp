...
function openBillingDtl()
{
	...
	var url = "frm_ltcora_cont_billing_dtl.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+contract_type+"&buy_sale="+buy_sale+"&cont_no="+cont_no+
			"&cont_rev_no="+cont_rev_no+"&agmt_no="+agmt_no+"&agmt_rev_no="+agmt_rev_no+"&start_dt="+start_dt+"&agreement_type="+agreement_type+"&rate_unit="+ltcora_tariff_unit+
			"&u="+u;
...
function openVariableTariff()
{
	...
	if(trim(storage_tariff) == "" || storage_tariff == "0")
	{
