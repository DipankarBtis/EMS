...
<script>
function setValue(obj,id_no,ship_cd,ship_nm,counterparty_cd)
{
	window.opener.shipDtl(id_no,ship_cd,ship_nm,counterparty_cd);
	window.close();
}
</script>
</head>
							...
							<div class="table-responsive">
								<table class="table table-bordered" id="example">
									...
									<%if(VSHIP_CD.size() > 0){ %>
										...
										<tr>
											<td align="center">
												<input type="radio" name="rdo" onclick="setValue(this,'<%=id_no %>','<%=VSHIP_CD.elementAt(i)%>','<%=VSHIP_NAME.elementAt(i)%>','<%=counterparty_cd%>')">
											</td>
