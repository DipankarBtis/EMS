...
%>
<body onload="setBillingDays(document.forms[0].freq);"><!-- setExchgVal(document.forms[0].exchng_rate); -->
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	LTCORA <%=utilBean.getCounterpartyABBR(counterparty_cd)%> [<%=display_agmt_id%>] Billing Details
					    </div>
					</div>
				</div>
