...
function refresh(opration)
{
	...
	var url = "frm_ltcora_agmt_buy_mst.jsp?counterparty_cd="+counterparty_cd+"&opration="+opration+"&u="+u;
...
function openAgreementList()
{
	...
	{
		newWindow.close();
		newWindow = window.open("frm_ltcors_agmt_list.jsp?counterparty_cd="+counterparty_cd+"&buy_sale="+buy_sale+"&agreement_type="+agmt_type,"Agreement List","top=10,left=10,width=1100,height=600,scrollbars=1");
	}
}
...
function setAgmtDetail(countpty_cd,buy_sale,agmt_type,agmt_no,agmt_rev_no)
{
	...
	var url = "frm_ltcora_agmt_buy_mst.jsp?counterparty_cd="+countpty_cd+"&opration="+opration+
...
%>
<body onload="setValues('<%=strPlant%>','<%=strBuPlant%>'); revisionEffDateShows();messurmentShows();off_spec_gasShows();liabilityShows();billingShows();terminatorShows();">
				...
				<div class="card-body cdbody">
							...
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<select class="form-select form-select-sm" name="agmt_type" style="pointer-events: none;">
				    					<option value="L">LTCORA (Buy)</option>
				    				</select>
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				      				<input type="radio" name="agreement_type" value="G" <%if(agmt_type.equals("G")){%>checked<%}%>>&nbsp;CN&nbsp;&nbsp;
				      				<input type="radio" name="agreement_type" value="P" <%if(agmt_type.equals("P")){%>checked<%}%>>&nbsp;Period&nbsp;&nbsp;
				    			</div>
				  			</div>
						</div>
					</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	LTCORA (Buy) Agreement - Change Request(s)
					    </div>
					</div>
				</div>
				<div class="card-body cdbody">
