...
function doSubmit()
{
	...
	{
		msg+="OTP maximum length is missing\n"
		flag=false;
	}
	if(otp_min_length == "" || trim(otp_min_length) == "")
	{
		msg+="OTP minimum length is missing\n"
		flag=false;
	}
	if(parseInt(otp_timer)>=6 || parseInt(otp_timer)<=1)
	{
		msg+="OTP Timer(Minutes): Value range <2-5>!\n"
		flag=false;
	}
	...
	if(trim(otp_min_length) != "" && trim(otp_max_length) != "")
	{
		...
		{
			msg+="OTP Length(Max) : Value range <4 - 6>!\n"
			flag=false;
		}
	}
	if(flag)
			...
			<div class="card cardmain">
				...
				<div class="card-body cdbody">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-3 col-xs-3 col-md-3">
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="uid_min_length" id="uid_min_length" placeholder="Min" size="10" value="<%=uid_min_length %>" style="text-align: right;" onblur="validateNumInput();">
	   							<span class="input-group-text"><b>TO</b></span>
	   							<input type="text" class="form-control form-control-sm" name="uid_max_length" id="uid_max_length" placeholder="Max" size="10" value="<%=uid_max_length %>" style="text-align: right;" onblur="validateNumInput();">
	   						</div>
						</div>
						...
						<div class="col-sm-3 col-xs-3 col-md-3">
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="dormant_days" id="dormant_days" size="10" value="<%=dormant_days %>" style="text-align: right;" onblur="validateNumInput();">	   							
	   						</div>
						</div>
					</div>
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-3 col-xs-3 col-md-3">  
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="pid_min_length" id="pid_min_length" placeholder="Min" size="10" value="<%=pid_min_length %>" style="text-align: right;" onblur="validateNumInput();">
	   							<span class="input-group-text"><b>TO</b></span>
	   							<input type="text" class="form-control form-control-sm" name="pid_max_length" id="pid_max_length" placeholder="Max" size="10" value="<%=pid_max_length %>" style="text-align: right;" onblur="validateNumInput();">
	   						</div>
						</div>
						<div class="col-sm-1 col-xs-1 col-md-1"> </div>
						<div class="col-sm-3 col-xs-3 col-md-3">  
						...
						<div class="col-sm-3 col-xs-3 col-md-3">
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="no_password_notrep" id="no_password_notrep" size="10" value="<%=no_password_notrep %>" style="text-align: right;" onblur="validateNumInput();">
	   						</div>
						</div>
					</div>
					<div class="row m-b-5">
						...
						<div class="col-sm-3 col-xs-3 col-md-3">
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="password_exp" id="password_exp" size="10" value="<%=password_exp %>" style="text-align: right;" onblur="validateNumInput();">
	   						</div>
						</div>
						<div class="col-sm-1 col-xs-1 col-md-1"> </div>
						<div class="col-sm-3 col-xs-3 col-md-3">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-3 col-xs-3 col-md-3">  
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="otp_timer" id="otp_timer" size="10" value="<%=otp_timer %>" style="text-align: right;" onblur="validateNumInput();">
	   						</div>
						</div>
						<div class="col-sm-1 col-xs-1 col-md-1"> </div>
						<div class="col-sm-3 col-xs-3 col-md-3">  
						...
						<div class="col-sm-3 col-xs-3 col-md-3">
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="max_otp" id="max_otp" size="10" value="<%=max_otp %>" style="text-align: right;" onblur="validateNumInput();">
	   						</div>
						</div>
					</div>
					<div class="row m-b-5">
						...
						<div class="col-sm-3 col-xs-3 col-md-3">
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm" name="otp_min_length" id="otp_min_length" placeholder="Min" size="10" value="<%=otp_min_length %>" style="text-align: right;" onblur="validateNumInput();">
	   							<span class="input-group-text"><b>TO</b></span>
	   							<input type="text" class="form-control form-control-sm" name="otp_max_length" id="otp_max_length" placeholder="Max" size="10" value="<%=otp_max_length %>" style="text-align: right;" onblur="validateNumInput();">
	   						</div> 
						</div>
						<div class="col-sm-1 col-xs-1 col-md-1"> </div>
						<%-- <div class="col-sm-3 col-xs-3 col-md-3">
