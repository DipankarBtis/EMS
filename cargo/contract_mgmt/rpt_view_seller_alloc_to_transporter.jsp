...
cont_mgmt.setTransCd(transporter_cd);
cont_mgmt.setTransPlantSeq(tplant_seq);
		...
		<td colspan="1" width="20%">
			<div align="center">
				<font size="2px" face="Arial">
					...
					Authorised Signatory
					<br>
					<%=view_seller_alloc_to_trans_info.get("transporter_nm")%>
				</font>
			</div>
		</td>
	</tr>
...
pdfFile.setCounterparty_cd(transporter_cd);
pdfFile.setPlant_seq(tplant_seq);
pdfFile.init();
