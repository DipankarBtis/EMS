         	...
         	{	
				...
				if(value!=1)
				{
					var url = "rpt_nom_alloc.jsp?from_dt="+from_dt+"&to_dt="+to_dt+"&counterparty_cd="+counterparty_cd+
							"&transporter_cd="+transporter_cd+"&transporter_plant_seq="+transporter_plant_seq+"&chk_diff="+chk_diff+"&u="+u;
...
function exportToXls()
{
	...
	var url = "xls_nom_alloc.jsp?from_dt="+from_dt+"&to_dt="+to_dt+"&counterparty_cd="+counterparty_cd+
		"&transporter_cd="+transporter_cd+"&transporter_plant_seq="+transporter_plant_seq+"&chk_diff="+chk_diff;
					...
					<div class="row m-b-5">	
						...
						<div class="col-sm-3 col-xs-3 col-md-3">  
							<div class="form-group row">
								...
								<div class="col-auto">
								<select class="form-select form-select-sm" name="transporter_cd" onchange="refresh()">
									<option value="0">--Select--</option>
						...
						<div class="col-sm-3 col-xs-3 col-md-3">  
							<div class="form-group row">
								...
								<div class="col-auto">
									<select class="form-select form-select-sm" name="transporter_plant_seq" onchange="refresh()">
										<option value="0">--Select--</option>
							...
							<div class="form-group row">
								<div class="col-auto">
									<label class="form-label">
										<b>
											<input type="checkbox" class="form-check-input" name="chk_diff" onclick="refresh();" <%if(chk_diff.equals("Y")){%>checked<%}%>>
