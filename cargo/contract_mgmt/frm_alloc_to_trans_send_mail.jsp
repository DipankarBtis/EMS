...
String tplant_seq=request.getParameter("tplant_seq")==null?"":request.getParameter("tplant_seq");
...
cont_mgmt.setCallFlag("SEND_MAIL_ALLOC_TO_TRANS");
cont_mgmt.setComp_cd(owner_cd);
cont_mgmt.setGas_dt(gas_dt);
cont_mgmt.setCounterparty_cd(transporter_cd);
cont_mgmt.setPlant_seq(tplant_seq);
cont_mgmt.setContact_person_cd(contact_person_cd);
cont_mgmt.setEmp_cd(emp_cd);
cont_mgmt.setFile_path(file_path);
cont_mgmt.init();

Vector VMAIL_FROM_LIST = cont_mgmt.getVMAIL_FROM_LIST();
Vector VMAIL_TO_LIST = cont_mgmt.getVMAIL_TO_LIST();
Vector VMAIL_CC_LIST = cont_mgmt.getVMAIL_CC_LIST();
Vector VMAIL_SUBJECT = cont_mgmt.getVMAIL_SUBJECT();
Vector VMAIL_ATTACHMENT = cont_mgmt.getVMAIL_ATTACHMENT();
Vector VMAIL_ATTACHMENT_PATH = cont_mgmt.getVMAIL_ATTACHMENT_PATH();
Vector VMAIL_BODY = cont_mgmt.getVMAIL_BODY();
