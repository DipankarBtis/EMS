...
function doModify(seq_no, from_dt, to_dt, price_type, slope, constant, remark, physical_curve, currency, rate,
		curve_nm, price_range, price_start_dt, price_end_dt, curve_logic, formula_desc, MIN_price_dt, counterparty_abbr, counterparty_cd, contract_no,cont_ref,cont_status)
{ 	
	...
	var old_value = "CP="+counterparty_cd+"#CPABBR="+counterparty_abbr+"#CONTNO="+contract_no+"#SLOPE="+slope+"#CONSTANT="+constant+"#CURVE_NM="+curve_nm+"#CONTREFNO="+cont_ref+"#CONT_STATUS="+cont_status;
...
//index, size,dcq
function doModify1(seq_no, from_dt, to_dt, price_type, curve_nm, slope, constant, remark,phys_curve_nm,PPAC_price,PPAC_Validity_dt,price_range,price_start_dt,price_end_dt,delete_permission,MIN_price_dt,UnitPrice) //HARSH20210820 MIN_price_dt //HARSH20210426 //HARSH20210803 WRITE PERMISSION ADDED
{
...
//	alert(document.forms[0].constant[index].value);
	...
	if(price_type=="Fixed")
	{
		...
		document.getElementById('tr2').style.display="none";
		document.getElementById('tr3').style.display="none";
	//SB20230704	document.getElementById('tr4').style.display="none";
		document.getElementById('tr4').style.display="table-row"; //SB20230704
		document.forms[0].opal_min.value="";
		document.getElementById('op1').style.display="none";
		document.getElementById('op2').style.display="none";
		document.getElementById('op3').style.display="none";
		...
		document.forms[0].remark.value=remark;
		document.forms[0].remark.readOnly=false;
		document.forms[0].ppac_price.value=PPAC_price;// alert(PPAC_price);//SB20230704
		document.forms[0].unit_price.value=UnitPrice;//alert(UnitPrice); //SB20230704
	}
	...
	{		
		...
		//SB20230704		document.getElementById('tr4').style.display="table-row";
				document.getElementById('tr4').style.display="none";//SB20230704
		...
		//HARSH20210729 document.forms[0].price_range.value=price_range;
	}
	...
	document.forms[0].save.value="Modify";//alert(document.forms[0].save.value);
}
										...
										<td align="center">
											<input type="radio" name="rd" 
												...
												onclick="doModify('<%=VSEQ_NO.elementAt(i)%>','<%=VSTART_DT.elementAt(i)%>','<%=VEND_DT.elementAt(i)%>',
													...
													'<%=VCURVE_LOGIC.elementAt(i)%>','<%=VFORMULA.elementAt(i)%>','<%=VMIN_PRICE_ST_END_DT.elementAt(i)%>',
													'<%=counterparty_abbr%>','<%=counterparty_cd%>','<%=contract_no%>','<%=cont_ref%>','<%=cont_status%>');">&nbsp;&nbsp;
											<%=i+1%>
										</td>
										<td align="center">
