...
function exportToXls()
{
	...
	var url = "xls_qp_exposure.jsp?fileName="+comp_abbr+"-QP_Exposure_"+formattedDate+".csv&rpt_dt="+rpt_dt;
						...
						<table id="search_by_filter" class="table table-bordered" id="filterbysearch">
							<thead>
								<tr>
									...
									<th align="center">DEAL NUM<br><div align="center"><input class="form-control form-control-sm" type="text" id="deal_num" onkeyup="Search(this,'3');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">COUNTERPARTY<br><div align="center"><input class="form-control form-control-sm" type="text" id="cp" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div></th>
							...
							<tbody>
								...
								<%}else{ %>
									<tr>
										<td colspan=14 align="center"><%=utilmsg.infoMessage("<b>No QP Exposure Data is Available!</b>") %></td>
									</tr>
								<%} %>
							</tbody>
						</table>
