...
function refresh()
{
	...
	var url = "rpt_gx_accrual_accounting.jsp?u="+u+"&report_dt="+report_dt;
	if(execute_access=="Y")
	{
...
function exportToXls()
{
	...
	var url = "xls_gx_accrual_accounting.jsp?fileName= TransactionChargeAccrualReport.xls&report_dt="+report_dt;
							...
							<table class="table table-bordered table-hover" id="example">
								<thead>
									<tr <%if(isFreezed.equals("Y")){ %>style="background: skyblue;color:black;"<%} %>>
										<th>Sr#</th>										
										<th>Counterparty
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_Customer" onkeyup="Search(this,'0');" placeholder="Search.." style="width:100px"/></div>
										</th>
										<th>Gas Exchange</th>
										<th>Buy/Sell
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_buy_sell" onkeyup="Search(this,'2');" placeholder="Search.." style="width:100px"/></div>										
										</th>
										<th>Contract No
										...
										<th>Gx Business Unit
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_plant" onkeyup="Search(this,'6');" placeholder="Search.." style="width:100px"/></div>										
										</th>
										<th>Business Unit
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_bu" onkeyup="Search(this,'7');" placeholder="Search.." style="width:100px"/></div>										
										</th>
										<th>Cash Flow
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_cash_flow" onkeyup="Search(this,'8');" placeholder="Search.." style="width:100px"/></div>										
										</th>
										<th>Production Month 
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_month" onkeyup="Search(this,'9');" placeholder="Search.." style="width:100px"/></div>										
										</th>
