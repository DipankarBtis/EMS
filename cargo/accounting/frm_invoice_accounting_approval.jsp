								...
								<thead>
									<tr>
										...
										<th rowspan="2"><%=owner_abbr%> BU
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_bu" onkeyup="Search(this,'2');" placeholder="Search.." style="width:100px"/></div>
										</th>
										...
										<th rowspan="2">Contract/Trade Ref#
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_ContractRef" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div>
										</th>
										<th rowspan="2">Billing Period
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_billinng period" onkeyup="Search(this,'5');" placeholder="Search.." style="width:100px"/></div>
										</th>
										<th rowspan="2">Cash Flow
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_billinng period" onkeyup="Search(this,'6');" placeholder="Search.." style="width:100px"/></div>
										</th>
