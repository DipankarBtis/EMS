...
function refresh(user_id,user_cd)
{
	...
	document.forms[0].action = "../home/frm_requried_password_change.jsp";
			...
			<div class="card cardmain">
						...
						<div class="col-sm-8 col-xs-8 col-md-8">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<lable class='form-label form-control form-control-sm' name="user_lbl"><b><%=user_id%></b></lable>
				...
				<div class="card-footer cdfooter text-center">
					<div class="d-flex justify-content-between">
						<input type="button" class="btn btn-warning com-btn" value="Reset" onclick="refresh('<%=user_id%>','<%=user_cd%>');">
