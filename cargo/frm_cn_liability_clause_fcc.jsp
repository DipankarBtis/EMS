...
%>
<body style="pointer-events: none;" onload="enableLDDetails();enableTOPDetails();enableMUGDetails();">
							...
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<div class="input-group input-group-sm" >
			      						<input type="text" class="form-control form-control-sm" name="ld_price_per" id="ld_price_per" value="<%=ld_price_per %>" size="8" maxlength="8" onblur="checkValuePrecision(this.value,'2','3','ld_price_per')">
				    	...
				    	<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">  
								<div class="col-sm-5 col-xs-5 col-md-5">
									<div class="input-group input-group-sm"">
										<input type="text" class="form-control form-control-sm" name="ld_low_per" id="ld_low_per" value="<%=ld_low_per%>" onblur="checkValuePrecision(this.value,'2','3','ld_low_per')">	
										<span class="input-group-text">%</span>	
									</div>							
								</div>	
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<div class="input-group input-group-sm" >
			      						<input type="text" class="form-control form-control-sm" name="top_price_per" id="top_price_per" value="<%=top_price_per %>" size="8" maxlength="8" onblur="checkValuePrecision(this.value,'2','3','top_price_per')">
			      						<span class="input-group-text">%</span>
		      						</div>
				    			</div>
				    		</div>
					...
					<div class="row m-b-5">
		    			...
		    			<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">  
								<div class="col-sm-5 col-xs-5 col-md-5">
									<div class="input-group input-group-sm" >
										<input type="text" class="form-control form-control-sm" name="top_per" id="top_per" value="<%=top_per %>" size="5" maxlength="8" onblur="checkValuePrecision(this.value,'2','3','top_per')">
										<span class="input-group-text">%</span>
									</div>
								</div>
								<div class="col-sm-1 col-xs-1 col-md-1">
				    ...
				    <div class="row m-b-5">
				    	...
				    	<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
								<div class="col-sm-12 col-xs-12 col-md-12">
									<div class="input-group input-group-sm" >
			      						<input type="text" class="form-control form-control-sm" name="top_obligation" value="<%=top_obligation %>" size="8" maxlength="11">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<div class="input-group input-group-sm" >
			      						<input type="text" class="form-control form-control-sm" name="mug_price_per" id="mug_price_per" value="<%=mug_price_per %>" size="8" maxlength="8" onblur="checkValuePrecision(this.value,'2','2','mug_price_per')">
			      						<span class="input-group-text">%</span>
		      						</div>
				    			</div>
				    		</div>
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">  
								<div class="col-sm-6 col-xs-6 col-md-6">
									<div class="input-group input-group-sm" >
			      						<input type="text" class="form-control form-control-sm" name="mug_period_per" id="mug_period_per" value="<%=mug_period_per %>" size="5" maxlength="8" onblur="checkValuePrecision(this.value,'2','2','mug_period_per')">
			      						<span class="input-group-text">%</span>
		      						</div>
								</div>
								<div class="col-sm-6 col-xs-6 col-md-6">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<div class="input-group input-group-sm" >
			      						<input type="text" class="form-control form-control-sm" name="recovery_day" id="recovery_day" value="<%=recovery_day %>" size="5" maxlength="5" onblur="checkValuePrecision(this.value,'0','3','recovery_day')">
