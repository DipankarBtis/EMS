...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr valign="middle">
		<td colspan="7">
			<div align="center">
				<font size="1px" face="Arial">
					In respect of <%=entity_nm%> Contract(<%=contRef%>) executed on <%=signing_dt%>
					<br>
			...
			<div align="center">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>Vendor <%=inv_lineitem%>#:&nbsp;</b></font>
							</div>
						</td>
					</tr>
				</table>
...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr valign="bottom">
		...
		<td width="15%"><div align="center"><font size="1.5px" face="Arial"><b>Quantity</font></div></td>
	...
	<tr valign="top">
		...
		<td>
			<div align="left">
				<font size="1.5px" face="Arial"><%=entity_nm%> Service Fee for <%=str_cargoname%></font>
			</div>
		</td>
		<td>
			<div align="center">
		...
		<td>
			<div align="right">
				<font size="1.5px" face="Arial">
					...
					<%} %>
					<script> document.write(window.opener.document.forms[0].energy_unit_nm.value);</script>
				</font>
			</div>
		</td>
		<td>
