									...
									<tr>
										...
										<td align="center">
											...
											<%}else if(VSTATUS.elementAt(i).equals("O")){  %>
												<b><span class="alert alert-success">In Order</span></b>
											<%}else if(VSTATUS.elementAt(i).equals("C")){  %>
												<b><span class="alert alert-danger">Cancelled</span></b>
											<%}else if(VSTATUS.elementAt(i).equals("A")){  %>
												<b><span class="alert alert-secondary">Pending For Amendment</span></b>
											<%}else if(VSTATUS.elementAt(i).equals("R")){  %>
												<b><span class="alert alert-warning">Restated</span></b>
											<%}else if(VSTATUS.elementAt(i).equals("D")){  %>
												<b><span class="alert alert-info">Dummy</span></b>
											<%} %>
										</td>
									</tr>
									<%} %>
