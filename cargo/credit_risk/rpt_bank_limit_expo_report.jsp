...
var newWindow;
function openBankList(VMST_BANK_NM,VBANK_LIMIT,VBANK_LIMIT_USD)
{
	var report_dt = document.forms[0].report_dt.value;
	
	document.forms[0].bank_nm.value = VMST_BANK_NM;
	...
	{
		newWindow = window.open("rpt_bank_limit_expo_dtl.jsp?report_dt="+report_dt+"&bank_nm="+bank_nm+"&bank_lmt_inr="+bank_lmt_inr+"&bank_lmt_usd="+bank_lmt_usd,"Bank Limit List","top=10,left=10,width=1100,height=600,scrollbars=1");
	}
	else
	{
		newWindow.close();
...
function exportToXls()
{
	...
	var url = "xls_bank_limit_expo_report.jsp?fileName=Bank Limit And Exposure Report "+report_dt+".xls&report_dt="+report_dt+"&bank_nm="+bank_nm+"&bank_lmt_inr="+bank_lmt_inr+"&bank_lmt_usd="+bank_lmt_usd;
										...
										<tr>
											<td align="center">
												...
												<font title="Click to View Details" style="color:black">
													...
													onclick=" openBankList('<%=VMST_BANK_NM.elementAt(i)%>','<%=VBANK_LIMIT.elementAt(i)%>','<%=VBANK_LIMIT_USD.elementAt(i)%>');"></i>
												</font>&nbsp;
												<%}%>
											</td>
