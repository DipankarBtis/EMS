...
var newWindow;
function showDetails(detail,cust_nm,deal_id,total,prev_total)
{
	url="rpt_walkforward_expo_details.jsp?detail="+detail+"&cust_nm="+cust_nm+"&deal_id="+deal_id+"&total="+total+"&prev_total="+prev_total;
								...
								<tbody class="body1" id="body1" style="display:none;">
									...
									<tr>
										...
										<%for(j=j; j < VCUSTWISESETTLEMENTSELLCREDIT.size(); j++){ 
											...
											{%>
												<td title="Click to view detail" onclick="showDetails('<%=VINFO.elementAt(j)%>',&quot;<%=VCOUNTERPARTY_NM.elementAt(i)%>&quot;,'<%=originalDealId%>','<%=VCUSTWISESETTLEMENTSELLCREDIT.elementAt(j)%>','<%=VCUSTWISESETTLEMENTSELLCREDITFORPREVDT.elementAt(j)%>')">
								...
								<tbody class="body2" id="body2" style="display:none;">
									...
									<tr>
										...
										<%for(z=z; z < VCUSTWISESETTLEMENTSELLEXPOSURE.size(); z++){ 
											...
											{
											%>
												<td title="Click to view detail" onclick="showDetails('<%=VINFO1.elementAt(z)%>',&quot;<%=VSEC_COUNTERPARTY_NM.elementAt(i)%>&quot;,'<%=originalDealId%>','<%=VCUSTWISESETTLEMENTSELLEXPOSURE.elementAt(z)%>','<%=VCUSTWISESETTLEMENTSELLEXPOSUREFORPREVDT.elementAt(z)%>')">
