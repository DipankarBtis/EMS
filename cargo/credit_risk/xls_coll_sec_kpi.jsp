...
%>
	<table width="100%" border="1">
		<tr>
			<th colspan="20" rowspan="2" align="left">Collateral/Security KPI Report (<%=from_dt%> - <%=to_dt %>)</th>
		</tr>
	</table>
	<table width="100%" border="1">
		<thead>
	...
	<table width="100%" border="1">
		<thead>
			<tr>
				<th colspan="20">Incoming/Outgoing</th>
			</tr>
			<tr>
		...
		<%}else{%>
			<tr>
				<td colspan="20" align="center"><b>No Security Available in Selected Time Period!</b></td>
			</tr>
		<%} %>
		</tbody>
	</table>
