					...
					<div class="table-responsive">
						<table class="table table-bordered" id="filterbysearch">
							<thead>
								<tr>
									<th>Sr#</th>
									<th align="center">Last Updated On<div align="center"><input class="form-control form-control-sm" type="text" id="updated_on" onkeyup="Search(this,'1');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">Last Updated By<div align="center"><input class="form-control form-control-sm" type="text" id="updated_by" onkeyup="Search(this,'2');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">Counterparty Name<div align="center"><input class="form-control form-control-sm" type="text" id="counterparty_nm" onkeyup="Search(this,'3');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">Counterparty ABBR<div align="center"><input class="form-control form-control-sm" type="text" id="counterparty_abbr" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">Security Type<div align="center"><input class="form-control form-control-sm" type="text" id="sec_type" onkeyup="Search(this,'5');" placeholder="Search.." style="width:100px"/></div></th>
									...
									<th align="center">Contract#<br>[Contract/Trade Ref#]<div align="center"><input class="form-control form-control-sm" type="text" id="deal_no" onkeyup="Search(this,'7');" placeholder="Search.." style="width:100px"/></div></th>
									<th>Change Type</th>
								</tr>
							</thead>
							<tbody>
							<%if(VSECURITYDETAILS.size()>0){
								...
								<%} %>
								<%if(j<=0){ %>
									<tr><td colspan="9" align="center"><%=utilmsg.infoMessage("<b>Collateral Audit History Not Available for Selected Date!</b>") %></td></tr>
								<%} %>
							<%}else{ %>
								<tr><td colspan="9" align="center"><%=utilmsg.infoMessage("<b>Collateral Audit History Not Available for Selected Date!</b>") %></td></tr>
							<%} %>						
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="filterbysearch2">
							<thead>
								<tr>
									<th>Sr#</th>
									<th align="center">Last Updated On<div align="center"><input class="form-control form-control-sm" type="text" id="cr_updated_on" onkeyup="Search(this,'1');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">Last Updated By<div align="center"><input class="form-control form-control-sm" type="text" id="cr_updated_by" onkeyup="Search(this,'2');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">Counterparty/Bank Name<div align="center"><input class="form-control form-control-sm" type="text" id="cr_counterparty_nm" onkeyup="Search(this,'3');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">Counterparty/Bank ABBR<div align="center"><input class="form-control form-control-sm" type="text" id="cr_counterparty_abbr" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div></th>
							...
							<%if(VSECURITYDETAILS.size()>0){
								...
								<%} %>
								<%if(j<=0){ %>
									<tr><td colspan="7" align="center"><%=utilmsg.infoMessage("<b>Credit Rating/Limit Audit History Not Available for Selected Date!</b>") %></td></tr>
								<%}%>
							<%}else{ %>
								<tr><td colspan="7" align="center"><%=utilmsg.infoMessage("<b>Credit Rating/Limit Audit History Not Available for Selected Date!</b>") %></td></tr>
							<%} %>
