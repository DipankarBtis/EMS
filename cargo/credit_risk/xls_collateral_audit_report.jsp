...
%>
	<table width="100%" border="1">
		<tr>
			<th colspan="9" rowspan="2" align="left">Collateral Audit report (<%=from_dt%> - <%=to_dt%>)</th>
		</tr>
	</table>
	<table width="100%" border="1">
		<thead>
		...
		<%if(VSECURITYDETAILS.size()>0){
			...
			<%} %>
		<%}else{ %>
			<tr><td colspan="9" align="center"><b>Audit History Not Available for Selected Date!</b></td></tr>
		<%} %>
		</tbody>
	</table>
	<br>
	<table width="100%" border="1">
		<tr>
			<th colspan="7" rowspan="2" align="left">Limit Audit report (<%=from_dt%> - <%=to_dt%>)</th>
		</tr>
	</table>
	<table width="100%" border="1">
		<thead>
		...
		<%if(VSECURITYDETAILS.size()>0){
			...
			<%} %>
		<%}else{ %>
			<tr><td colspan="7" align="center"><b>Audit History Not Available for Selected Date!</b></td></tr>
		<%} %>
		</tbody>
	</table>
</body>
