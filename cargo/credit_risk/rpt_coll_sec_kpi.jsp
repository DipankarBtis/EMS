								...
								<table id="search_by_filter" class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th align="center">Counterparty<div align="center"><input class="form-control form-control-sm" type="text" id="counterparty_nm" onkeyup="Search(this,'1');" placeholder="Search.." style="width:100px"/></div></th>
											<th align="center">Security Type<div align="center"><input class="form-control form-control-sm" type="text" id="security_type" onkeyup="Search(this,'2');" placeholder="Search.." style="width:100px"/></div></th>
											...
											<th align="center">Deal Ref#<div align="center"><input class="form-control form-control-sm" type="text" id="dealNo" onkeyup="Search(this,'4');" placeholder="Search.." style="width:100px"/></div></th>
											<th align="center">Security Ref#<div align="center"><input class="form-control form-control-sm" type="text" id="security_reference_no" onkeyup="Search(this,'5');" placeholder="Search.." style="width:100px"/></div></th>
											<th align="center">Status<div align="center"><input class="form-control form-control-sm" type="text" id="stats" onkeyup="Search(this,'6');" placeholder="Search.." style="width:100px"/></div></th>
									...
									<%}else{ %>
										<tr>
											<td colspan="21" align="center"><%=utilmsg.infoMessage("<b>No Security Available in Selected Time Period!</b>") %></td>
										</tr>
									<%} %>
									</tbody>
								</table>
