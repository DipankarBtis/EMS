...
%>
	<table  width="100%" border="1">
		<tr>
			<th colspan="13" rowspan="2" align="left">Security Status Report <%=from_dt%></th>
		</tr>
	</table>
	<%int i=0;int k=0; int l=0; int j=0; int m=0; int c=0; int n=0; int b=0; int d=0;
		...
		<% if(j!=0)
			...
			<%} %>
				<table width="100%" border="1">
					<tr>
						<th colspan="13" rowspan="1" align="left"><%=VSEC_CATEGORY.elementAt(j)%> Security</th>
					</tr>
				</table>
			<table width="100%" border="1">
				<thead>
				...
				<tbody>
					...
					if(index > 0){
						...
						<%} %>
					<%}else{ %>
						<tr><td colspan="13" align="center"><b>No Security Status Available!</b></td></tr>
					<%} %>
				</tbody>
			</table>
		<%} %>
