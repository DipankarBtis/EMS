...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: var(--header_color);">
	<div class="container-fluid">
    	<a class="navbar-brand" href="#" style="padding-top: 2px;padding-left: 4px;padding-right: 2px;" onclick="homepage();">
    		<img src="<%if(!comp_logo.equals("")){%>../<%=CommonVariable.company_logo_path %>/<%=comp_logo%><%} %>" height="30px">&nbsp;<font style="font-size:24px; color:azure"> <%=CommonVariable.app_name%></font>
    	</a>
					    		...
					    		{%>
					    			<div class="col-auto"> 
										<div class="col-megamenu">
					            			<ul>
					              				<li><a class="dropdown-item" href="#"><%=VSUB_MENU_NM.elementAt(k)%></a></li>
      		...
      		<div class="d-flex">
		          ...
		          <!-- style="position: absolute;inset: 0px auto auto 0px;margin: 0px;transform: translate(-80px, 34px);" -->
		            ...
		            <li>
		            	...
		            	<%if(comp_cd.equals(VMENU_COMPANY_CD.elementAt(i).toString())){ %>style="background-color: #95c674;color:white;font-weight:bold;pointer-events: none;"<%} %>>
