...
Vector VSELECTED_PLANT_SEQ = svc.getVSELECTED_PLANT_SEQ();
Vector VSELECTED_PLANT_ABBR = svc.getVSELECTED_PLANT_ABBR();
Vector VSTATE_NM = svc.getVSTATE_NM();
Vector VSTATE_CODE = svc.getVSTATE_CODE();
Vector VPLANT_SEQ = svc.getVPLANT_SEQ();
...
String contpty_abbr=svc.getContpty_abbr();
String display_map_id=svc.getDisplay_map_id();

String sat_days = svc.getSat_days();
String holiday_state = svc.getHoliday_state();
String plant_seq = svc.getPlant_seq();
String disp_holiday_state = svc.getDisp_holiday_state();
String no_of_billing_dtl=svc.getNo_of_billing_dtl();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	<%=contpty_abbr%> [<%=display_map_id%>] Billing Details
					    </div>
					</div>
				</div>
