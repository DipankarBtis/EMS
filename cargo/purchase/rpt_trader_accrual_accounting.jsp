...
function refresh()
{
	...
	var url = "rpt_trader_accrual_accounting.jsp?u="+u+"&report_dt="+report_dt;
	if(execute_access=="Y")
	{
...
{
	var report_dt = document.forms[0].report_dt.value;	
	var url = "xls_trader_accrual_accounting.jsp?fileName= Accounting Purchase Accrual Report.xls&report_dt="+report_dt;
	location.replace(url);
}
</script>
</head>
...
String isFreezed=purchase.getIsFreezed();
String eodProcessDoneOn=purchase.getEodProcessDoneOn();
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader">
					    	Accounting Purchase Accrual Report
					    </div>
					    <div>
					...
					<div class="row">
						<div class="table-responsive">
							<table class="table table-bordered table-hover" id="example">
								...
								<%}else{ %>
									<tr>
										<td align="center" colspan="16"><%=utilmsg.infoMessage("<b>No Accrual Data Available!</b>") %></td>
									</tr>
								<%} %>
								</tbody>
							</table>
