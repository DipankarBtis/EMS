...
function openContList()
{
	...
	{
		newWindow = window.open("frm_trader_contract_list.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+contract_type+"&clearance="+clearance,"Trader Contract List","top=10,left=10,width=1100,height=600,scrollbars=1");
	}
	else
	{
		newWindow.close();
