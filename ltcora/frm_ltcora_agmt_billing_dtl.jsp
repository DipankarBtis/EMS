...
ltcora.setCallFlag("LTCORA_AGREEMENT_BILLING_DTL");
...
Vector VEXCHNG_RATE_CD = ltcora.getVEXCHNG_RATE_CD();
Vector VEXCHNG_RATE_NM = ltcora.getVEXCHNG_RATE_NM();
Vector VINT_RATE_CD = ltcora.getVINT_RATE_CD();
Vector VINT_RATE_NM = ltcora.getVINT_RATE_NM();

Vector VPLANT_NAME = ltcora.getVPLANT_NAME();
Vector VTAX_STRUCT_CD = ltcora.getVTAX_STRUCT_CD();
Vector VTAX_STRUCT_NM = ltcora.getVTAX_STRUCT_NM();
Vector VBU_PLANT_NM = ltcora.getVBU_PLANT_NM();

Vector VINVOICE_TYPE = ltcora.getVINVOICE_TYPE();	//Pratham Bhatt 20240821: for invoice_type
Vector VINVOICE_CATEGORY = ltcora.getVINVOICE_CATEGORY(); //Pratham Bhatt 20240822: for invoice_category

Vector VSELECTED_PLANT_SEQ = ltcora.getVSELECTED_PLANT_SEQ();
Vector VSELECTED_PLANT_ABBR = ltcora.getVSELECTED_PLANT_ABBR();
Vector VSTATE_NM = ltcora.getVSTATE_NM();
Vector VSTATE_CODE = ltcora.getVSTATE_CODE();
Vector VPLANT_SEQ = ltcora.getVPLANT_SEQ();

String billing_freq=ltcora.getBilling_freq();
String billing_flag=ltcora.getBilling_flag();
String due_date=ltcora.getDue_date();
String sec_due_date=ltcora.getSec_due_date();
String inv_currency=ltcora.getInv_currency();
String payment_currency=ltcora.getPayment_currency();
String interest_rate_cd=ltcora.getInterest_rate_cd();
String interest_cal_sign=ltcora.getInterest_cal_sign();
String interest_cal_per=ltcora.getInterest_cal_per();
String exchng_rate_cd=ltcora.getExchng_rate_cd();
String exchng_cal=ltcora.getExchng_cal();
String exchng_criteria=ltcora.getExchng_criteria();
String exchng_note=ltcora.getExchng_note();
String due_dt_in=ltcora.getDue_dt_in();
String exclude_sat=ltcora.getExclude_sat();
String exchg_val=ltcora.getExchg_val();
String billing_days = ltcora.getBilling_days();
String display_agmt_id = ltcora.getDisplay_agmt_id();
String counterparty_abbr = ltcora.getCounterparty_abbr();
String sat_days = ltcora.getSat_days();
String holiday_state = ltcora.getHoliday_state();
String plant_seq = ltcora.getPlant_seq();
String disp_holiday_state = ltcora.getDisp_holiday_state();
...
%>
<body onload="setBillingPeriod(document.forms[0].billing_flag);setBillingDays(document.forms[0].freq);enablechk();setValues('<%=sat_days%>');showDispState();setPlantState('<%=strPlant%>','<%=holiday_state%>');"><!-- setExchgVal(document.forms[0].exchng_rate); -->
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    <div class="topheader"> 
					    	LTCORA <%=counterparty_abbr%> [<%=display_agmt_id%>] Billing Details
					    </div>
					</div>
				</div>
...
<input type="hidden" name="option" value="LTCORA_AGREEMENT_BILLING_DTL">
