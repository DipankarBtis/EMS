...
function refresh(active_status)
{
	...
	var url = "../ltcora/frm_ltcora_cont_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&buy_sale="+buy_sale+"&contract_type="+contract_type+"&agreement_type="+agreement_type;
...
function refresh_date()
{
	...
	if(flag && flg)
	{
		if(trim(from_dt)!="" && trim(to_dt)!="")
		{
			...
			{
			var url = "../ltcora/frm_ltcora_cont_agmt_list.jsp?active_status="+active_status+"&counterparty_cd="+counterparty_cd+"&buy_sale="+buy_sale+
				"&contract_type="+contract_type+"&agreement_type="+agreement_type+"&from_dt="+from_dt+"&to_dt="+to_dt;
			location.replace(url);
			}
		}
	}
