...
%>
<body onload="setExchgVal(document.forms[0].exchng_rate);setBillingPeriod(document.forms[0].billing_flag);setBillingDays(document.forms[0].freq);enablechk();setValues('<%=sat_days%>');showDispState();setPlantState('<%=strPlant%>','<%=holiday_state%>');">
					    			...
					    			<div class="col-sm-12 col-xs-12 col-md-12">
					    				<select class="form-select form-select-sm" name="inv_currency">
								    		<option value="0">--Select--</option>
								     		...
								     		<%-- <%if(rate_unit.equals("2") || storage_tariff_unit.equals("2")){ %> 
