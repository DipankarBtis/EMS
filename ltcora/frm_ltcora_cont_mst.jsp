...
function refresh(opration,sale_buy)
{
	...
	var url = "frm_ltcora_cont_mst.jsp?counterparty_cd="+counterparty_cd+"&opration="+opration+"&u="+u+"&sale_buy="+sale_buy;
			...
			<div class="card cardmain">
				...
				<div class="card-body cdbody">
					...
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4"> 
				    		...
				    		<%}else{ %>
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    		<%} %>
				    				<select class="form-select form-select-sm" name="contract_type" onchange="refresh('<%=opration%>','<%=sale_buy%>');" <%if(opration.equals("MODIFY") && (!cont_no.equals("0") && !cont_no.equals(""))){ %>style="pointer-events: none;"<%} %>>
				    					<option value="S">CN</option>
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
				    			<label class="form-label"><b>LTCORA Tarrif</b></label>
				  			</div>
						</div>
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
						...
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
				    			<div class="col-auto">
				    				<select class="form-select form-select-sm" name="discount_flag" onchange="refresh('<%=opration%>','<%=sale_buy%>');" <%if(opration.equals("MODIFY") && (!cont_no.equals("0") && !cont_no.equals(""))){ %>style="pointer-events: none;"<%} %>>
				    					<option value="S">USD/MMBTU</option>
				    					<option value="S">INR/MMBTU</option>
				    				</select>
				      			</div>
				  			</div>
						</div>
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
				    			<label class="form-label"><b>SUG%</b></label>
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<div class="col-auto">
				    				<label class="form-label"><b><input type="checkbox" class="form-check-input" name="discount_flag" value="Y" >&nbsp;Discount Tarrif</b></label>
				  				</div>				    			
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<div class="col-auto">
				    				<label class="form-label"><b><input type="checkbox" class="form-check-input" name="discount_flag" value="Y" >&nbsp;Volume Discount</b></label>
				  				</div>				    			
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<div class="col-auto">
				    				<label class="form-label"><b><input type="checkbox" class="form-check-input" name="discount_flag" value="Y" >&nbsp;Advance Adjustment</b></label>
				  				</div>				    			
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<div class="col-auto">
				    				<label class="form-label"><b>Storage Charge Mode</b></label>
				  				</div>				    			
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<div class="col-auto">
				    				<label class="form-label"><b>Storage Charge Currency</b></label>
				  				</div>				    			
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
