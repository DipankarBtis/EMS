...
other_inv.setCallFlag("HSA_CRDR_APROVAL");
...
//other_inv.setBu_state_tin(bu_state_tin);
			...
			<div align="center">
				<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=crdr_berthing_hrs%>&nbsp;</b></font>
							</div>
						</td>
					</tr>
					<%} %>
...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr valign="bottom">
		...
		<%if(criteri_formula.contains("GRT")){ %>
			<td width="15%"><div align="center"><font size="1.5px" face="Arial"><b>Invoice GRT</b></font></div></td>
			<td width="15%"><div align="center"><font size="1.5px" face="Arial"><b>Applicable GRT</b></font></div></td>
			<td width="15%"><div align="center"><font size="1.5px" face="Arial"><b>Difference In GRT</b></font></div></td>
		<%}else{ %>
	...
	<tr valign="top">
		...
		<td>
			<div align="right">
				<font size="1.5px" face="Arial"><%=main_grt %></font>
			</div>
		</td>
		<td>
			<div align="right">
				<font size="1.5px" face="Arial"><%=new_grt %></font>
			</div>
		</td>
		<td>
			<div align="right">
				<font size="1.5px" face="Arial"><%=crdr_grt %></font>
			</div>
		</td>
		<%}else{ %>
		<td>
		...
		<td>
			<div align="right">
				<font size="1.5px" face="Arial"><%=new_qty_mmbtu %> M<font size="4px">&sup3</font></font>
			</div>
		</td>
	</tr>
</table>&nbsp;
...
<input type="hidden" name="option" value="HSA_CRDR_APPROVAL">
