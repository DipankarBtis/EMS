...
other_inv.setCallFlag("AHPL_SHARE_APPROVAL");
...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	...
	<tr valign="top">
		...
		<td>
			<div <%if(Double.parseDouble(""+VPDF_COL1.elementAt(i))/(int)Double.parseDouble(""+VPDF_COL1.elementAt(i))>1 && Double.parseDouble(""+VPDF_COL1.elementAt(i))>5){%>align="right"<%}else{%>align="left"<%} %>>
...
<input type="hidden" name="option" value="AHPL_SHARE_APPROVAL">
