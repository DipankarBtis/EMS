...
String bu_unit = request.getParameter("bu_seq")==null?"":request.getParameter("bu_seq");
//String msg=request.getParameter("msg")==null?"":request.getParameter("msg");
//String msg_type=request.getParameter("msg_type")==null?"":request.getParameter("msg_type");

other_inv.setCallFlag("OTH_INV_GA_APPROVAL");
...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr valign="bottom">
		<td rowspan="2" width="6%"><div align="center"><font size="1.5px" face="Arial"><b>Sr. No.</b></font></div></td>
		<td rowspan="2" width="34%"><div align="center"><font size="1.5px" face="Arial"><b>Description</b></font></div></td>
		<td rowspan="2" width="8%"><div align="center"><font size="1.5px" face="Arial"><b>HSN/SAC Code</b></font></div></td>
		<td rowspan="2" width="10%"><div align="center"><font size="1.5px" face="Arial"><b>Amount</b></font></div></td>
		<% if(supp_state.equals(vend_state)) { %>
			<td colspan="2" width="10%"><div align="center"><font size="1.5px" face="Arial"><b>CGST</b></font></div></td>
			<td colspan="2" width="10%"><div align="center"><font size="1.5px" face="Arial"><b>SGST</b></font></div></td>
			<td rowspan="2" width="20%"><div align="center"><font size="1.5px" face="Arial"><b>Total Amount</b></font></div></td>
		<%} else {%> 
			<td colspan="2" width="10%"><div align="center"><font size="1.5px" face="Arial"><b>IGST</b></font></div></td>
			<td rowspan="2" width="15%"><div align="center"><font size="1.5px" face="Arial"><b>Total Amount</b></font></div></td>
		<%}%>
		
	</tr>
	<tr valign="bottom">
		<% if(supp_state.equals(vend_state)) { %>
	        <td width="5%"><div align="center"><font size="1.5px" face="Arial"><b>Rate</b></font></div></td>
			<td width="8%"><div align="center"><font size="1.5px" face="Arial"><b>Amount</b></font></div></td>
			<td width="5%"><div align="center"><font size="1.5px" face="Arial"><b>Rate</b></font></div></td>
			<td width="8%"><div align="center"><font size="1.5px" face="Arial"><b>Amount</b></font></div></td>
	    <%} else {%> 
	   		<td width="8%"><div align="center"><font size="1.5px" face="Arial"><b>Rate</b></font></div></td>
			<td width="8%"><div align="center"><font size="1.5px" face="Arial"><b>Amount</b></font></div></td>
	    <%}%>
	</tr>
		<%for(int i=0; i<VPDF_COL1.size(); i++){ %>
			<%if(supp_state.equals(vend_state)) {%>
				<tr valign="top">
					...
					<%if(VPDF_COL2.elementAt(i).equals("<b>Gross Amount</b>") || VPDF_COL2.elementAt(i).equals("<b>Total Tax Amount</b>") 
							|| VPDF_COL2.elementAt(i).equals("<b>Total Amount in INR</b>")) {%>
						<td colspan="7">
...
<table border="0" width="100%" align="center" cellpadding="1" cellspacing="0">
	...
	<tr><td align="left"  style="text-align: left;"><font size="1.5px" face="Arial">&nbsp; <%=remark1 %></font></td></tr>
	<tr></tr>
</table>
<%} %>
&nbsp;&nbsp;
...
<input type="hidden" name="option" value="GA_APPROVAL">
...
<input type="hidden" name="bu_seq" value="<%=bu_unit%>">
