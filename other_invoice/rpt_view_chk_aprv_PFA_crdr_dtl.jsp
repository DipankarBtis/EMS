...
other_inv.setCallFlag("PFA_CRDR_APROVAL");
...
Vector VNSHIP_NAME = other_inv.getVNSHIP_NAME();
Vector VNQTY_MMBTU = other_inv.getVNQTY_MMBTU();
Vector VNCARGO_RATE = other_inv.getVNCARGO_RATE();
Vector VNCARGO_DATE = other_inv.getVNCARGO_DATE();
Vector VNCARGO_AMT = other_inv.getVNCARGO_AMT();
...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	...
	<tr valign="top">
		...
		<td>
		<%if(Double.parseDouble(""+VPDF_COL1.elementAt(i)) == 2) {%>
			<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
				<tr>
					<th>Cargo Date</th>				
					<th>Cargo Name</th>				
				...
				<% for(int j=0; j<VNSHIP_NAME.size(); j++) {%>
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><%=VNCARGO_DATE.elementAt(j)%></font>
							</div>
						</td>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><%=VNSHIP_NAME.elementAt(j)%></font>
							</div>
						</td>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><%=VNQTY_MMBTU.elementAt(j)%></font>
							</div>
						</td>
					</tr>
				<%} %>
			...
			<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
				...
				<% for(int j=0; j<VNSHIP_NAME.size(); j++) {%>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><%=VNCARGO_RATE.elementAt(j)%></font>
							</div>
						</td>
					</tr>
				<%} %>
			...
			<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
				...
				<% for(int j=0; j<VNSHIP_NAME.size(); j++) {%>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><%=VNCARGO_AMT.elementAt(j)%></font>
							</div>
						</td>
					</tr>
				<%} %>
...
<input type="hidden" name="option" value="PFA_CRDR_APPROVAL">
