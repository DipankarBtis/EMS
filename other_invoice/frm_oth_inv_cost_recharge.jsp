...
function refresh()
{
	...
	var url = "frm_oth_inv_cost_recharge.jsp?supp_cd="+supp_cd+"&vend_cd="+vend_cd+"&inv_dt="+inv_dt+"&currency="+curr
			+"&desc_item="+desc_item+"&amount="+amount+"&accord="+accord
...
other_inv.setCallFlag("OTH_INV_COST_RECHARGE");
										...
										<tbody id="itemTab">
											<tr>
												...
												<td align="center">
													...
													<%-- <input type="text" class="form-control form-control-sm" name="desc_item" maxlength="80" style="width:250px;" value="<%=desc_item%>"> --%>
												</td>
												<td align="center">
...
<input type="hidden" name="option" value="COST_RECHARGE">
