...
other_inv.setCallFlag("OTH_INV_RE_EXPORT_APPROVAL");
	  ...
	  <td colspan="3" width="50%">
		<div align="left">
		    <table cellpadding="0" cellspacing="0" border="1" 
		        style=" font-family: Arial; font-size: 1.5px; width: 50%;">
		        <tr>
		            <td><b>Per-Carriage By:</b></td><td><%= per_carriage %></td>
		        </tr>
		        <tr>
		            <td><b>Vessel/Flight No:</b></td><td><%= reference_no %></td>
		        </tr>
		        <tr>
		            <td><b>Port Of Discharge:</b></td><td><%= port_of_discharge %></td>
		        </tr>
		        <tr>
		            <td><b>Port Of Loading:</b></td><td><%= port_of_loading %></td>
		        </tr>
		        <tr>
		            <td><b>Final Destination:</b></td><td><%= final_destination %></td>
		        </tr>
		        <tr>
		            <td><b>Country Of Origin:</b></td><td><%= country_of_origin %></td>
		        </tr>
		        <tr>
		            <td><b>Terms Of Delivery And Payment:</b></td><td><%= pay_terms %></td>
		        </tr>
		    </table>
	    </div>
		</td>
		...
		<td colspan="3" width="40%">
			<div align="left">
				<font size="1.5px" face="Arial">
					...
					<br><%=vend_ship_abbr%>,<%=vend_ship_city%>
					<!-- <br> -->
					<br><%=vend_ship_state%>&nbsp;-&nbsp;<%=vend_ship_pin_no%>
					<br><br>
					<b>Billing Address:</b>&nbsp; 
					<br><%=vend_bill_abbr%>,<%=vend_bill_city%>
					<!-- <br> -->
					<br><%=vend_bill_state%>&nbsp;-&nbsp;<%=vend_bill_pin_no%>
				</font>
			</div>
		</td>
	</tr>
...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr valign="bottom">
		...
		<td width="30%"><div align="center"><font size="1.5px" face="Arial"><b>Description Of Goods</b></font></div></td>
		<td width="6%"><div align="center"><font size="1.5px" face="Arial"><b>UOM</b></font></div></td>
		<td width="20%"><div align="center"><font size="1.5px" face="Arial"><b>Packing Details</b></font></div></td>
		<td width="4%"><div align="center"><font size="1.5px" face="Arial"><b>Quantity</b></font></div></td>
		<td width="6%"><div align="center"><font size="1.5px" face="Arial"><b>Rate Per Qty</b></font></div></td>
		<td width=4%><div align="center"><font size="1.5px" face="Arial"><b>Currency</b></font></div></td>
		<td width=6%><div align="center"><font size="1.5px" face="Arial"><b>Amount</b></font></div></td>
	</tr>
		<%for(int i=0; i<VPDF_COL1.size(); i++){ %>
			<tr valign="top">
				...
				<td><div align="left"<%if(!VPDF_COL2.elementAt(i).equals("")) {%> style="white-space: pre-line;"<%}%>><font size="1.5px" face="Arial"><%=VPDF_COL3.elementAt(i).toString().trim()%></font></div></td>
				<td>
					<div align="center">
				...
				<td>
					<div align="left">
						<font size="1.5px" face="Arial">
						<%for(int j=i; j<=i; j++){ %>
                        <%=VPDF_COL5.elementAt(j).toString().replace("\n","<br>") %>
                        <% } %>
						</font>
					</div>
				</td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1">
	<tr>
		<td width="100%">
			<font size="1.5px" face="Arial"><b>Amount in Words &nbsp;&nbsp;| &nbsp;<%=currency_nm %>&nbsp;<%=amt_in_word %>&nbsp;Only</b></font>
		</td>
	</tr>
</table>
<table border="0" width="100%" align="center" cellpadding="2" cellspacing="0">
...
<input type="hidden" name="option" value="RE_EXPORT_APPROVAL">
