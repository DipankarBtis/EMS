...
function doSubmit()
{
	...
	var write_access = document.forms[0].write_access.value; //used write acces instead of check & approve access as per the requirement(check & approve access not required for RCM invoice)
	...
	if(operation=="APPROVE") 
	{
		if(write_access=="N")
		{
			msg+="You don't have Write Rights!\n";
			flag=false;
		}
	}
...
other_inv.setCallFlag("COST_RECHARGE_APROVAL");
...
String pacer_no = other_inv.getPacer_no();
String ref_no = other_inv.getRef_no();
			...
			<div align="center">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>Vendor/Supplier Inv Ref No:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>Pacer WO/PO No:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
				</table>
			...
			<div align="center">
				<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=ref_no%>&nbsp;</b></font>
							</div>
					...
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=pacer_no%>&nbsp;</b></font>
							</div>
...
<input type="hidden" name="option" value="COST_RECHARGE_APPROVAL">
