...
other_inv.setCallFlag("COST_RECHARGE_HPPL_APROVAL");
...
String purchase_no = other_inv.getPurchase_no();
			...
			<div align="center">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>Contract/Purchase Order No:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>Reference No.:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
				</table>
			...
			<div align="center">
				<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=purchase_no%>&nbsp;</b></font>
							</div>
...
<input type="hidden" name="option" value="COST_RECHARGE_HPPL_APPROVAL">
