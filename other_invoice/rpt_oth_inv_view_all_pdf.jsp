...
<jsp:useBean class="com.etrm.fms.other_invoice.DataBean_Other_Invoice" id="oth_inv" scope="request"></jsp:useBean>
<%
String financial_year=request.getParameter("financial_year")==null?"":request.getParameter("financial_year");
String supplier_cd=request.getParameter("supplier_cd")==null?"":request.getParameter("supplier_cd");
...
oth_inv.setCallFlag("VIEW_ALL_PDF");
oth_inv.setComp_cd(owner_cd);
oth_inv.setFin_yr(financial_year);
oth_inv.setSupplier_Cd(supplier_cd);
oth_inv.setInv_seq(invoice_seq);
oth_inv.setInv_type(invoice_type);
oth_inv.init();

Vector VPDF_FILE_NAME = oth_inv.getVPDF_FILE_NAME();
Vector VPDF_FILE_PATH = oth_inv.getVPDF_FILE_PATH();
