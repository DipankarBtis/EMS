...
other_inv.setCallFlag("HPPL_SHIPPING_AGENT_APROVAL");
...
String inv_due_dt = other_inv.getInv_due_dt();
...
String currency = other_inv.getCurrency();
String tax_structure = other_inv.getTax_name();
String tax_amt = other_inv.getTax_amt();
String total_gst = other_inv.getTotal_gst();
String desc_item = other_inv.getDesc_item();
String sale_amt = other_inv.getSale_amt();
String gross_amount = other_inv.getGross_amt();
String net_amt = other_inv.getNet_amt();
String fin_yr = other_inv.getFinanical_yr();
String inv_seq = other_inv.getInvoice_seq();
String tax_struct_dt = other_inv.getTax_struct_dt();
...
String grt = other_inv.getGrt();
String importer_nm = other_inv.getImporter_nm();
String inv_qty = other_inv.getInv_qty();
String berthing_hours = other_inv.getBerthing_hours();
String berthing_slots_no = other_inv.getBerthing_slots_no();
String rate = other_inv.getRate();
			...
			<div align="center">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<div align="right">
								<font face="Arial"><b>Importer:&nbsp;</b></font>
					...
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>Vessel Agent:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>No of Time Slots - 8 Hrs Berthing:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>No. of Hours Berthing:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
				</table>
			...
			<div align="center">
				<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=importer_nm%>&nbsp;</b></font>
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=vessel_agent_nm%>&nbsp;</b></font>
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=berthing_slots_no%>&nbsp;</b></font>
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=berthing_hours%>&nbsp;</b></font>
							</div>
						</td>
					</tr>
				</table>
			...
			<div align="center">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<div align="right">
								<font face="Arial"><b>Invoice No:&nbsp;</b></font>
					...
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b>Invoice Due Date:&nbsp;</b></font>							
							</div>
						</td>
					</tr>
				</table>
...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr valign="bottom">
		<td width="30%"><div align="center"><font size="1.5px" face="Arial"><b>Vessel Name</b></font></div></td>
		<td width="20%"><div align="center"><font size="1.5px" face="Arial"><b>Flag</b></font></div></td>
		<td width="15%"><div align="center"><font size="1.5px" face="Arial"><b>Cargo</b></font></div></td>
		<td width="15%"><div align="center"><font size="1.5px" face="Arial"><b>GRT</b></font></div></td>
		<td width="20%"><div align="center"><font size="1.5px" face="Arial"><b>Quantity</b></font></div></td>
	</tr>
	<tr valign="top">
		<td>
			<div align="center">
				<font size="1.5px" face="Arial"><%=vessel_nm %></font>
			</div>
		</td>
		<td>
			<div align="center">
				<font size="1.5px" face="Arial"><%=vessel_flag %></font>
			</div>
		</td>
		<td>
			<div align="center">
				<font size="1.5px" face="Arial"><%=vessel_item %></font>
			</div>
		</td>
		<td>
			<div align="right">
				<font size="1.5px" face="Arial"><%=grt %></font>
			</div>
		</td>
		<td>
			<div align="right">
				<font size="1.5px" face="Arial"><%=inv_qty %> M<font size="4px">&sup3</font></font>
			</div>
		</td>
	</tr>
</table>&nbsp;
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
	<tr valign="bottom">
		...
		<td width="10%"><div align="center"><font size="1.5px" face="Arial"><b>Unit</b></font></div></td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1">
	<tr>
		<td width="100%">
			<font size="1.5px" face="Arial"><b>Amount in Words &nbsp;&nbsp;| &nbsp;USD&nbsp;<%=amt_in_word %>&nbsp;Only</b></font>
		</td>
	</tr>
</table>
<table border="0" width="100%" align="center" cellpadding="2" cellspacing="0">
...
<table border="0" width="100%" align="center" cellpadding="2" cellspacing="0">
	...
	<tr><td valign="top"><font size="1.5px" face="Arial">2</font></td><td  align="left" style="text-align: left;"><font size="1.5px" face="Arial">&nbsp; <%=remark2 %></font></td></tr>
	<tr><td valign="top"><font size="1.5px" face="Arial">3</font></td><td  align="left"  style="text-align: left;"><font size="1.5px" face="Arial">&nbsp; <%=remark3 %></font></td></tr>
	<tr><td valign="top"><font size="1.5px" face="Arial">4</font></td><td  align="left"  style="text-align: left;"><font size="1.5px" face="Arial">&nbsp; <%=remark4 %></font></td></tr>
	<tr></tr>
</table>&nbsp;&nbsp;
<table border="0" width="100%" align="center" cellpadding="2" cellspacing="0">
	<tr valign="middle">
...
<input type="hidden" name="option" value="HPPL_SHIPPING_AGENT_APPROVAL">
