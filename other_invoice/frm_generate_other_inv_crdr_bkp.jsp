...
function refresh(operation)
{
	...
	if(flag)
	{
		var url = "frm_generate_other_inv_crdr.jsp?u="+u+"&invoice_type="+invoice_type+"&cr_dr_type="+cr_dr_type+
...
function difference()
{
	...
	if(new_tax_struct_info.startsWith("IGST"))
	{
		//document.getElementsByName("tax_amt")[0].value=diff.toFixed(2);
	}
	else
	{
...
other_inv.setCallFlag("CRDR_PREPARATION_LIST");
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="card cardmain">
					...
					<div class="row" <%if(operation.equals("MODIFY")){%>style="pointer-events: none;"<%}%>>
						...
						<div class="col-sm-6 col-xs-2 col-md-4">
							<div class="form-group row">
								...
								<div class="col">  
									<select class="form-select form-select-sm" name="invoice_type" onchange="refresh('<%=operation%>');">
				...
				<div class="card-body cdbody">
					...
					<div class="card-footer cdfooter text-center" <%if(type.equals("VIEW") && operation.equals("MODIFY")){ %> style="display: none;" <%}%>>
						<div class="d-flex justify-content-between">
