...
<jsp:useBean class="com.etrm.fms.other_invoice.DataBean_Oth_Inv_pdf_Gen" id="other_inv" scope="request"></jsp:useBean>
<%
...
String print_pdf_type=request.getParameter("pdf_type")==null?"":request.getParameter("pdf_type");
...
/* 	System.out.println("Pdf::"+print_pdf_type); */
	...
	other_inv.setCallFlag("PDF_OTHER_INVOICE");
	other_inv.init();
