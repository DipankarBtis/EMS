...
other_inv.setCallFlag("HPPL_SEIPL_APPROVAL");
			...
			<div align="center">
				<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><b><%=due_dt%>&nbsp;</b></font>
							</div>
			...
			<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
				...
				<% for(int j=0; j<VSHIP_NAME.size(); j++) {%>
					<tr>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><%=VCARGO_DT.elementAt(j)%></font>
							</div>
						</td>
						<td>
							<div align="center">
								<font size="1.5px" face="Arial"><%=VSHIP_NAME.elementAt(j)%></font>
							</div>
						</td>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><%=VQTY_MMBTU.elementAt(j)%></font>
							</div>
						</td>
					</tr>
				<%} %>
			...
			<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
				...
				<% for(int j=0; j<VSHIP_NAME.size(); j++) {%>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><%=VRATE.elementAt(j)%></font>
							</div>
						</td>
					</tr>
				<%} %>
			...
			<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0">
				...
				<% for(int j=0; j<VSHIP_NAME.size(); j++) {%>
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><%=VCARGO_AMT.elementAt(j)%></font>
							</div>
						</td>
					</tr>
				<%} %>
...
<input type="hidden" name="option" value="HPPL_SEIPL_APPROVAL">
