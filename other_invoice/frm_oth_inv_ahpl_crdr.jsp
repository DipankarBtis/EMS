...
function refresh(operation)
{
	...
	if(flag)
	{
		var url = "frm_oth_inv_ahpl_crdr.jsp?u="+u+"&invoice_type="+invoice_type+"&cr_dr_type="+cr_dr_type+
...
other_inv.setCallFlag("AHPL_CRDR_LIST");
...
<input type="hidden" name="option" value="GENERATE_AHPL_CR_DR">
