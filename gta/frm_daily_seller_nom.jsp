																			...
																			%>
																				<tr>
																					<td>
																						...
																						onclick="setSubEnableDisabled(this,'<%=l%>','<%=q%>');calculateSCM('<%=l%>');totalSubQty('<%=l%>');checkSubQty('<%=l%>','<%=q%>');totalQty();" disabled>
																					...
																					<td align="center">
																						<div style="width:100px;">
																							...
																							onblur="negNumber(this);checkNumber1(this,9,2);calculateSCM('<%=l%>');totalSubQty('<%=l%>');checkSubQty('<%=l%>','<%=q%>');totalQty();" disabled>
																						</div>
																					</td>
																					<td align="center">
																						<div style="width:100px;">
