...
function refresh()
{
	...
	if(flag)
	{
		var url = "rpt_parking_imbalance.jsp?counterparty_cd="+counterparty_cd+
...
function openContList()
{
	...
	var url="frm_gta_nom_contract_list.jsp?counterparty_cd="+counterparty_cd+"&contract_type="+contract_type;
...
function exportToXls()
{
	...
	if(flag)
	{
		var url = "xls_parking_imbalance.jsp?counterparty_cd="+counterparty_cd+
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="card cardmain">
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th rowspan="2" title="=(Entry Pt. Allocation - Exit Pt. Allocation)">Derived Parking/ Deparking<br>(MMBTU)</th>
										<th rowspan="2" title="=Adjusted Imbalance">Adjusted Imbalance<br>(MMBTU)</th>
										<th rowspan="2" title="=Cummulative (Deparking + Adjusted Imbalance)">Cummulative Parking<br>(MMBTU)</th>
									</tr>
									<tr>
				...
				<div class="card-body cdbody">
					<div align="center">
						<%if(contract_type.equals("K") && (counterparty_cd.equals("") || counterparty_cd.equals("0"))){ %> 
