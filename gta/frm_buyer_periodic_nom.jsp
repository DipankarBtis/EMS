																					...
																					<tr>
																							...
																							<div style="width:150px;">
																								<div class="row m-b-5">
																									<div class="col-auto">
																										...
																										onclick="setSubEnableDisabled(this,'<%=l%>','<%=q%>');calculateSCM('<%=l%>');totalSubQty('<%=l%>');checkQty('<%=l%>');" disabled>
																						...
																						<td align="center">
																							<div style="width:100px;">
																								...
																								onblur="negNumber(this);checkNumber1(this,9,2);calculateSCM('<%=l%>');totalSubQty('<%=l%>');checkQty('<%=l%>');" disabled>
																								<%-- checkTCQ('<%=l%>'); --%>
																							</div>
																						</td>
																						<td align="center">
