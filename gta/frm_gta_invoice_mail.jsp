...
remittance.setCallFlag("GTA_SEND_INVOICE_MAIL");
...
remittance.setMail_inv_type(mail_inv_type);
...
Vector VMAIL_BCC_LIST = remittance.getVMAIL_BCC_LIST();
...
String path ="/"+CommonVariable.work_dir+owner_cd+"/"+CommonVariable.gta_inv_path+sub_folder2+"//";
/* if(invoice_type.equals("F"))
{
	path ="/"+CommonVariable.work_dir+owner_cd+"/"+CommonVariable.signed_freeflow_inv_path+sub_folder2+"//";
} */
