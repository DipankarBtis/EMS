...
%>
<body onload="<%if(!msg.equals("")){ %>DoRefresh()<%}%>">
									...
									<%if(VAGMT_NO.size()>0){ %>
										...
										<tr>
											<td align="center">
												...
												<%if(Integer.parseInt(""+VROW_COUNT.elementAt(i)) > 0 && VIS_ATTACHED.elementAt(i).equals("Y")) {%>style="pointer-events: none;"<%} %>
												>
											</td>
											<td align="center"><%=VDIS_DEAL_NO.elementAt(i)%></td>
											<td><%=VCONT_REF_NO.elementAt(i)%></td>
											<td align="center"><%=VSTART_DT.elementAt(i)%> - <%=VEND_DT.elementAt(i)%></td>
											<td align="center"><%=VROW_INFO.elementAt(i)%> = <%=VROW_COUNT.elementAt(i)%></td>
										</tr>
										<%} %>
									<%}else{ %>
										<tr>
											<td colspan="5" align="center"><%=utilmsg.infoMessage("<b>Sales Contract is not Available!</b>") %></td>
										</tr>
									<%} %>
									</tbody>
								</table>
