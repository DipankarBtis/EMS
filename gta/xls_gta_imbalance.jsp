...
String file_nm="CT_ImbalanceReport_"+from_dt.replaceAll("/", "")+"_"+to_dt.replaceAll("/", "")+".xls";
%>
<body>
<%
...
%>
<h2><b>CT Imbalance Report From <%=from_dt%> To <%=to_dt%></b></h2>
<table border="1">
	<thead>
		<tr>
			...
			<th rowspan="2">Adjusted Imbalance<br>(MMBTU)</th>			
