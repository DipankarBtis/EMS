...
%>
<body onload="<%if(activity_type.equals("PREPARE") && sg_submission_chk) {%>doEnabled('P');<%}else{%>doEnabled('<%=default_chk %>');<%}%>difference();copyInvoiceNo();<%if(!msg.equals("")){%>refreshParent();<%}%>"
								...
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th rowspan="2"><%if(invoice_type.equals("PC")){ %>Parking<%}else{%>GTC<%} %> <br>[Contract Ref#]</th>
										...
										<tr <%if(!activity_type.equals("PREPARE") && !activity_type.equals("APPROVE")) {%>style="pointer-events: auto;"<%} %>>
											...
											<th>
												<span class="badge rounded-pill" style="background:orange;color:black;font-size:12px;">
													<input type="radio" name="gta_invoice_type" value="S" <%if(!activity_type.equals("PREPARE") && default_chk.equals("S")){ %>checked<%}else if(default_chk.equals("S")){%>checked<%} %> onclick="doEnabled(this.value);">&nbsp;System Generated
												</span>
											</th>
											<th>
												<span class="badge rounded-pill" style="background:skyblue;color:black;font-size:12px;">
													<input type="radio" name="gta_invoice_type" value="P" onclick="doEnabled(this.value);" <%if(activity_type.equals("PREPARE") && sg_submission_chk){%>checked<%}else if(default_chk.equals("P")){ %>checked<%} %> <%if(!sg_submission_chk){ %>disabled<%} %>>&nbsp;Party Generated
												</span>
											</th>
											<th>
												Difference
									...
									<tbody>
										...
										<tr id="tab_parking_qty">
											...
											<td align="center">
												<div style="width:250px;">
													<div class="input-group input-group-sm" >
														<input type="text" class="form-control form-control-sm" name="sys_parking_qty" value="<%=parking_qty%>" readOnly>
														<span class="input-group-text">MMBTU</span>
													</div>
													<input type="hidden" name="sys_parking_amt" value="<%=parking_amt%>" readOnly>
												</div>
											</td>
											<td align="center">
												<div style="width:250px;">
													<div class="input-group input-group-sm" >
														<input type="text" class="form-control form-control-sm" name="party_parking_qty" value="<%=pg_parking_qty%>"
														onkeyup=" partyGenCalc();difference();checkNumber1(this,13,3);">
														<span class="input-group-text">MMBTU</span>
													</div>
													<input type="hidden" name="party_parking_amt" value="<%=pg_parking_amt%>" readOnly>
												</div>
											</td>
											<td></td>
										</tr>
										<tr id="tab_parking_chrg">
											...
											<td align="center">
												<div style="width:250px;">
													<div class="input-group input-group-sm" >
														<input type="text" class="form-control form-control-sm" name="sys_parking_rate" value="<%=parking_rate%>" readOnly>
														<span class="input-group-text"><%=price_cd_nm%>/MMBTU</span>
													</div>
												</div>
											</td>
											<td align="center">
												<div style="width:250px;">
													<div class="input-group input-group-sm" >
														<input type="text" class="form-control form-control-sm" name="party_parking_rate" value="<%=pg_parking_rate%>" 
														onkeyup=" partyGenCalc();difference();<%if(price_cd.equals("1")){ %>checkNumber1(this,6,2);<%}else{ %>checkNumber1(this,6,4);<%}%>">
														<span class="input-group-text"><%=price_cd_nm%>/MMBTU</span>
													</div>
												</div>
											...
											<td align="center">
												<div style="width:250px;">
													<div class="d-flex justify-content-between">
														...
														onclick="doGenXML('<%=counterparty_cd%>','<%=invoice_no%>',
														 '<%=financial_year%>','<%=invoice_seq%>','<%=contract_type%>',
														 'S','<%=invoice_type%>','<%=sap_approval_flag%>',
														 '<%=trans_bu_seq%>','<%=agmt_no%>','<%=cont_no%>','N','VIEW');"
														style="color: orange;">													
														</i>
														<%} %>
											...
											<td align="center">
												<div style="width:250px;">
													<div class="d-flex justify-content-between">
														...
														<i class="fa fa-file-code-o fa-2x" 
														onclick="doGenXML('<%=counterparty_cd%>','<%=pg_invoice_no%>',
														 '<%=financial_year%>','<%=invoice_seq%>','<%=contract_type%>',
														 'P','<%=invoice_type%>','<%=pg_sap_approval_flag %>',
														 '<%=trans_bu_seq%>','<%=agmt_no%>','<%=cont_no%>','N','VIEW');"
														style="color: orange;">													
														</i>
														<%} %>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<input type="radio" name="final_aprv" value="S" <%if(!invoice_auth_flag.equals("Y")){ %>disabled<%} %> <%if(!invoice_aprv_flag.equals("") || default_chk.equals("S")){ %>checked<%} %>>&nbsp;System Generated&nbsp;&nbsp;&nbsp;
				    				<input type="radio" name="final_aprv" value="P" <%if(!pg_invoice_auth_flag.equals("Y")){ %>disabled<%} %> <%if(!pg_invoice_aprv_flag.equals("") || default_chk.equals("P")){ %>checked<%} %>>&nbsp;Party Generated
				      				<br>
...
<input type="hidden" name="cont_ref" value="<%=contRef%>">
