...
customer_cd=counterparty_cd;

gta.setCallFlag("SALES_CONT_LIST");
								...
								<table class="table table-bordered" id="example">
									...
									<%if(VAGMT_NO.size()>0){ %>
										...
										<tr>
											...
											<td align="center"><%=VDIS_DEAL_NO.elementAt(i)%><br>(<%=VCONT_REF_NO.elementAt(i)%>)</td>
											<td align="center"><%=VSTART_DT.elementAt(i)%> - <%=VEND_DT.elementAt(i)%></td>
											<td align="center"><%=VBU_POINT.elementAt(i)%></td>
											<td align="center"><%=VDELV_POINT.elementAt(i)%></td>
											<td align="center"><%=VCUST_PLANT_POINT.elementAt(i)%></td>
