																	...
																	%>
																		<tr>
																			<td align="center" valign="middle" <%if(VNOM_BLOCK.elementAt(l).equals("Y")) {%>style="background: #df9fbf;" title="Invoice Generated!"<%} %>>
																				...
																				onclick="setEnableDisabled(this,'<%=l%>');calculateSCM('<%=l%>');totalQty();"
																			...
																			<td align="center">
																				<div style="width:100px;">
																					...
																					<%-- onpaste="doPaste('<%=j%>','<%=l%>');"  --%>
																					onblur="negNumber(this);checkNumber1(this,9,2);checkQty('<%=l%>');checkTCQ('<%=l%>');calculateSCM('<%=l%>');totalQty();" disabled>
																		...
																		if(index1>0){ %>
																			<tbody id="tbody<%=j%>" style="display:;">
																				<tr style="font-weight: bold;background:#bce6ff;text-align: center;">
																					<td rowspan="<%=index1+2%>" colspan="7" style="background:white;"></td>
																				...
																				<tr>
																						...
																						<div style="width:150px;">
																							<div class="row m-b-5">
																								<div class="col-auto">
																									...
																									onclick="setSubEnableDisabled(this,'<%=l%>','<%=q%>');calculateSCM('<%=l%>');totalSubQty('<%=l%>');checkQty('<%=l%>');checkTCQ('<%=l%>');totalQty();" disabled>
																					...
																					<td align="center">
																						<div style="width:100px;">
																							...
																							onblur="negNumber(this);checkNumber1(this,9,2);calculateSCM('<%=l%>');totalSubQty('<%=l%>');checkQty('<%=l%>');checkTCQ('<%=l%>');totalQty();" disabled>
																						</div>
																					</td>
																					<td align="center">
																						<div style="width:100px;">
