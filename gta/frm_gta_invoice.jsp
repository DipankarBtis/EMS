								...
								<div class="col-auto">
					  			...
					  			<div class="col">
					  				<select class="form-select form-select-sm" name="filter_trans_cd" onchange="refresh();">
					  					...
					  					<option value="<%=VFILTER_TRANS_CD.elementAt(i)%>"><%=VFILTER_TRANS_NAME.elementAt(i)%></option>
					  					<%} %>
					  				</select>
					  				<script>document.forms[0].filter_trans_cd.value="<%=filter_trans_cd%>"</script>
					  			</div>
					  		</div>
					  	</div>
					  	<div class="col-md-3 col-sm-6 col-xs-6">
								...
								<div class="col-auto">
					  			...
					  			<div class="col">
					  				<select class="form-select form-select-sm" name="filter_contract">
					  					...
					  					<option value="<%=VFILTER_MAPPING_ID.elementAt(i)%>"><%=VFILTER_DEAL_NO.elementAt(i)%></option>
					  					<%} %>
					  				</select>
					  				<script>document.forms[0].filter_contract.value="<%=filter_contract%>"</script>
					  			</div>
					  		</div>
					  	</div>
					  	<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="form-group row">
								<div class="col-auto">
					  			...
					  			<div class="col">
					  				...
					  				<script>document.forms[0].filter_remittance.value="<%=filter_remittance%>"</script>
					  			</div>
					  		</div>
					  	</div>
					  	<div class="col-md-3 col-sm-6 col-xs-6">
											...
											<thead>
												<tr>
													...
													<th>View PDF
												    	...
												    	<%} else if(invoice_type.equals("PC")){ %>	
												    	<script>document.getElementById("<%=invoice_type.toLowerCase()%>_inv_title").value="<%=pc_inv_title%>"</script>
												    	<%} %>
													</th>
													<th>Send Mail</th>
												</tr>
													...
													<tr>
														...
														<td align="center">
															...
															onclick="doGenXML('<%=VCOUNTERPTY_CD.elementAt(i)%>','<%=VINVOICE_NO.elementAt(i)%>',
															 ...
															 '<%=VBU_PLANT_SEQ.elementAt(i)%>','<%=VAGMT_NO.elementAt(i)%>','<%=VCONT_NO.elementAt(i)%>','<%=VPDF_INV_FLAG.elementAt(i)%>','<%=VREMITTANCE_NO.elementAt(i)%>');"
															style="<%if(!VAPPROVE_FLAG_CHECK.elementAt(i).equals("Y")){ %>
																pointer-events: none; opacity: .65; color: gray;
																<%} else{%>
													...
													<tr>
														...
														<td align="center">
															...
															onclick="doGenXML('<%=VOTH_COUNTERPTY_CD.elementAt(i)%>','<%=VOTH_REMITTANCE_NO.elementAt(i)%>',
															 '<%=VOTH_FINANCIAL_YEAR.elementAt(i)%>','<%=VOTH_INVOICE_SEQ.elementAt(i)%>','<%=VOTH_CONTRACT_TYPE.elementAt(i)%>',
															 '<%=VOTH_TYPE_FLAG.elementAt(i)%>','<%=VOTH_INVOICE_TYPE.elementAt(i)%>','<%=VOTH_SAP_APPROVAL_FLAG.elementAt(i)%>',
															 '<%=VOTH_BU_PLANT_SEQ.elementAt(i)%>','<%=VOTH_AGMT_NO.elementAt(i)%>','<%=VOTH_CONT_NO.elementAt(i)%>','<%=VOTH_PDF_INV_FLAG.elementAt(i)%>','<%=VOTH_REMITTANCE_NO.elementAt(i)%>');"
...
<input type="hidden" name="prv_month" value="<%=month%>">
<input type="hidden" name="prv_year" value="<%=year%>">
