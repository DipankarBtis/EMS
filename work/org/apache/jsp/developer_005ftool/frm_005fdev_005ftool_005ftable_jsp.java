 ...
 * Generated at: 2026-04-03 09:35:24 UTC
...
public final class frm_005fdev_005ftool_005ftable_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0; i<VTABLE_NM.size(); i++){ 
      ...
      out.print(i);
      out.write("');\">\n															</div>\n														</td>\n														<td align=\"left\">\n															");
      out.print(VTABLE_NM.elementAt(i));
      out.write("\n															<input type=\"hidden\" name=\"tbl_nm\" id=\"tbl_nm");
      out.print(i);
      out.write("\" value=\"");
      out.print(VTABLE_NM.elementAt(i));
      out.write("\" disabled>\n														</td>\n														<td align=\"center\">");
      out.print(VRETENTION_DT.elementAt(i));
      out.write("</td>\n														<td align=\"right\">");
      out.print(VROW.elementAt(i));
      out.write("</td>\n														<td>\n															<div class=\"form-check form-switch\">\n																<input class=\"form-check-input\" name=\"archive_active\" type=\"checkbox\" role=\"switch\" id=\"archive_active");
      out.print(i);
      out.write('"');
      out.write(' ');
if(VARCHIVE_FLAG.elementAt(i).equals("Y")){
      out.write("checked");
}
      out.write(" onclick=\"setActiveInactive(this,'");
      out.print(i);
      out.write("', 'archive_lb', 'archive_flag')\" disabled>\n															  	<label class=\"form-check-label\" for=\"archive_active");
      out.print(i);
      out.write("\" id=\"archive_lb");
      out.print(i);
      out.write("\">\n															  		");
if(VARCHIVE_FLAG.elementAt(i).equals("Y")){
      out.write('Y');
      ...
      out.write("\n															  	</label>\n															  	<input type=\"hidden\" name=\"archive_flag\" id=\"archive_flag");
      out.print(i);
      out.write("\" value=\"");
      out.print(VARCHIVE_FLAG.elementAt(i));
      out.write("\" disabled>\n															</div>\n														</td>\n														<td align=\"center\">\n															<select class=\"form-select form-select-sm\" name=\"archival_logic\" id=\"archival_logic");
      out.print(i);
      out.write("\" style=\"pointer-events: none;\" disabled>\n					      										<option value=\"\">--Select--</option>\n					      										");
for(int j=0; j<((Vector)(VARCHIVE_LOGIC.elementAt(i))).size(); j++) { 
      out.write("\n					      										<option value=\"");
      out.print(((Vector)(VARCHIVE_LOGIC.elementAt(i))).elementAt(j));
      out.write('"');
      out.write('>');
      out.print(((Vector)(VARCHIVE_LOGIC.elementAt(i))).elementAt(j));
      out.write("</option>\n					      										");
} 
      out.write("			    \n					      									</select>\n					      									<script>\n					      									document.getElementById(\"archival_logic");
      out.print(i);
      out.write("\").value='");
      out.print(VARCHIVE_LOGIC_VALUE.elementAt(i));
      out.write("'\n					      									</script>\n														</td>\n														<td align=\"right\">");
      out.print(VARCHIVABLE_ROW.elementAt(i) );
...
if(Integer.parseInt(""+VARCHIVABLE_ROW.elementAt(i)) > 0  && VARCHIVED_TABLE_NAME.elementAt(i).equals("")) {
      ...
      out.write("\n															></i>	\n															</div>\n														</td>\n														<td>");
      out.print(VARCHIVED_TABLE_NAME.elementAt(i));
      out.write("</td>\n														<td align=\"right\">");
      out.print(VARCHIVED_ROW.elementAt(i) );
      out.write("</td>\n														<td>\n															<div align=\"center\">\n																<i class=\"fa fa-trash-o fa-lg\" \n																	");
if(Integer.parseInt(""+VARCHIVED_ROW.elementAt(i)) > 0) {
      out.write("\n																		style=\"color:red;\"\n																		onclick=\"doDeleteArchiveTbl('");
      out.print(VARCHIVED_TABLE_NAME.elementAt(i));
      out.write("')\"\n																	");
}else{ 
      out.write("\n																		style=\"color:grey;\"\n																	");
