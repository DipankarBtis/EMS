 ...
 * Generated at: 2026-02-20 05:00:15 UTC
...
public final class frm_005fsvc_005fbilling_005fdtl_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      com.etrm.fms.cargo.DB_cargo_service_cont_master svc = null;
      svc = (com.etrm.fms.cargo.DB_cargo_service_cont_master) _jspx_page_context.getAttribute("svc", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (svc == null){
        svc = new com.etrm.fms.cargo.DB_cargo_service_cont_master();
        _jspx_page_context.setAttribute("svc", svc, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      out.write('\r');
      out.write('\n');
...
for(int i=0; i<VSELECTED_PLANT_SEQ.size(); i++){ 
 ...
 for(int j=0; j<VSTATE_CODE.size(); j++){ 
      ...
      out.print(start_dt);
      out.write("\">\r\n<input type=\"hidden\" name=\"provisional_rate_unit\" value=\"");
      out.print(provisional_rate_unit);
      out.write("\">\r\n<input type=\"hidden\" name=\"final_rate_unit\" value=\"");
      out.print(final_rate_unit);
