 ...
 * Generated at: 2026-03-09 06:46:53 UTC
...
public final class frm_005fadd_005fmodify_005fgroup_005fallocation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0; i<VEMP_CD.size(); i++){ 
      ...
      out.write("\n				      				</select>\n				      				<script>document.forms[0].user_cd.value='");
      out.print(user_cd);
...
for(int i=0; i<VGROUP_CD.size(); i++){ 
      ...
      out.print(sysdate);
      out.write("\" maxLength=\"10\" onblur=\"validateDate(this);checkFromToDate(this,document.forms[0].to_dt,'F');checkFromSysdate('");
      out.print(sysdate );
      out.write("')\" onchange=\"validateDate(this);checkFromToDate(this,document.forms[0].to_dt,'F');checkFromSysdate('");
      out.print(sysdate );
      ...
      out.print(sysdatePlusOneYr);
      out.write("\" maxLength=\"10\" onblur=\"validateDate(this);checkFromToDate(document.forms[0].from_dt,this,'T');checkToSysdate('");
      out.print(sysdate );
      out.write("')\" onchange=\"validateDate(this);checkFromToDate(document.forms[0].from_dt,this,'T');checkToSysdate('");
      out.print(sysdate );
...
if(isSupAdmn.equals("Y")){ 
      out.write("\n												<div align=\"center\">\n													<font title=\"Click to Edit\" style=\"color:var(--header_color)\"><i class=\"fa fa-edit fa-lg\" onclick=\"setValues('");
      out.print(VALLOCATED_GRP_CD.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VALLOCATED_FRM_DT.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VALLOCATED_TO_DT.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VALLOCATED_GRP_NM.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
