 ...
 * Generated at: 2026-04-10 06:56:40 UTC
...
public final class frm_005fadd_005fmodify_005fgroup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0; i<VGROUP_CD.size(); i++){ 
      out.write("\n									<tr>\n										<td>\n											<div align=\"center\">\n												<input class=\"form-control form-control-sm\" name=\"group_cd\" id=\"group_cd");
      out.print(VGROUP_CD.elementAt(i) );
      out.write("\" type=\"text\" maxlength=\"2\" style=\"width:75px;\" value=\"");
      out.print(VGROUP_CD.elementAt(i) );
      out.write("\" readonly>\n											</div>\n										</td>\n										<td>\n											<div align=\"center\">\n												<input class=\"form-control form-control-sm\" name=\"group_nm\" id=\"group_nm");
      out.print(VGROUP_NM.elementAt(i) );
      out.write("\" type=\"text\" maxlength=\"50\" style=\"width:380px;\" value=\"");
      out.print(VGROUP_NM.elementAt(i) );
      out.write('"');
      out.write(' ');
if(VGROUP_CD.elementAt(i).equals("1") || VGROUP_CD.elementAt(i).equals("2")) {
      out.write("readonly");
} 
      out.write(">\n											</div>\n										</td>\n										<td>\n											<div class=\"form-check form-switch\">\n												<input class=\"form-check-input\" name=\"active\" type=\"checkbox\" role=\"switch\" id=\"flexSwitchCheckChecked\" ");
if(VACTIVE.elementAt(i).equals("Y")){
      out.write("checked");
}
...
if(VACTIVE.elementAt(i).equals("Y")){
      ...
      out.write("\n											  	</label>\n											  	<input type=\"hidden\" name=\"active_flag\" id=\"active_flag");
      out.print(VGROUP_CD.elementAt(i) );
      out.write("\" value=\"");
      out.print(VACTIVE.elementAt(i));
      out.write("\">\n											</div>\n										</td>\n										<td>\n											<div align=\"center\">\n												<select class=\"form-select form-select-sm\" name=\"group_owner\" id=\"group_owner");
      out.print(VGROUP_CD.elementAt(i));
      out.write("\">\n						      						<option value=\"0\"> -- Select -- </option>\n						      						");
for(int e=0;e<VEMP_CD.size();e++){
      out.write("\n						      							<option value=\"");
      out.print(VEMP_CD.elementAt(e));
      out.write('"');
      out.write('>');
      out.print(VEMP_NM.elementAt(e) );
      out.write("</option>\n						      						");
}
      out.write('\n');
      out.write("\n													<script>document.getElementById(\"group_owner\"+\"");
      out.print((i+2));
      out.write("\").value = '");
      out.print(VGROUP_OWNER.elementAt(i));
...
if(write_access.equals("Y")){ 
      ...
      out.write("\n						</div>\n					</div>\n				</div>\n			</div>\n		</div>\n	</div>\n</div>\n\n<input type=\"hidden\" name=\"option\" value=\"GROUP_MST\">\n<input type=\"hidden\" name=\"module_size\" id=\"group_size\" value=\"");
      out.print(VGROUP_CD.size()+1);
      out.write("\">\n<input type=\"hidden\" name=\"vemp_cd\" id=\"vemp_cd\" value=\"");
      out.print(VEMP_CD);
      out.write("\">\n<input type=\"hidden\" name=\"vemp_nm\" id=\"vemp_nm\" value=\"");
      out.print(VEMP_NM);
