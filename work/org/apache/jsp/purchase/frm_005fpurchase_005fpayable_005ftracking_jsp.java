 ...
 * Generated at: 2026-04-23 10:55:35 UTC
...
public final class frm_005fpurchase_005fpayable_005ftracking_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int i=0;int k=0;
      ...
      out.print(j);
      out.write("');\" placeholder=\"Search..\" style=\"width:100px\"/></div>\r\n										</th>\r\n										<th rowspan=\"2\">\r\n											Billing Period\r\n											<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"table_billing");
      out.print(j );
      out.write("\" onkeyup=\"Search(this,'3','");
      out.print(j);
      out.write("');\" placeholder=\"Search..\" style=\"width:100px\"/></div>\r\n										</th>\r\n										<th rowspan=\"2\">Remittance#<br>[Invoice Type]</th>\r\n										<th rowspan=\"2\">\r\n											Invoice#\r\n											<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"table_InvoiceNo");
      out.print(j );
      out.write("\" onkeyup=\"Search(this,'5','");
      out.print(j);
...
for(i=i; i<VCOUNTERPTY_CD.size(); i++){ 
      ...
      out.write("\" disabled>\r\n											<input type=\"hidden\" name=\"bu_unit\" id=\"bu_unit");
      out.print(i);
      out.write("\" value=\"");
...
if(!VSPLIT_VALUE.elementAt(i).equals("")){ 
      ...
      out.write("</td>\r\n										<td align=\"center\">");
      out.print(VDIS_REMITTANCE_NO.elementAt(i));
      out.write("\r\n											<input type=\"hidden\" name=\"remittance_no\" id=\"remittance_no");
      out.print(i);
      out.write("\" value=\"");
      ...
      out.print(i);
      out.write("\" value=\"");
      out.print(VINV_FLG.elementAt(i));
      out.write("\" disabled>\r\n											<input type=\"hidden\" name=\"invoice_flag\" id=\"invoice_flag");
      out.print(i);
      out.write("\" value=\"");
      out.print(VINVOICE_FLAG.elementAt(i));
      out.write("\" disabled>\r\n										</td>\r\n										<td align=\"center\">");
      ...
      out.write("\r\n											<input type=\"hidden\" name=\"gross_amt_usd\" id=\"gross_amt_usd");
      out.print(i);
      out.write("\" value=\"");
      out.print(VGROSS_AMT_USD.elementAt(i));
      out.write("\">\r\n										</td>\r\n										<td align=\"right\">");
      ...
      out.write("</td>\r\n										<td align=\"right\">");
      out.print(VTAX_AMT_USD.elementAt(i) );
      out.write("\r\n											<input type=\"hidden\" name=\"tax_amt_usd\" id=\"tax_amt_usd");
      out.print(i);
      out.write("\" value=\"");
      out.print(VTAX_AMT_USD.elementAt(i));
      out.write("\">\r\n										</td>\r\n										<td align=\"right\">");
      ...
      out.write("\r\n											<input type=\"hidden\" name=\"invoice_amt_usd\" id=\"invoice_amt_usd");
      out.print(i);
      out.write("\" value=\"");
      out.print(VINVOICE_AMT_USD.elementAt(i));
      out.write("\">\r\n										</td>\r\n										<td align=\"right\">");
      ...
      out.write("</td>\r\n										<td align=\"right\">");
      out.print(VTCS_AMT_USD.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\">");
      out.print(VTCS_AMT.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\">");
      out.print(VTDS_FACTOR.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\">");
      out.print(VTDS_AMT_USD.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\">");
      out.print(VTDS_AMT.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\">");
      out.print(VNET_PAYABLE_USD.elementAt(i) );
      out.write("\r\n											<input type=\"hidden\" class=\"form-control form-control-sm\" name=\"net_payable_amt_usd\" id=\"net_payable_amt_usd");
      out.print(i);
      out.write("\" value=\"");
      out.print(VNET_PAYABLE_USD.elementAt(i));
      out.write("\" style=\"text-align:right;\" disabled readOnly>\r\n										</td>\r\n										<td align=\"right\">");
      out.print(VNET_PAYABLE.elementAt(i) );
      out.write("\r\n											<input type=\"hidden\" class=\"form-control form-control-sm\" name=\"net_payable_amt\" id=\"net_payable_amt");
      out.print(i);
      out.write("\" value=\"");
      out.print(VNET_PAYABLE.elementAt(i));
      out.write("\" style=\"text-align:right;\" disabled readOnly>\r\n										</td>\r\n										<td align=\"center\">");
...
if(VPAYMENT_DONE_IN.elementAt(i).equals("USD")){ 
      out.write("#b3ff99");
}else{ 
      out.write("#b3f0ff");
}
      ...
      out.print(VPAY_COLOR.elementAt(i));
      ...
      out.write("\" style=\"text-align:right;\" disabled readOnly>\r\n											</div>\r\n											<input type=\"hidden\" class=\"form-control form-control-sm\" name=\"temp_short_receiverd\" id=\"temp_short_received");
      out.print(i);
      out.write("\" \r\n											value=\"");
      out.print(VSHORT_RECEIVED.elementAt(i));
      ...
      out.print(i);
      out.write("\" \r\n						      						value=\"\" maxLength=\"10\" onchange=\"validateDate(this);checkPayReceviDt(this,'");
      out.print(i);
      ...
      out.write("\r\n									<tr>\r\n										<td colspan=\"32\">\r\n											<div align=\"center\">");
      out.print(utilmsg.infoMessage("<b>No Remittance generated for Report Period!</b>"));
      out.write("</div>\r\n										</td>\r\n									</tr>\r\n								");
} 
      out.write("\r\n								</tbody>\r\n							</table>\r\n						</div>\r\n					</div>\r\n					");
} 
