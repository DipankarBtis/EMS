 ...
 * Generated at: 2026-04-03 13:55:40 UTC
...
public final class rpt_005fnomination_005fallocation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0;i<VCOUNTERPARTY_CD.size();i++){ 
      ...
      out.write("\" maxLength=\"50\" readOnly style=\"font-weight:bold;\">\r\n				      				<input type=\"hidden\" class=\"form-control form-control-sm\" name=\"hid_cont_no\" value=\"");
      out.print(cont_name);
      ...
      out.write("\" maxLength=\"2\" readOnly>\r\n				    			</div>\r\n				  			</div>\r\n						</div>\r\n						<div class=\"col-sm-6 col-xs-6 col-md-6\" align=\"center\">\r\n							<div class=\"btn-group\">\r\n								<select class=\"btn btn-sm select_btn\" name=\"sel_trad_plant\" onchange=\"refresh('");
      out.print(clearance);
...
for(int i=0; i<VSEL_PLANT_SEQ_NO.size(); i++){ 
      ...
      out.write("\r\n								</select>\r\n								<select class=\"btn btn-sm select_btn\" name=\"sel_bu_plant\" onchange=\"refresh('");
      out.print(clearance);
...
for(int i=0; i<VSEL_BU_PLANT_SEQ_NO.size(); i++){ 
      ...
      out.write("\r\n								</select>\r\n							</div>\r\n							<script>document.forms[0].sel_trad_plant.value=\"");
      out.print(sel_trad_plant);
      out.write("\"</script>\r\n							<script>document.forms[0].sel_bu_plant.value=\"");
      out.print(sel_bu_plant);
      out.write("\"</script>\r\n						</div>\r\n					</div>\r\n				</div>\r\n			</div>\r\n			&nbsp;\r\n			<div class=\"card cardmain\" ");
if((cont_no.equals("") || cont_no.equals("0")) && (cont_rev_no.equals("") || cont_rev_no.equals("0"))){
...
for(int i=0; i<VGAS_DT.size(); i++){ 
      ...
      out.print(VBUYER_COLOR.elementAt(i));
      out.write('"');
      out.write('>');
      out.print(VBUYER_QTY_MMBTU.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\" style=\"background:");
      out.print(VBUYER_COLOR.elementAt(i));
      out.write('"');
      out.write('>');
      out.print(VBUYER_QTY_SCM.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\" style=\"background:");
      out.print(VSELLER_COLOR.elementAt(i));
      out.write('"');
      out.write('>');
      out.print(VSELLER_QTY_MMBTU.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\" style=\"background:");
      out.print(VSELLER_COLOR.elementAt(i));
      out.write('"');
      out.write('>');
      out.print(VSELLER_QTY_SCM.elementAt(i) );
      out.write("</td>\r\n										<td align=\"right\" style=\"background:");
      ...
      out.print(total_buyer_mmbtu );
      out.write("</b></td>\r\n										<td align=\"right\"><b>");
      out.print(total_buyer_scm );
      out.write("</b></td>\r\n										<td align=\"right\"><b>");
      out.print(total_seller_mmbtu );
      out.write("</b></td>\r\n										<td align=\"right\"><b>");
      out.print(total_seller_scm );
      out.write("</b></td>\r\n										<td align=\"right\"><b>");
      out.print(total_alloc_mmbtu );
      out.write("</b></td>\r\n										<td align=\"right\"><b>");
      out.print(total_alloc_scm );
      ...
      out.write("\">\r\n\r\n<input type=\"hidden\" name=\"tmp_from_dt\" value=\"");
      out.print(from_dt);
      out.write("\">\r\n<input type=\"hidden\" name=\"tmp_to_dt\" value=\"");
      out.print(to_dt);
      out.write("\">\r\n<input type=\"hidden\" name=\"cont_st_dt\" value=\"");
      out.print(start_dt);
      out.write("\">\r\n<input type=\"hidden\" name=\"cont_end_dt\" value=\"");
      out.print(end_dt);
      out.write("\">\r\n<input type=\"hidden\" name=\"cont_cargo\" value=\"");
      out.print(cont_cargo);
