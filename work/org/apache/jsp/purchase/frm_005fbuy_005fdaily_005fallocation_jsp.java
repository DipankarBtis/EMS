 ...
 * Generated at: 2026-04-03 13:53:46 UTC
...
public final class frm_005fbuy_005fdaily_005fallocation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("				if(nom_block.value!=\"Y\")\n				{\n					setEnableDisabled(chk,index)\n				}\n				else\n				{\n					//moleConfigBtn.style.display=\"\";\n					moleConfigBtn.disabled = false;\n					calcRemainMoleQty(index);\n				}\n			}\n		}\n	}\n}\n</script>\n</head>\n");
...
if(VCOUNTERPATY_STATUS.elementAt(i).equals("N")){ 
      ...
      out.print(i);
      out.write("\" disabled value=\"MM\" onclick=\"variableMolecule('");
      out.print(i);
      out.write("');\">\n													");
...
if(mole_exist.equals("Y")){ 
      ...
      out.print(x);
      out.write("');\" \n												onchange=\"negNumber(this);checkNumber1(this,9,2);calculateSCM('");
      out.print(x);
      out.write("');calcRemainMoleQty('");
      out.print(x);
