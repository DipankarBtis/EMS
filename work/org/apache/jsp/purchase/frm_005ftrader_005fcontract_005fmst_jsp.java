 ...
 * Generated at: 2026-03-13 10:17:53 UTC
...
public final class frm_005ftrader_005fcontract_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("	var ent_time = document.forms[0].ent_time.value;\r\n	var start_dt = document.forms[0].start_dt.value;\r\n	var end_dt = document.forms[0].end_dt.value;\r\n	var rate = document.forms[0].rate.value;\r\n	var rate_unit = document.forms[0].rate_unit.value;\r\n	var tcq = document.forms[0].tcq.value;\r\n	var quantity_unit = document.forms[0].quantity_unit.value;\r\n	var dcq = document.forms[0].dcq.value;\r\n	var cont_status_flg = document.forms[0].cont_status_flg.value;\r\n	\r\n	var no_of_billing_dtl = document.forms[0].no_of_billing_dtl.value;\r\n	var no_of_security_dtl = document.forms[0].no_of_security_dtl.value;\r\n	var no_of_liability_dtl = document.forms[0].no_of_liability_dtl.value;\r\n	\r\n	var agreement_type = document.forms[0].agreement_type;\r\n	var agreement_base = document.forms[0].agreement_base;\r\n	var transportation_charges = document.forms[0].transportation_charges.value\r\n	\r\n	var split_enabled=document.forms[0].split_enabled.value\r\n	\r\n	var chk_plant = document.forms[0].chk_plant;\r\n	var chk_oth_plant = document.forms[0].chk_oth_plant;\r\n");
...
"#ENTDT="+ent_dt+"#ENTTIME="+ent_time+"#STARTDT="+start_dt+"#ENDDT="+end_dt+"#RATE="+rate+"#RATEUNIT="+rate_unit+"#TCQ="+tcq+"#DCQ="+dcq+"#QUNIT="+quantity_unit+"#MDCQ="+mdcq_percentage+"#GXFEE="+txn_charges+"#GXFEEUNIT="+txn_unit+"#POSTMARG="+post_margin+"#CONT_STATUS="+cont_status;
      ...
      out.write(',');
      out.write('\'');
      out.print(strOthChargehistdesc);
...
if(rate_unit.equals("1")){ 
      ...
      out.write(" \r\n				      				");
if(opration.equals("MODIFY") && cont_status.equals("Y") && fcc_flg.equals("Y")) {
      out.write("readOnly");
} 
...
if(cont_status_flg.equals("C")||cont_status_flg.equals("T")){
}else if(!is_nominated.equals("Y")){
      out.write("Buyer nomination is not done!");
}else if(!is_expired.equals("Y")){
      out.write("Contract is active,Terminate the contract!");
}
      out.write("\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Closure Request\" ");
if(opration.equals("MODIFY")&&!counterparty_cd.equals("0")&&!cont_no.equals("")&&!cont_status_flg.equals("X") && is_expired.equals("Y") && !closure_req_flag.equals("Y") && !closure_req_flag.equals("R") && !cont_status_flg.equals("C") && !cont_status_flg.equals("T") && is_nominated.equals("Y") && !cont_status_flg.equals("R")){
      out.write("onclick=\"doClosure('C');\"");
}else{
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
} 
...
if(cont_status_flg.equals("C")||cont_status_flg.equals("T")){
      ...
      out.write("Buyer nomination is done for this contract,close/terminate it!");
}
      out.write("\">\r\n				    				");
      out.write("\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Cancel Contract\" ");
if(opration.equals("MODIFY")&&!counterparty_cd.equals("0")&&!cont_no.equals("")&&!cont_status_flg.equals("X") && !closure_req_flag.equals("Y") && !closure_req_flag.equals("R")&& !cont_status_flg.equals("C") && !cont_status_flg.equals("T") && !is_nominated.equals("Y")){
...
if(cont_status_flg.equals("C")||cont_status_flg.equals("T")){
      ...
      out.write("Contract is expired,Close the contract!");
}else if(!termination_forced.equals("Y")){
      out.write("For Termination, configure Termination/Suspention (Force Majeure) clause!");
}
      out.write("\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Terminate Request\" \r\n				    				");
if(opration.equals("MODIFY")&&!counterparty_cd.equals("0")&&!cont_no.equals("")&&!cont_status_flg.equals("X") && !is_expired.equals("Y")&&termination_forced.equals("Y") && is_nominated.equals("Y")&& !closure_req_flag.equals("Y") && !closure_req_flag.equals("R") && !cont_status_flg.equals("C") && !cont_status_flg.equals("T") && !cont_status_flg.equals("R")){
      out.write("onclick=\"doClosure('T');\"");
}else{
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
}
      out.write(">\r\n				    			</div>\r\n				    			<!-- /Terminate Button -->\r\n				    			<!-- RE-OPEN REQUEST BUTTON -->\r\n				    			<div class=\"col-auto\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Re-Open Request\" \r\n				    				");
if(opration.equals("MODIFY")&&!counterparty_cd.equals("0")&&!cont_no.equals("")&&(cont_status_flg.equals("C")||cont_status_flg.equals("T"))&&!closure_req_flag.equals("O")){
      out.write("onclick=\"doReopen();\"");
}else{
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
}
      out.write(">\r\n				    			</div>\r\n				    			<!-- /RE-OPEN REQUEST BUTTON -->\r\n				  			</div>\r\n						</div>\r\n					</div>\r\n					<br>\r\n					");
...
for(int i=0; i<VFORMULA_ID.size(); i++){ 
      ...
      out.write("</span>\r\n					    		</div>\r\n					    	</div>\r\n					    </div>\r\n					</div>\r\n				</div>\r\n				<div class=\"cdbody\">\r\n      				<div class=\"row\">\r\n						<div class=\"col-sm-12 col-xs-12 col-md-12\">  \r\n							<div class=\"form-group row\">\r\n								<div class=\"d-flex justify-content-end\">\r\n					    			<label class=\"form-label\">\r\n					    				<b>\r\n					    					<input type=\"checkbox\" class=\"form-check-input\" name=\"chk_split\" onclick=\"splitEnabled(this, '");
      out.print(enable_split);
      out.write("');\">&nbsp;Split Trader(% wise)\r\n					    					<input type=\"hidden\" name=\"split_enabled\" value=\"");
      out.print(split_flag);
...
for(int i=0; i<VPLANT_SEQ_NO.size(); i++){ 
      ...
      out.print(i);
      out.write("','','");
      out.print(VNOM_SEL_TRADER_CHK.elementAt(i));
...
for(j=j; j<VOTH_PLANT_SEQ_NO.size(); j++){ 
      ...
      out.print(j);
      out.write("','oth','");
      out.print(VNOM_SEL_OTH_TRADER_CHK.elementAt(j) );
      ...
      out.write("\" disabled>\r\n						      						</td>\r\n						      						<td>\r\n					      								");
      out.print(VOTH_PLANT_ABBR.elementAt(j));
      out.write("&nbsp;\r\n					      								<i name=\"oth_history_btn_");
      out.print(VOTH_PLANT_SEQ_NO.elementAt(j));
      out.write("\" id=\"oth_history_btn_");
      out.print(VOTH_PLANT_SEQ_NO.elementAt(j));
      out.write("\" style=\"pointer-events: auto; color:#800040\" class=\"fa fa-info-circle fa-lg\" aria-hidden=\"true\"></i>\r\n						      						</td>\r\n						      						<td>\r\n						      							<div class=\"col-auto\" id=\"hid_col_oth_split_");
      out.print(oth_countpty_cd);
      out.write('_');
      out.print(VOTH_PLANT_SEQ_NO.elementAt(j));
 ...
 for(int m=0; m<VCHARGE_ABBR.size(); m++){ 
      ...
      out.write('_');
      out.print(m);
      out.write("');\"\r\n									      						 autocomplete=\"off\" disabled>\r\n									      						<input type=\"hidden\"name=\"max_oth_eff_dt_");
      out.print(VCHARGE_ABBR.elementAt(m));
      out.write("\" id=\"max_oth_eff_dt_");
      out.print(VCHARGE_ABBR.elementAt(m));
      out.write('_');
      out.print(j);
      out.write('_');
...
if(!cont_status_flg.equals("X") && !cont_status_flg.equals("C") && !cont_status_flg.equals("T")){
      ...
      out.write("\">\r\n\r\n<input type=\"hidden\" name=\"change_request\" value=\"\">\r\n<INPUT TYPE=\"hidden\" name=\"closure_req_flag\" value=\"");
      out.print(closure_req_flag );
