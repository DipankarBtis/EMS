 ...
 * Generated at: 2026-03-27 06:33:06 UTC
...
public final class rpt_005fdigital_005fsignature_005fsummary_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      com.etrm.fms.accounting.DataBean_Accounting contract = null;
      contract = (com.etrm.fms.accounting.DataBean_Accounting) _jspx_page_context.getAttribute("contract", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (contract == null){
        contract = new com.etrm.fms.accounting.DataBean_Accounting();
...
if (VINVOICE_TYPE.elementAt(i).equals("DERIVATIVE INVOICE")) { 
      ...
      out.write("<br>");
 if(!VCONT_REF_NO.elementAt(i).equals("") && VCONT_REF_NO.elementAt(i)!=null){
      out.write('[');
 ...
 if(!VCONT_REF_NO.elementAt(i).equals("") && VCONT_REF_NO.elementAt(i)!=null){
      ...
      out.write("</td>\r\n												<td align=\"center\">");
      out.print( VSIGNED_BY.elementAt(i) );
      out.write("</td>\r\n												<td align=\"center\">");
      ...
      out.print(utilmsg.infoMessage("<b>Digital Signature Data Not Available for Selected Period!</b>") );
      out.write("</td>\r\n										</tr>\r\n								  	");
} 
