 ...
 * Generated at: 2026-03-03 12:24:47 UTC
...
public final class frm_005foth_005finv_005fsun_005fxml_005fre_005fapproval_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      com.etrm.fms.extn_interface.DataBean_oth_inv_sun_interface accounting = null;
      accounting = (com.etrm.fms.extn_interface.DataBean_oth_inv_sun_interface) _jspx_page_context.getAttribute("accounting", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (accounting == null){
        accounting = new com.etrm.fms.extn_interface.DataBean_oth_inv_sun_interface();
...
for(int i=0; i<VINVOICE_NO.size();i++){
      ...
      out.print(VACCOUNT_CD.elementAt(i) );
      out.write("\r\n												</td>\r\n												<td align=\"center\">");
      out.print(VACCOUNT_TYPE_NM.elementAt(i));
      out.write("</td>\r\n												<td align=\"center\">");
