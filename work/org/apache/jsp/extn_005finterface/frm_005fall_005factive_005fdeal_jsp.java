 ...
 * Generated at: 2026-02-24 11:40:37 UTC
...
public final class frm_005fall_005factive_005fdeal_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/extn_interface/../util/common_js.jsp", Long.valueOf(1770199628000L));
  }
...
String execute_access = menu_access.getExecute_access();
      ...
      com.etrm.fms.extn_interface.DataBean_sf_interface db_intrface = null;
      db_intrface = (com.etrm.fms.extn_interface.DataBean_sf_interface) _jspx_page_context.getAttribute("db_intrface", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (db_intrface == null){
        db_intrface = new com.etrm.fms.extn_interface.DataBean_sf_interface();
...
int j=0,k=0,l=0,m=0;
      ...
      out.print(l);
      out.write("\">\r\n								    			");
      out.print(VSEGMENT_NM.elementAt(i));
      out.write("\r\n								      		</button>	\r\n								    	</h2>\r\n										<div id=\"collapse");
      out.print(l);
      ...
      out.write("\">\r\n															<thead id=\"tbsearch");
      out.print(i);
      out.write("\">\r\n																<tr>\r\n																	<th>Check All\r\n																		<br><input type=\"checkbox\"  id=\"check_all");
      out.print(i);
      out.write(">\" class=\"form-check-input\" \r\n																		onclick=\"chkAllCont(this,document.forms[0].dwn_checkbox");
      out.print(i);
      out.write(",document.forms[0].dwn_checkbox_flag");
      out.print(i);
      out.write(")\"> \r\n																	 </th>\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Customer Name</th>\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Deal Type</th>	\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Deal#</th>	\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Contract/Trade Ref#</th>	\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Contract Duration</th>	\r\n																	<!-- <th>Buy/Sell</th>	 --><!-- As only sell Deals will come -->\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Status</th>					\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Last Updated</th>\r\n																	<th class=\"tbser");
      out.print(i);
      out.write("\">Sales-force XML Status</th>\r\n																	<!-- <th>Download</th> -->	\r\n																</tr>\r\n															</thead>\r\n															<tbody>\r\n																");
if(VCOUNTERPARTY_CD.size()>0 && index>0){
																	k=0; 
																	for(l=l; l<VCOUNTERPARTY_CD.size();l++){
																		k+=1;
      out.write("\r\n																	<tr style=\"background:");
      out.print(VSF_ROW_COLOR.elementAt(l));
      out.write("\"\r\n																		");
if(VSF_ROW_COLOR.elementAt(l).equals("#f2f2f2")){ 
      out.write("title=\"Purchased MMBTU is not mapped for contract.\"");
}
      out.write(">\r\n																		<td align=\"center\">\r\n																			<div align=\"center\">\r\n																				");
if(VSF_XML_STATUS.elementAt(l).equals("N")){
      out.write("\r\n																					<input type=\"checkbox\" class=\"form-check-input\" name=\"dwn_checkbox");
      out.print(i);
      out.write("\" id=\"dwn_checkbox");
      out.print(i);
      out.print(l);
      out.write("\" \r\n																					onclick=\"setAccessFlag(this,'dwn_checkbox_flag");
      out.print(i);
      out.print(l);
      out.write("');\">\r\n																					<input type=\"hidden\" name=\"dwn_checkbox_flag");
      out.print(i);
      out.write("\" id=\"dwn_checkbox_flag");
      out.print(i);
      out.print(l);
      out.write("\" value=\"");
      out.print(VCONT_XML_GEN_MAPPING.elementAt(l));
      ...
      out.write("<br>(");
      out.print(VCONT_SF_NO.elementAt(l)  );
      out.write(")</td>\r\n																		<td align=\"center\">");
      out.print(VCONT_REF_NO.elementAt(l) );
      out.write("</td>\r\n																		<td align=\"center\">");
      out.print(VCONT_START_DT.elementAt(l) );
      out.write(' ');
      out.write('-');
      out.write(' ');
      out.print(VCONT_END_DT.elementAt(l) );
      out.write("</td>\r\n																		<td align=\"center\">");
      out.print(VCONT_STATUS.elementAt(l) );
      out.write("</td>\r\n																		<td align=\"center\">");
      out.print(VLAST_MODIFY_DT.elementAt(l) );
      out.write("</td>\r\n																		<td align=\"left\">\r\n																			<!-- <div align=\"center\"> -->\r\n																				<font style=\"color:");
if(VSF_XML_STATUS.elementAt(l).equals("N")){
      out.write("#a6ff4d");
}else{
      ...
      out.print(VCONT_SF_XML_GEN_DT.elementAt(l) );
...
if(k==index){
      ...
      out.print(utilmsg.infoMessage("<b>No Active Deals are Available for "+VSEGMENT_NM.elementAt(i)+"!</b>") );
      out.write("</td>\r\n																	</tr>\r\n																");
} 
      out.write("\r\n															</tbody>\r\n														</table>\r\n													</div>\r\n												</div>\r\n											</div>\r\n										</div>\r\n									</div>\r\n								</div>\r\n							</div>\r\n						</div>\r\n					");
}
