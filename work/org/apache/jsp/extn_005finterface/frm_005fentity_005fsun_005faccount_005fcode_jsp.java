 ...
 * Generated at: 2026-03-05 11:00:52 UTC
...
public final class frm_005fentity_005fsun_005faccount_005fcode_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("						var sun_plant_account = document.getElementById(\"sun_plant_account_\"+entity_role+\"_\"+index+\"_\"+i);\r\n						sun_plant_account.disabled=false;\r\n						\r\n						for(j=0;j<acc_type_count;j++)\r\n						{\r\n							var sun_entity_plant_account = document.getElementById(\"sun_entity_plant_account_\"+entity_role+\"_\"+index+\"_\"+j+\"_\"+i);\r\n							sun_entity_plant_account.disabled=false;\r\n						}\r\n					}\r\n				}\r\n				else\r\n				{\r\n					for(i=0;i<plant_indx;i++)\r\n					{\r\n						var sun_plant_account = document.getElementById(\"sun_plant_account_\"+entity_role+\"_\"+index+\"_\"+i);\r\n						sun_plant_account.disabled=true;\r\n						\r\n						for(j=0;j<acc_type_count;j++)\r\n						{\r\n							var sun_entity_plant_account = document.getElementById(\"sun_entity_plant_account_\"+entity_role+\"_\"+index+\"_\"+j+\"_\"+i);\r\n							sun_entity_plant_account.disabled=true;\r\n						}\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n}\r\n\r\nfunction chkNumber(obj)\r\n{\r\n	if(isNaN(obj.value))\r\n	{\r\n		alert(\"SUN Code must be Numeric!\");\r\n		obj.value='';\r\n		return false;\r\n	}\r\n}\r\nfunction doSubmit()\r\n");
...
for(int acc=0;acc<VACCOUNT_TYPE.size();acc++){
      out.write("\r\n											<th>");
      out.print(VACCOUNT_TYPE_NM.elementAt(acc) );
      out.write("</th>\r\n										");
} 
      out.write("\r\n									</tr>\r\n								</thead>\r\n								<tbody>\r\n									");
if(VCOUNTERPARTY_CD.size()!=0){
 ...
 int j=0,n=0,plant_count=0,t=0;
      ...
      out.print(i);
      out.write("');enable_disable_plant('");
      out.print(i);
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(plant_count);
      out.write("');\">\r\n												</td>\r\n												");
if(entity_role.equals("T")){
      ...
      out.write("\r\n														&nbsp;&nbsp;&nbsp;<span id=\"hidCont");
      out.print(i);
      out.write("\" class=\"fa fa-compress\" title=\"Click here to edit for different plant!\"></span>\r\n													\r\n														<input type=\"hidden\" name=\"plant_count\" value=\"");
      out.print(plant_count);
      ...
      out.write("</td>\r\n												<td>\r\n													<input type=\"text\" class=\"form-control form-control-sm\" name=\"sun_account_");
      out.print(entity_role);
      out.write("\" id=\"sun_account_");
      out.print(entity_role);
      out.write('_');
      out.print(i);
      out.write("\" \r\n														value=\"");
      out.print(VSUN_ACCOUNT.elementAt(i));
      out.write("\" style=\"text-align:right;\"  onchange=\"chkNumber(this);\" disabled >\r\n												</td>\r\n												");
for(int acc=0;acc<VACCOUNT_TYPE.size();acc++){
      out.write("\r\n													<td>\r\n														<input type=\"text\" class=\"form-control form-control-sm\" name=\"sun_entity_account_");
      out.print(entity_role);
      out.write('_');
      out.print(i);
      out.write('_');
      out.print(acc);
      out.write("\" id=\"sun_entity_account_");
      out.print(entity_role);
      out.write('_');
      out.print(i);
      out.write('_');
      out.print(acc);
      out.write("\" \r\n														value=\"");
      out.print(VSUN_ENTITY_ACCOUNT.elementAt(j) );
      out.write("\" style=\"text-align:right;\"  onchange=\"chkNumber(this);\" disabled >\r\n													</td>\r\n												");
j++;} 
      out.write("\r\n											</tr>\r\n											");
if(entity_role.equals("T")) { 
      ...
      out.print(plant_count+1);
      out.write("\" align=\"right\"  style=\"background:white;\"></td>\r\n														<td align=\"right\">Trader Plant</td>\r\n														<td align=\"right\">Sun Account Code</td>\r\n														");
for(int acc=0;acc<VACCOUNT_TYPE.size();acc++){
      out.write("\r\n															<td>");
      out.print(VACCOUNT_TYPE_NM.elementAt(acc) );
      out.write("</td>\r\n														");
...
for(int p=0;p<plant_count;p++){
      out.write("\r\n														<tr>\r\n															<td>\r\n																");
      out.print(VPLANT_ABBR.elementAt(n));
      out.write("\r\n																<input type=\"hidden\" name=\"plant_map_");
      out.print(VCOUNTERPARTY_CD.elementAt(i));
      out.write("\" value=\"");
      out.print(VPLANT_SEQ_NO.elementAt(n));
      out.write("\">\r\n																<input type=\"hidden\" name=\"plant_seq_no\" value=\"");
      out.print(VPLANT_SEQ_NO.elementAt(n));
      out.write("\">\r\n															</td>\r\n															<td>\r\n																<input type=\"text\" class=\"form-control form-control-sm\" name=\"sun_plant_account_");
      out.print(entity_role);
      out.write("\" id=\"sun_plant_account_");
      out.print(entity_role);
      out.write('_');
      out.print(i);
      out.write('_');
      out.print(p);
      out.write("\" \r\n																	value=\"");
      out.print(VACC_PLANT.elementAt(n) );
      out.write("\" style=\"text-align:right;\"  onchange=\"chkNumber(this);\" disabled >\r\n															</td>\r\n															");
for(int acc=0;acc<VACCOUNT_TYPE.size();acc++){
      out.write("\r\n																<td>\r\n																	<input type=\"text\" class=\"form-control form-control-sm\" name=\"sun_entity_plant_account_");
      out.print(entity_role);
      out.write('_');
      out.print(acc);
      out.write("\" id=\"sun_entity_plant_account_");
      out.print(entity_role);
      out.write('_');
      out.print(i);
      out.write('_');
      ...
      out.print(p);
      out.write("\" \r\n																	value=\"");
      out.print(VACC_OTH_PLANT.elementAt(t++) );
      out.write("\" style=\"text-align:right;\"  onchange=\"chkNumber(this);\" disabled >\r\n																</td>\r\n															");
} 
      out.write("\r\n														</tr>\r\n													");
n++;}
      ...
      out.write("\r\n										<tr>\r\n											<td colspan=\"");
      out.print(5+VACCOUNT_TYPE.size());
      out.write('"');
      out.write('>');
      out.print(utilmsg.infoMessage("<b>No Counterparty found!</b>") );
      out.write("</td>\r\n										</tr>\r\n									");
} 
      out.write("\r\n								</tbody>\r\n							</table>\r\n						");
}else{
      ...
      out.print(utilmsg.infoMessage("<b>Please Select any Entity!</b>") );
      out.write("\r\n							</div>\r\n						");
} 
      out.write("\r\n					</div>\r\n				</div>\r\n				");
if(!entity_role.equals("0")){
...
if(write_access.equals("Y")){ 
      ...
      out.write("\r\n			</div>\r\n		</div>\r\n	</div>\r\n</div>\r\n\r\n<input type=\"hidden\" name=\"acc_type_count\" value=\"");
      out.print(VACCOUNT_TYPE.size());
