 ...
 * Generated at: 2026-02-18 11:29:17 UTC
...
public final class rpt_005fvol_005freconcilation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/mgmt_reports/../home/../menu/menu.jsp", Long.valueOf(1766569350000L));
    _jspx_dependants.put("/mgmt_reports/../util/common_js.jsp", Long.valueOf(1770199628000L));
    _jspx_dependants.put("/mgmt_reports/../util/../sess/Expire.jsp", Long.valueOf(1754630867476L));
    _jspx_dependants.put("/mgmt_reports/../util/common_val.jsp", Long.valueOf(1754630867617L));
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("	var sysdate1 = sysdate.replace(\"/\",\"_\");\r\n	\r\n	var fileName = \"");
      out.print(owner_abbr);
      out.write("_VolumeReconciliationReport_\"+sysdate1+\".xls\";\r\n	\r\n	var url=\"xls_vol_reconcilation.jsp?month=\"+month+\"&year=\"+year+\"&fileName=\"+fileName+\"&month_to=\"+month_to+\"&year_to=\"+year_to+\"&bu_select=\"+bu_select;\r\n	location.replace(url);\r\n}\r\n</script>\r\n</head>\r\n");
      com.etrm.fms.mgmt_reports.DataBean_MGMT_Reports mgmt_rpt = null;
      mgmt_rpt = (com.etrm.fms.mgmt_reports.DataBean_MGMT_Reports) _jspx_page_context.getAttribute("mgmt_rpt", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (mgmt_rpt == null){
        mgmt_rpt = new com.etrm.fms.mgmt_reports.DataBean_MGMT_Reports();
        _jspx_page_context.setAttribute("mgmt_rpt", mgmt_rpt, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      out.write('\r');
      out.write('\n');
...
for(int i=0;i<VBU_SEQ.size();i++){ 
      ...
      out.write("\r\n								</select>\r\n							</div>\r\n							<script>document.forms[0].bu_select.value=\"");
      out.print(bu_select);
...
if(!accroid.equals(heading)){
      ...
      out.write("&nbsp;&nbsp;\r\n							    			<font color=\"black\" style=\"background: white;padding: 2px 5px 4px 5px;border-radius: 30px;\">\r\n								    			<span style=\"color:black;\">[Opening Inventory : ");
      out.print(open_qty);
      out.write(" MMBTU]</span>\r\n								    			<span style=\"color:blue;\">[Sales : ");
      out.print(sal_qty);
      out.write(" MMBTU]</span>  \r\n								    			<span style=\"color:green;\">[Purchase : ");
      out.print(pur_qty);
      out.write(" MMBTU]</span>\r\n								    			<span style=\"color:red;\">[Closing Inventory : ");
      out.print(close_qty);
      out.write(" MMBTU]</span>\r\n							    			</font>\r\n							    			&nbsp;\r\n							      		</button>	\r\n							    	</h2>\r\n									<div id=\"collapse");
      out.print(j);
...
if(accroid.equals(heading)){
      ...
      out.print(j);
      out.write("\">\r\n															<thead>\r\n																<tr>\r\n																<th rowspan=\"2\" align=\"center\" valign=\"middle\">Month/Year</th>\r\n																<th colspan=\"5\">SALES</th>\r\n																<th colspan=\"5\">PURCHASE</th>\r\n																</tr>\r\n																<tr>\r\n																	<th>Counterparty\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"sal_counterparty");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'1','");
      out.print(j);
      out.write("');\" placeholder=\"Search Counterparty\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Contract No\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"sal_cont");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'2','");
      out.print(j);
      out.write("');\" placeholder=\"Search Contract No\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Contract/Trade Ref#\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"sal_contref");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'3','");
      out.print(j);
      out.write("');\" placeholder=\"Search Contract/Trade Ref#\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Invoice No\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"sal_inv");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'4','");
      out.print(j);
      out.write("');\" placeholder=\"Search Invoice No\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Quantity(MMBTU)\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"sal_qty");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'5','");
      out.print(j);
      out.write("');\" placeholder=\"Search Quantity(MMBTU)\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Counterparty\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"pur_counterparty");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'6','");
      out.print(j);
      out.write("');\" placeholder=\"Search Counterparty\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Contract No\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"pur_cont");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'7','");
      out.print(j);
      out.write("');\" placeholder=\"Search Contract No\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Contract/Trade Ref#\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"pur_contref");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'8','");
      out.print(j);
      out.write("');\" placeholder=\"Search Contract/Trade Ref#\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Invoice No\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"pur_inv");
      out.print(j);
      out.write("\" onkeyup=\"Search(this,'9','");
      out.print(j);
      out.write("');\" placeholder=\"Search Invoice No\" style=\"width:100px\"/></div>\r\n																	</th>\r\n																	<th>Quantity(MMBTU)\r\n																		<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"pur_qty");
      out.print(j);
...
if(VAGMT_BASE.elementAt(i).equals("D")){ 
      ...
      out.write("</td>\r\n																		\r\n																		<td align=\"center\" title=\"");
      out.print(VPUR_COUNTERPARTY_NM.elementAt(i));
      out.write("\">\r\n																			");
      out.print(VPUR_COUNTERPARTY_ABBR.elementAt(i));
      out.write("\r\n																		</td>\r\n																		<td align=\"center\">\r\n																			<font color=\"blue\">");
      out.print(VPUR_DEAL_NO.elementAt(i));
      out.write("</font>\r\n																			</td>\r\n																		<td align=\"center\">");
      out.print(VPUR_CONT_REF_NO.elementAt(i));
      out.write("\r\n																		</td>\r\n																		<td align=\"center\">");
      out.print(VPUR_INVOICE_NO.elementAt(i));
      out.write("</td>\r\n																		<td align=\"right\">");
      out.print(VPUR_ALLOC_QTY.elementAt(i));
      out.write("</td>\r\n																	</tr>\r\n																	");
if(k==index){
																			i=i+1;
																			break;
      ...
      out.print(sysdate);
      out.write("\">\r\n<input type=\"hidden\" name=\"comp_abbr\" value=\"");
      out.print(owner_abbr);
