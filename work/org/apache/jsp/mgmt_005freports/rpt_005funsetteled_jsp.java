 ...
 * Generated at: 2026-04-20 12:12:30 UTC
...
public final class rpt_005funsetteled_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write(" 	var temp_sysdate = new Date(tmp1[1]+\"/\"+tmp1[0]+\"/\"+tmp1[2]);\r\n	\r\n	var flag=true;\r\n	if(temp_report_dt>temp_sysdate)\r\n	{\r\n		flag=false;\r\n	}\r\n	\r\n	if(flag==true)\r\n	{\r\n		var url=\"rpt_unsetteled.jsp?report_dt=\"+report_dt.value+\"&u=\"+u;\r\n		document.getElementById(\"loading\").style.visibility = \"visible\";\r\n		location.replace(url);\r\n	}\r\n	else\r\n	{\r\n		alert(\"Report Date can't exceed System Date (\"+sysdate+\")!\");\r\n		setTimeout(function () {\r\n	        report_dt.value = prev_report_dt;\r\n		}, 0);\r\n		return false;\r\n	}\r\n}\r\n\r\nfunction exportToXls()\r\n{\r\n	var report_dt=document.forms[0].report_dt.value;\r\n	var sysdate=document.forms[0].sysdate.value;\r\n	var sysdate1=sysdate.replace('/','_');\r\n	\r\n	var fileName=\"Unsettle_Report_\"+sysdate1+\".xls\";\r\n	var url=\"xls_unsetteled.jsp?report_dt=\"+report_dt+\"&fileName=\"+fileName;\r\n	location.replace(url);\r\n}\r\n\r\n</script>\r\n</head>\r\n");
      com.etrm.fms.mgmt_reports.DataBean_Unsettled_Report unset_rpt = null;
      unset_rpt = (com.etrm.fms.mgmt_reports.DataBean_Unsettled_Report) _jspx_page_context.getAttribute("unset_rpt", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (unset_rpt == null){
        unset_rpt = new com.etrm.fms.mgmt_reports.DataBean_Unsettled_Report();
        _jspx_page_context.setAttribute("unset_rpt", unset_rpt, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      out.write('\r');
      out.write('\n');
...
for(int i=0; i<VCOUNTERPARTY_CD.size(); i++){
      ...
      out.write("</td>\r\n											");
      out.write("\r\n											<td align=\"center\">");
      out.print(VREPORT_DT.elementAt(i));
      out.write("</td>\r\n											<td align=\"center\" title=\"");
      out.print(VCOMPANY_NM.elementAt(i));
      out.write('"');
      out.write('>');
...
if(VSPLIT_FLAG.elementAt(i).equals("Y")){ 
      ...
      out.print(VSPLIT_VAL.elementAt(i));
      out.write("%]</font>\r\n												");
} 
      out.write("	\r\n												");
...
if(VINV_FLAG.elementAt(i).equals("F")){ 
      ...
      out.write("</td>\r\n											<td align=\"center\">");
      out.print(VDOC_STATUS.elementAt(i) );
      out.write("</td>\r\n											<td align=\"center\">");
      out.print(VNEXT_STEP.elementAt(i) );
      out.write("</td>\r\n											<td align=\"center\">");
      out.print(VOPS_FLAG.elementAt(i) );
      out.write("</td>\r\n											<td align=\"center\">");
      ...
      out.write("</td>\r\n											<td align=\"right\">");
      out.print(VSETTELED_AMT.elementAt(i) );
      out.write("</td>\r\n											<td align=\"center\">");
      out.print(VSETTELED_CURR.elementAt(i) );
      out.write("</td>\r\n											<td align=\"center\" ");
if(VACC_COLOR.elementAt(i).toString().equals("R")){
...
if(VBILLING_FREQ_NM.elementAt(i).equals("1st-Fortnight")){ 
      ...
      out.print(utilmsg.infoMessage("<b>No Un-Setteled data found!</b>") );
      out.write("</td>\r\n										</tr>\r\n									");
} 
      out.write(" \r\n									</tbody>\r\n								</table>\r\n							</div>\r\n						</div>\r\n					</div>\r\n				</div>\r\n				<div class=\"card-body cdbody\">\r\n					<div class=\"row m-b-5\">\r\n						<div align=\"left\">");
      out.print(utilmsg.infoMessage(info) );
