 ...
 * Generated at: 2026-04-03 14:10:14 UTC
...
public final class rpt_005findian_005fgas_005fpoc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      com.etrm.fms.mgmt_reports.DataBean_MGMT_Reports db_mgmt = null;
      db_mgmt = (com.etrm.fms.mgmt_reports.DataBean_MGMT_Reports) _jspx_page_context.getAttribute("db_mgmt", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (db_mgmt == null){
        db_mgmt = new com.etrm.fms.mgmt_reports.DataBean_MGMT_Reports();
...
if(VCO_CODE.size()>0){
      ...
      out.write("</td>\n										<td align=\"center\">");
      out.print(VTRADE_TYPE.elementAt(i));
      out.write("</td>\n										<td align=\"center\">\n											<span\n											");
if(VBUY_SALE.elementAt(i).equals("Buy")){ 
      ...
      out.write("</b></span>\n		    							</td>\n										<td align=\"center\">");
      out.print(VDELIVERY_MONTH.elementAt(i));
      out.write("</td>\n										<td align=\"center\">");
      out.print(VDELIVERY_YEAR.elementAt(i));
      out.write("</td>\n										<td align=\"right\">");
      out.print(VVOLUME.elementAt(i));
      out.write("</td>\n										<td align=\"center\">");
if(VUNIT_OF_MEASURE.elementAt(i).equals("1")){
      out.write("MMBTU");
} 
      out.write("</td>\n										<td align=\"center\">");
      out.print(VINSTRUMENT_INDICATOR.elementAt(i));
      out.write("</td>\n										<td align=\"center\">");
      ...
      out.print(utilmsg.infoMessage("<b>No Indain Gas POC Data is Available!</b>") );
      out.write("</td>\n									</tr>\n								");
} 
      out.write("\n							</tbody>\n						</table>\n					</div>\n				</div>\n				<div class=\"card-body cdbody\">\n					<div class=\"row\">\n						<div class=\"col-sm-3 col-xs-3 col-md-3\"></div>\n						<div align=\"center\" class=\"col-sm-3 col-xs-3 col-md-3\">   \n							<div class=\"form-group row\">\n								<div align=\"right\" class=\"col-auto\"> \n									<b>Total Buy Volume : </b>\n								</div>\n								<div align=\"left\" class=\"col\">  \n									");
      out.print(nf.format(buy_sum ) );
      out.write(" MMBTU\n								</div>\n							</div>\n						</div>\n						<div align=\"center\" class=\"col-sm-3 col-xs-3 col-md-3\">  \n							<div class=\"form-group row\">\n								<div align=\"right\" class=\"col-auto\">  \n									<b>Total Sell Volume : </b>\n								</div>\n								<div align=\"left\" class=\"col\">  \n									");
      out.print(nf.format(sell_sum ) );
