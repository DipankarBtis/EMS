 ...
 * Generated at: 2026-04-15 05:40:35 UTC
...
public final class frm_005fdlng_005ftmsa_005fbilling_005fdtl_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0;i<VPLANT_SEQ.size();i++)
{
	strPlant = strPlant + VPLANT_SEQ.elementAt(i)+"@";
      ...
      out.write("\r\n<body onload=\"setBillingPeriod(document.forms[0].billing_flag);setBillingDays(document.forms[0].freq);enablechk();setValues('");
      out.print(sat_days);
...
for(int i=0; i<VPLANT_NAME.size(); i++){
      ...
      out.write("</td>	 	<!-- Pratham Bhatt: for invoice category  -->\r\n											<td align=\"center\">");
