 ...
 * Generated at: 2026-05-06 10:11:49 UTC
...
public final class frm_005flink_005ftruck_005fdriver_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int i=0,j=0,k=0,l=0,m=0,p=0,q=0,n=0;
      ...
      out.print(VTRUCK_TRANS_NAME.elementAt(a));
      out.write("</label>\r\n					</div>\r\n					<div class=\"row\">\r\n						<div class=\"col-md-12 col-sm-12 col-xs-12\">\r\n							<div class=\"accordion\">\r\n								<div class=\"accordion-item accor_item\">\r\n									<h2 class=\"accordion-header\" id=\"heading_linked");
      out.print(a);
      out.write("\">\r\n										<button class=\"accordion-button collapsed accor-btn\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#collapse_linked");
      out.print(a);
      out.write("\" aria-expanded=\"false\" aria-controls=\"collapse_linked");
      out.print(a);
      out.write("\">\r\n										Linked Driver\r\n							      		</button>\r\n							    	</h2>\r\n							    	<div id=\"collapse_linked");
      out.print(a);
      out.write("\" class=\"accordion-collapse collapse\" aria-labelledby=\"heading_linked");
      out.print(a);
      out.write("\">\r\n							      		<div class=\"accordion-body accor-body\">\r\n							        		<div class=\"row\">\r\n												<div class=\"table-responsive\">\r\n													<table class=\"table table-bordered\" id=\"example_linked\">\r\n														<thead>\r\n															<tr>\r\n																");
if(write_access.equals("Y")){ 
      out.write("<th>DeLink/Modify</th>");
} 
...
if(VDRIVER_STATUS_LINKED.elementAt(i).equals("Y")){ 
      ...
      out.print(VLINK_TRUCK_CD );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VLINKED_TRUCK_REG_NO );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VLINKED_TRUCK_TRANS_CD );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(trans_cd );
      out.write("');doModify('");
      out.print(VDRIVER_CD_LINKED.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VDRIVER_NAME_LINKED.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VTRUCK_CD_LINKED.elementAt(i));
      out.write("'\r\n																			,'");
      out.print(VEFF_DT_LINKED.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VRELEASE_DT_LINKED.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VREMARK_LINKED.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
...
if(VDRIVER_STATUS_LINKED.elementAt(i).equals("Y")){
      ...
      out.print(VDRIVER_NAME_LINKED.elementAt(i) );
      out.write("\r\n																		</div>\r\n																	</td>\r\n							    									<td align=\"center\">");
      out.print(VTRUCK_REG_NO_LINKED.elementAt(i) );
      out.write("</td>\r\n							    									<td align=\"center\">");
      out.print(VDRIVER_LICENSE_LINKED.elementAt(i) );
      out.write("</td>\r\n							    									<td align=\"center\">");
      out.print(VDRIVER_LICENSE_DURATION_LINKED.elementAt(i) );
      out.write("</td>\r\n							    									<td align=\"center\">");
      out.print(VEFF_DT_LINKED.elementAt(i) );
      out.write("</td>\r\n							    									<td align=\"center\">");
      out.print(VRELEASE_DT_LINKED.elementAt(i) );
...
if(n==driver_index_linked)
      ...
      out.print(utilmsg.infoMessage("<b>No Driver Linked To Truck!</b>") );
      out.write("</td>\r\n															</tr>\r\n														");
} 
      out.write("\r\n														</tbody>\r\n													</table>\r\n												</div>\r\n											</div>\r\n										</div>\r\n									</div>\r\n								</div>\r\n							</div>\r\n							\r\n							<div class=\"accordion\">\r\n								<div class=\"accordion-item accor_item\">\r\n									<h2 class=\"accordion-header\" id=\"heading_available");
      out.print(a);
      out.write("\">\r\n										<button class=\"accordion-button collapsed accor-btn\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#collapse_available");
      out.print(a);
      out.write("\" aria-expanded=\"false\" aria-controls=\"collapse_available");
      out.print(a);
      out.write("\">\r\n										Available Driver\r\n							      		</button>\r\n							    	</h2>\r\n							    	<div id=\"collapse_available");
      out.print(a);
      out.write("\" class=\"accordion-collapse collapse\" aria-labelledby=\"heading_available");
      out.print(a);
...
if(VLINKED_DRIVER_STATUS.elementAt(p).equals("Y")){ 
      ...
      out.print(trans_cd );
      out.write("');doLink('");
      out.print(VLINK_DRIVER_CD.elementAt(p));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VLINKED_DRIVER_NAME.elementAt(p));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(sysdate);
      ...
      out.write(',');
      out.write('\'');
      out.print(VLAST_RELEASE_DT.elementAt(p));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VLINK_DRIVER_TRANS_EFF_DT.elementAt(p));
      out.write("');\">\r\n																				</i>\r\n																			</font>\r\n																		");
} 
      out.write("\r\n																	</td>");
} 
...
if(VLINKED_DRIVER_STATUS.elementAt(p).equals("Y")){
      ...
      out.print(VLINKED_DRIVER_NAME.elementAt(p));
      out.write("\r\n																		</div>\r\n																	</td>\r\n							    									<td align=\"center\">");
      out.print(VLINKED_DRIVER_LICENSE.elementAt(p));
      out.write("</td>\r\n							    									<td align=\"center\">");
      out.print(VLINKED_DRIVER_LICENSE_DURATION.elementAt(p));
      out.write("</td>\r\n							    									<td align=\"center\">");
      out.print(VLINK_DRIVER_TRANS_EFF_DT.elementAt(p));
      out.write("</td>\r\n																</tr>\r\n																");
if(m==driver_index)
