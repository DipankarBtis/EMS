 ...
 * Generated at: 2026-05-07 04:57:55 UTC
...
public final class frm_005fdlng_005finv_005fchng_005freq_005faprv_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(accroid.equals(heading)){
      ...
      out.print(j);
      out.write("\" rowspan=\"2\">Invoice No</th>\r\n																	<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Invoice Date</th>\r\n																	<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">");
if(heading.equals("LP_HEAD")) {
      out.write("Contract Period");
}else if(heading.equals("FFLOW_HEAD")){
      out.write("Billing Period");
}else{
      out.write("Gas Day");
} 
      out.write("</th>\r\n																	<th class=\"tbser");
...
if(VAGMT_BASE.elementAt(i).equals("D")){ 
      ...
      out.write("</td>\r\n																		<td align=\"center\">");
      out.print(VREMAINING_DAYS.elementAt(i) );
      out.write(' ');
      out.write(':');
      out.write(' ');
      out.print(VCOUNT.elementAt(i).equals("")?"0":VCOUNT.elementAt(i));
      out.write("</td>\r\n																		<td align=\"center\">\r\n																			<input type=\"button\" class=\"btn btn-sm request_btn\" name=\"btn_submit\" id=\"submit");
      out.print(i);
      out.write("\" value=\"Request\" \r\n																			");
if(VREMAINING_DAYS.elementAt(i).toString().equals("0")) {
      out.write("disabled style=\"background: grey;color:black;border-color: grey\"\r\n																			");
}else if(VCOUNT.elementAt(i).toString().equals("2")) {
      out.write("disabled style=\"background: grey;color:black;border-color: grey\"\r\n																			");
}else if(VACTION_FLAG.elementAt(i).equals("P") || VACTION_FLAG.elementAt(i).equals("X")) {
      out.write(" \r\n																			");
}else if(!VACTION_FLAG.elementAt(i).equals("")){
      out.write("disabled style=\"background: grey;color:black;border-color: grey\"");
} 
      out.write("\r\n																			onclick=\"doSubmit('R','");
...
if(!VACTION_FLAG.elementAt(i).equals("R")) {
      out.write("disabled style=\"background: grey;color:black;border-color: grey\"\r\n															   				");
}else if(VREMAINING_DAYS.elementAt(i).equals("0")) {
      out.write("disabled style=\"background: grey;color:black;border-color: grey\"");
} 
      out.write(" \r\n															   				onclick=\"doSubmit('A','");
      out.print(VFINANCIAL_YEAR.elementAt(i));
      ...
      out.write('\'');
      out.print(VOTH_INVOICE_TYPE.elementAt(i));
      out.write("');\">\r\n															   			</td>\r\n															   			<td align=\"center\">	\r\n															   				<input type=\"button\" class=\"btn btn-danger btn-sm\" name=\"reject\" id=\"reject");
      out.print(i);
      out.write("\" value=\"Reject\" \r\n															   				");
if(!VACTION_FLAG.elementAt(i).equals("R")) {
      out.write("disabled style=\"background: grey;color:black;border-color: grey;border-radius: 50px;font-weight: bold\"\r\n															   				");
}else if(VREMAINING_DAYS.elementAt(i).equals("0")) {
      out.write("disabled style=\"background: grey;color:black;border-color: grey;border-radius: 50px;font-weight: bold\"\r\n															   				");
}else{ 
      out.write("style=\"border-radius: 50px;font-weight: bold;\"");
} 
      out.write("\r\n															   				onclick=\"doSubmit('X','");
      out.print(VFINANCIAL_YEAR.elementAt(i));
      out.write('\'');
...
if(k==index){
      ...
      out.write("	\r\n				</div>\r\n				<div class=\"card-body cdbody\">\r\n					<div class=\"row m-b-5\">\r\n						<div align=\"left\">");
      out.print(utilmsg.infoMessage("<b>Note:"
							+"<br>1. Re-print Requests permitted up to 30 days from Invoice Date!"
							+"<br>2. Re-print Requests permitted only Twice!</b>") );
