 ...
 * Generated at: 2026-03-16 07:03:37 UTC
...
public final class rpt_005fsend_005fout_005fsummary_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(owner_cd.equals("2")){ 
      out.write("background-color:#336699; color:white;text-align:center;");
}
		        else{ 
      out.write(" background-color:#FFD700; color:black; text-align:center;");
} 
      out.write("\" \r\n		        title=\"");
...
if(((Vector)VREMARK.elementAt(i)).elementAt(j)!=""){ 
      out.write("\r\n		         <td colspan=\"1\" align=\"left\"><b style=\"color:red;\">");
      out.print(((Vector)VREMARK.elementAt(i)).elementAt(j));
      out.write("</b></td>\r\n		         <td colspan=\"1\">&nbsp;</td>\r\n		         ");
} else{ 
...
if((""+((Vector)VCONTRACT_TYPE.elementAt(i)).elementAt(j)).trim().equalsIgnoreCase("S"))
      ...
      out.write("]\">Supply Notice&nbsp;</span>\r\n						");
 if (!((Vector)VCONT_REF.elementAt(i)).elementAt(j).toString().equals("")){ 
      out.write("\r\n						[ ");
      out.print(((Vector)VCONT_REF.elementAt(i)).elementAt(j));
      out.write("]\r\n						");
}else{
      out.write("\r\n						 [");
      out.print(((Vector)VCONT_NO.elementAt(i)).elementAt(j));
      out.write("]\r\n					");
		}
		          }
      ...
      out.write('[');
      out.print(VAGMT_BASE.elementAt(i) );
      out.write("]\">Letter of Agreement&nbsp;</span>\r\n						");
 if (!((Vector)VCONT_REF.elementAt(i)).elementAt(j).toString().equals("")){ 
      out.write("\r\n						[");
      out.print(((Vector)VCONT_REF.elementAt(i)).elementAt(j));
      out.write("]\r\n						");
 ...
 if (!((Vector)VCONT_REF.elementAt(i)).elementAt(j).toString().equals("")){ 
      ...
      out.write("				  \r\n		        </td>\r\n		        <td align=\"right\">");
      out.print(((Vector)VTCQ.elementAt(i)).elementAt(j));
      out.write("&nbsp;</td>\r\n		        ");
} 
      out.write("\r\n		       </tr>\r\n		       <tr>\r\n		       ");
for(int i=0;i<VCOUNTERPARTY_CD.size();i++){ 
      out.write("\r\n		         <td align=\"left\">");
if(!(""+((Vector)VTCQ.elementAt(i)).elementAt(j)).trim().equals("")){
      out.write("Qty supplied");
}
      out.write("</td>\r\n				 <td align=\"right\">");
      out.print(((Vector)VQTY_MMBTU.elementAt(i)).elementAt(j));
      out.write("</td>\r\n		       ");
} 
      out.write("\r\n		       </tr>\r\n		       <tr>\r\n		       ");
for(int i=0;i<VCOUNTERPARTY_CD.size();i++){ 
      out.write("\r\n		         <td align=\"left\">");
if(!(""+((Vector)VTCQ.elementAt(i)).elementAt(j)).trim().equals("")){
      out.write("<b>Remaining Supply</b>");
}
      out.write("</td>\r\n				 <td align=\"right\"><b>");
      out.print(((Vector)VBALANCE.elementAt(i)).elementAt(j));
      out.write("</b></td>\r\n		       ");
} 
      out.write("\r\n		       </tr>\r\n		       <tr>\r\n					<td colspan=\"");
      out.print(((VCOUNTERPARTY_CD.size()*2)));
      out.write("\">&nbsp;</td>\r\n			   </tr>\r\n		       ");
 } 
      out.write("\r\n		       <tr>\r\n		  		 ");
	for(int i=0;i<VCOUNTERPARTY_CD.size();i++){ 
      out.write("\r\n					<td align=\"left\">&nbsp;<b>Total Balance</b></td>\r\n					<td align=\"right\"><b>");
      out.print(VSN_LOA_TOTAL_BALANCE.elementAt(i));
      out.write("</b>&nbsp;</td>\r\n		  		");
}	
      out.write("\r\n			  </tr>\r\n			  </table>\r\n			</div>\r\n			<div class=\"row\">&nbsp;</div>\r\n			<div class=\"row\">&nbsp;</div>\r\n			<div class=\"row\">&nbsp;</div>\r\n\r\n			<div class=\"row\">\r\n			  <div class=\"row m-b-5\">\r\n				 <label class=\"form-label subheader\"><i class=\"fa fa-snowflake-o\"></i> LTCORA</label>\r\n		      </div>\r\n			  <div class=\"table-responsive\">\r\n			    <table class=\"table table-bordered table-hover\" >\r\n			       <tr style=\"");
if(owner_cd.equals("2")){ 
      out.write(" background-color:#336699; color:white ");
} 
			         else {
      out.write("background-color:#FFD700; color:black");
 }
...
for(int i=0;i<VCUSTOMER_CD_LTCORA.size();i++){ 
      out.write("\r\n			            <tr>\r\n			                <td align=\"left\"> Unloaded LTCORA Volumes of ");
      out.print(VCUSTOMER_NM_LTCORA.elementAt(i));
      out.write(" Cargo </td>\r\n			 	 		    <td align=\"right\">");
      out.print(LTCORA_TOTAL_UNLOADED_VOLUME.elementAt(i) );
      out.write("</td>\r\n			 	 		    <td align=\"right\">");
      out.print(LTCORA_TOTAL_UNLOADED_VOLUME_MCM.elementAt(i));
      out.write("</td>\r\n			            </tr>\r\n			            ");
} 
      out.write("\r\n			            <tr>\r\n				 	 		<td align=\"left\"> SUG Under LTCORA Agreement </td>\r\n				 	 		<td align=\"right\">");
      out.print(total_sug_lt );
      out.write("</td>\r\n				 	 		<td align=\"right\">");
      out.print(total_sug_lt_mcm );
      out.write("</td>\r\n			 	 	    </tr>\r\n			 	 	    <tr>\r\n				 	 		<td align=\"left\">Net Committed LTCORA Volume</td>\r\n				 	 		<td align=\"right\">");
      out.print( net_commit_lt_vol);
      out.write("</td>\r\n				 	 		<td align=\"right\">");
      out.print(net_commit_lt_vol_mcm );
      out.write("</td>\r\n			 	 	    </tr>\r\n			 	 	    ");
      out.write("\r\n			 	 	\r\n			 	 	    <tr>\r\n				 	 		<td align=\"left\">LTCORA Volume Supplied</td>\r\n				 	 		<td align=\"right\">");
      out.print(total_vol_supplied );
      out.write("</td>\r\n				 	 		<td align=\"right\">");
      out.print(total_vol_supplied_mcm );
      out.write("</td>\r\n			 	 	    </tr>\r\n			 	 	    <tr>\r\n				 	 		<td  align=\"left\"><b> OutStanding Commitment</b></td>\r\n				 	 		<td  align=\"right\"><b>");
      out.print(total_outstanding_commitment );
      out.write("</b></td>\r\n				 	 		<td align=\"right\"><b>");
      out.print(total_outstanding_commitment_mcm );
...
if(owner_cd.equals("2")){ 
      ...
      out.write("\">\r\n			 	 		<th style=\"text-align:center;\">Approximate nos.</th>\r\n			 	 		<th style=\"text-align:center;\">MMBTU</th>\r\n			 	 		<th style=\"text-align:center;\">MMSCM</th>\r\n			 	  	</tr>\r\n			        <tr>\r\n			 	 		<td align=\"left\">Opening tank levels on ");
      out.print(selected_from_date );
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(month_opening_stock);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(month_opening_stock_mcm);
      out.write("</td>\r\n			 	 	</tr>\r\n			 	 	<tr>\r\n			 	 		<td align=\"left\">Volume received during ");
      out.print(selected_prev_month_year);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(volume_received_sales);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(volume_received_sales_mcm);
      out.write("</td>\r\n			 	 	</tr>\r\n			        <tr>\r\n			 	 		<td align=\"left\">Sales &amp;Regas Volume in ");
      out.print(selected_prev_month_year);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(month_total_sales);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(month_total_sales_mcm);
      out.write("</td>\r\n			 	 	</tr>\r\n			 	 	<tr>\r\n			 	 		<td align=\"left\">Dead stock</td>\r\n			 	 		<td align=\"right\">");
      out.print(dead_stock);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(dead_stock_mcm);
      out.write("</td>\r\n			 	 	</tr> \r\n			 	 	<tr>\r\n			 	 		<td align=\"left\">Expected own volumes</td>\r\n			 	 		<td align=\"right\">");
      out.print(volume_expected_sales);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(volume_expected_sales_mcm);
      out.write("</td>\r\n			 	 	</tr>\r\n			 	 	<tr>\r\n			 	 		<td align=\"left\">Outstanding commitment</td>\r\n			 	 		<td align=\"right\">");
      out.print(outstanding_commitment_total);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(outstanding_commitment_total_mcm);
      out.write("</td>\r\n			 	 	</tr> \r\n			 	 	<tr>\r\n			 	 		<td align=\"left\">Internal consumption ");
      out.print(consumption_percentage);
      out.write("%</td>\r\n			 	 		<td align=\"right\">");
      out.print(internal_consumption_total);
      out.write("</td>\r\n			 	 		<td align=\"right\">");
      out.print(internal_consumption_total_mcm);
      out.write("</td>\r\n			 	 	</tr>\r\n			 	 	<tr><td colspan=\"3\">&nbsp;</td></tr>\r\n			 	 	<tr>\r\n			 	 		<td align=\"left\"><b>Net Uncommitted Volumes</b></td>\r\n			 	 		<td align=\"right\"><b>");
      out.print(net_uncommited_total);
      out.write("</b></td>\r\n			 	 		<td align=\"right\"><b>");
      out.print(net_uncommited_total_mcm);
      out.write("</b></td>\r\n			 	 	</tr>\r\n			 	 	<tr>\r\n                      <td colspan=\"3\" style=\"height:30px;\">&nbsp;</td>\r\n                    </tr>\r\n			     </table>\r\n			    </div>\r\n			   </div>\r\n	        ");
 } else { 
      out.write("\r\n	        <table>\r\n	         <tr>\r\n				<td align=\"center\">");
      out.print(utilmsg.infoMessage("<b>...Send-out summary statement List not present for the selected Date...</b>") );
      out.write("</td>\r\n			 </tr>\r\n		    </table>\r\n	       ");
} 
