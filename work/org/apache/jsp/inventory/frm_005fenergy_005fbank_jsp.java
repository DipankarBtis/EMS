 ...
 * Generated at: 2026-03-03 06:14:12 UTC
...
public final class frm_005fenergy_005fbank_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int i=0;int k=0, ctn=0;
      ...
      out.write("&nbsp;<font color=\"blue\">(Balance MMBTU: ");
      out.print(VTOTAL_BALANCE_MMBTU.elementAt(ctn++) );
      out.write(")</font>\n									</button>\n								</h2>\n								<div id=\"collapse");
      out.print(j);
...
if((!VCARGO_POOL_FLAG.elementAt(j).equals("S"))&&(!VCARGO_POOL_FLAG.elementAt(j).equals("O"))){
      ...
      out.print(VBALANCE_QTY_INFO.elementAt(i) );
      out.write('"');
      out.write(' ');
if(Double.parseDouble(VBALANCE_QTY.elementAt(i).toString())<0){
...
if(!VCARGO_POOL_FLAG.elementAt(j).equals("E")){ 
      out.write("title=\"");
      out.print(VUNLOADED_QTY_INFO.elementAt(i));
      out.write('"');
}
      out.write('>');
      out.print(VUNLOADED_QTY.elementAt(i));
      out.write("</td>\n																		<td align=\"right\" title=\"");
      out.print(VAVAIL_FOR_SALE_QTY_INFO.elementAt(i));
      out.write('"');
      out.write('>');
      ...
      out.write(' ');
if(VCARGO_POOL_FLAG.elementAt(j).equals("O")){
      out.write("&nbsp;&nbsp;<span title=\"LTCORA changes after ");
      out.print(sysdate);
      out.write("\" onclick=\"viewProjectedLTCORADetail();\"><i class='fa fa-info-circle fa-lg'></i></span>");
} 
      out.write("</td>\n																	");
} 
      ...
      out.write("\">\n																		<input type=\"hidden\" name=\"contract_type_name\" id=\"contract_type_name\" value=\"");
      out.print(VCONTRACT_TYPE_NM.elementAt(i));
      out.write("\">\n																		<input type=\"hidden\" name=\"booked_qty\" id=\"booked_qty\" value=\"");
      out.print(VBOOKED_QTY.elementAt(i));
      ...
      out.write("\" value=\"");
      out.print(VALLOCATED_QTY.elementAt(i));
      out.write("\">\n																		<input type=\"hidden\" name=\"pool_flag\" id=\"pool_flag");
      out.print(i);
      out.write("\" value=\"");
      out.print(VCARGO_POOL_FLAG.elementAt(j));
      out.write("\">\n																	</td>\n																	");
