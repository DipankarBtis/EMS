 ...
 * Generated at: 2026-03-27 12:52:43 UTC
...
public final class frm_005fother_005finvoice_005fdtl_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!accord.equals(heading)){
      ...
      out.print(j);
      out.write("\">\r\n								    			");
      out.print(VINVOICE_LIST_ABBR.elementAt(j));
...
if(!VINVOICE_TYPE.elementAt(j).equals("RXP")) {
      out.write("\r\n															<div class=\"btn-group\">\r\n																<label class=\"btn btn-outline-secondary subbtngrp\" id=\"genInvoice");
      out.print(j);
      out.write("\" onclick=\"generateNewInvoice('");
      ...
      out.write("');\" data-bs-toggle=\"modal\" data-bs-target=\"#PdBondModal\">&nbsp;Generate New Invoice</label>\r\n															</div>\r\n														");
} 
...
if(VAPPROVE_FLAG.elementAt(i).equals("Y")){ 
      ...
      out.write(',');
      out.write('\'');
      out.print(VCHECK_APPROVE.elementAt(j));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VINVOICE_LIST_ABBR.elementAt(j));
...
if(VIS_IRN_GENERATED.elementAt(i).equals("Y")) {
      ...
      out.write('\'');
      out.print(VINV_NO.elementAt(i));
      out.write("','pdf_other_invoice.jsp','");
      out.print(VINVOICE_TYPE.elementAt(j) );
      out.write('\'');
      out.write(',');
      out.write('\'');
...
if(k==index){
      ...
      out.print(utilmsg.infoMessage("<b>No "+VINVOICE_LIST_ABBR.elementAt(j)+" is Generated!</b>") );
      out.write("</td>\r\n															</tr>\r\n														");
} 
      out.write("\r\n														</tbody>\r\n													</table>\r\n													</div>\r\n												</div>\r\n											</div>\r\n										</div>\r\n									</div>\r\n								</div>\r\n							</div>\r\n						</div>\r\n					");
} 
