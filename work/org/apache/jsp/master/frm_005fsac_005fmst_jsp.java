 ...
 * Generated at: 2026-04-03 13:32:09 UTC
...
public final class frm_005fsac_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("		document.getElementById(\"lb\").innerHTML=\"Deactive\";\n		document.getElementById(\"status_flag\").value=\"N\";\n	}\n	\n	document.forms[0].opration.value=\"MODIFY\";\n}\n\nvar newWindow;\n\nfunction exportToXls()\n{\n	var url = \"xls_sac_mst.jsp?fileName=SAC Master Report.xls\";\n\n	location.replace(url);\n}\n</script>\n</head>\n");
      com.etrm.fms.master.DataBean_Master sacMst = null;
      sacMst = (com.etrm.fms.master.DataBean_Master) _jspx_page_context.getAttribute("sacMst", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (sacMst == null){
        sacMst = new com.etrm.fms.master.DataBean_Master();
        _jspx_page_context.setAttribute("sacMst", sacMst, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      out.write('\n');
...
for(int i=0; i<VSAC_CD.size(); i++){ 
      ...
      out.print(VSAC_CD.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VSAC_CODE.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VSAC_DESC.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VSAC_REMARKS.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VSAC_FLAG.elementAt(i));
      out.write("')\">\n													</i>\n												</font>\n											</td>\n											<td>");
      out.print(VSAC_CODE.elementAt(i));
      out.write("</td>\n											<td align=\"center\">");
      out.print(VSAC_DESC.elementAt(i) );
...
if(VSAC_FLAG.elementAt(i).equals("Y")){
      ...
      out.print(utilmsg.infoMessage("<b>SAC Code List is not Available!</b>") );
      out.write("\n											</td>\n										</tr>\n									");
} 
