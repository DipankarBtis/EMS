 ...
 * Generated at: 2026-03-13 10:15:51 UTC
...
public final class frm_005ftax_005fstructure_005fdtl_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(Integer.parseInt(""+VCOUNT.elementAt(i))>0){ 
      out.write("Entity Tax Structure Configured!");
}
      out.write("\">\r\n											<div align=\"center\">\r\n											");
if(Integer.parseInt(""+VCOUNT.elementAt(i))==0){ 
      out.write("\r\n												<font title=\"Click to Edit\" style=\"color:var(--header_color)\">\r\n													<i class=\"fa fa-edit fa-lg\" \r\n													data-bs-toggle=\"modal\" data-bs-target=\"#myModal\" \r\n													onclick=\"doClear();doModify('MODIFY','");
      ...
      out.write("',\r\n													'");
      out.print(VTAX_STRUCT_STATUS.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.write(',');
      out.write('\'');
      out.print(VTAX_CATEGORY.elementAt(i));
      out.write("',\r\n													'");
      ...
      out.write(',');
      out.write('\'');
      out.print(VPAY_RECV.elementAt(i) );
      out.write("');\r\n													fetchStructDtl('");
      out.print(VTAX_STRUCT_CD.elementAt(i));
      out.write('\'');
      out.write(',');
...
if(VTAX_STRUCT_STATUS.elementAt(i).equals("1")){
      ...
      out.write("											<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"table_Tax Name\" onkeyup=\"Search1(this,'2');\" placeholder=\"Search..\" style=\"width:100px\"/></div>\r\n										</th>\r\n										<th>\r\n											Alias\r\n											<br><div align=\"center\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"table_Alias\" onkeyup=\"Search1(this,'3');\" placeholder=\"Search..\" style=\"width:100px\"/></div>\r\n										</th>\r\n										<th>Tax Abr.</th>\r\n										<th>Rate (%)</th>\r\n										<th>Tax On</th>\r\n										<th>SAP Tax Code</th>\r\n										<th>SAP GL</th>\r\n									</tr>\r\n								</thead>\r\n								<tbody>\r\n								");
if(VTAX_CD.size() > 0){ 
      out.write("\r\n									");
for(i=0; i<VTAX_CD.size(); i++){ 
      out.write("\r\n									<tr>\r\n										<td width=\"5%\" align=\"center\">\r\n											<input type=\"checkbox\" name=\"chk\" id=\"chk");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" class=\"form-check-input\" onclick=\"setValue(this,'");
      out.print(VTAX_CD.elementAt(i));
      out.write("');setDescription()\">\r\n										</td>\r\n										<td align=\"center\">\r\n											");
      out.print(VTAX_CD.elementAt(i));
      out.write("\r\n											<input type=\"hidden\" class=\"form-control form-control-sm\" name=\"tax_code\" id=\"tax_code");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" value=\"");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" disabled>\r\n										</td>\r\n										<td>\r\n											");
      out.print(VTAX_NM.elementAt(i));
      out.write("\r\n										</td>\r\n										<td align=\"center\">\r\n											");
      out.print(VTAX_ALIAS_NM.elementAt(i));
      out.write("\r\n											<input type=\"hidden\" class=\"form-control form-control-sm\" name=\"tax_alias\" id=\"tax_alias");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" value=\"");
      out.print(VTAX_ALIAS_NM.elementAt(i));
      out.write("\">\r\n										</td>\r\n										<td align=\"center\">");
      out.print(VTAX_SHT_NM.elementAt(i));
      out.write("</td>\r\n										<td align=\"center\">\r\n											<div style=\"width:50px;\">\r\n												<input type=\"text\" class=\"form-control form-control-sm\" name=\"rate\" id=\"rate");
      out.print(VTAX_CD.elementAt(i));
      out.write("\"  onblur=\"checkNumber1(this,5,3);setDescription();\" disabled>\r\n											</div>\r\n										</td>\r\n										<td align=\"center\">\r\n											<div style=\"width:250px;\">\r\n												<div class=\"row m-b-5\">\r\n													<div class=\"col-auto\">\r\n														<input type=\"radio\" name=\"tax_on");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" id=\"tax_on1");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" value=\"1\" checked onclick=\"setTaxOn(this,'");
      out.print(VTAX_CD.elementAt(i));
      out.write("');setDescription();\">&nbsp;On Value\r\n													</div>\r\n													<div class=\"col-auto\">\r\n														<input type=\"radio\" name=\"tax_on");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" id=\"tax_on2");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" value=\"2\" onclick=\"setTaxOn(this,'");
      out.print(VTAX_CD.elementAt(i));
      out.write("');setDescription();\">&nbsp;On Tax Code\r\n													</div>\r\n													<div class=\"col\">\r\n														<input type=\"text\" class=\"form-control form-control-sm\" name=\"tax_code_on\" id=\"tax_code_on");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" maxlength=\"6\" disabled readOnly onblur=\"setDescription();\">\r\n													</div>\r\n												</div>\r\n											</div>\r\n										</td>\r\n										<td align=\"center\">\r\n											<div style=\"width:100px;\">\r\n												<input class=\"form-control form-control-sm\"  name=\"sap_tax_code_dtl\" id=\"sap_tax_code_dtl");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" maxlength=\"2\" onblur=\"setDescription();\" disabled>\r\n											</div>\r\n										</td>\r\n										<td align=\"center\">\r\n											<div style=\"width:100px;\">\r\n												<input class=\"form-control form-control-sm\"  name=\"sap_gl_dtl\" id=\"sap_gl_dtl");
      out.print(VTAX_CD.elementAt(i));
      out.write("\" maxlength=\"20\" onblur=\"setDescription();\" disabled>\r\n											</div>\r\n										</td>\r\n									</tr>\r\n									");
} 
      out.write("\r\n								");
}else{ 
      out.write("\r\n									<tr>\r\n										<td align=\"center\" colspan=\"9\">");
      out.print(utilmsg.infoMessage("<b>No Tax is Configured!</b>") );
      out.write("</td>\r\n									</tr>\r\n								");
} 
