 ...
 * Generated at: 2026-03-27 05:33:47 UTC
...
public final class rpt_005fentity_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write('\n');
      com.etrm.fms.master.DB_Counterparty_Report dbcounterpty = null;
      dbcounterpty = (com.etrm.fms.master.DB_Counterparty_Report) _jspx_page_context.getAttribute("dbcounterpty", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (dbcounterpty == null){
        dbcounterpty = new com.etrm.fms.master.DB_Counterparty_Report();
...
if(!msg.equals("")){
      ...
      out.write("\n			<div class=\"card cardmain\">\n				<div class=\"card-header cdheader\">\n					<div class=\"d-flex justify-content-between\">\n						<div class=\"topheader\">\n							Entity Master Report\n						</div>						\n				    	<div class=\"row justify-content-end\">\n							<div class=\"col-auto\">\n						 		<span class=\"input-group-text\"><a id=\"multisheetIcon\"><i  ");
if(counterparty_cd.equals("0")){ 
      out.write("title=\"Multisheet Export To Excel\" onclick=\"multiSheetGen();downloadFile();\" ");
}else{
      out.write("onclick=\"exportToXls();\" title=\"Export To Excel\"");
} 
      out.write("style=\"color: green;\" class=\"fa fa-file-excel-o fa-2x\"></i></a></span>\n							</div>						\n							<div class=\"col-auto\">\n							 	<div class=\"btn-group\">\n									<select class=\"btn btn-outline-secondary btngrp ");
...
if(!name.equals("")){ 
      out.write("										\n									<tr>\n										<th colspan = 4><div align=\"left\"><span class=\"badge rounded-pill\" style=\"background:");
      out.print(color);
      out.write(";color:black;font-size:12px;\"><i class=\"fa fa-snowflake-o\"></i> Counterparty Details</span></div></th>																								\n									</tr>										\n									<tr>\n										<th>Name</th><td><div>");
      out.print(name);
      out.write("</div></td><th>Eff Date</th><td><div>");
      out.print(eff_dt );
      out.write("</div></td>\n									</tr>\n									<tr>\n										<th>Abbreviation</th><td><div>");
      out.print(abbr );
      out.write("</div></td><th>Clearance</th><td><div>");
      out.print(clearance);
      out.write("</div></td>\n									</tr>\n									<tr>\n										<th>PAN No</th><td><div>");
      out.print(pan_no);
      out.write("</div></td><th>PAN Eff Date</th><td><div>");
      out.print(pan_dt );
      out.write("</div></td>\n									</tr>\n									<tr>\n										<th>Web-Site Address</th><td><div>");
      out.print(web_addr );
      out.write("</div></td><th>Category</th><td><div>");
      out.print(category);
      out.write("</div></td>\n									</tr>\n									<tr>\n										<th >KYC Remark</th><td><div>");
      out.print(notes);
      out.write("</div></td><th>Requester/Approver Notes</th><td><div>");
      out.print(requester_approver_note );
      out.write("</div></td>\n									</tr>\n									");
if(entity_role.equals("B")){ 
      out.write("\n									<tr>\n										<th>Bank Details Config</th><td colspan = 3>");
...
for(int k=0;k<3;k++){ 
      out.write("\n										<tr>\n											<th colspan =4 >");
if(k==0){ 
      out.write("\n											<div align=\"left\"><span class=\"badge rounded-pill\" style=\"background:");
      out.print(color);
      out.write(";color:black;font-size:12px;\"><i class=\"fa fa-snowflake-o\"></i> Registered Address & Communication Details</span></div>\n											");
}else if(k==1){ 
      out.write("\n												<div align=\"left\"><span class=\"badge rounded-pill\" style=\"background:");
      out.print(color);
      out.write(";color:black;font-size:12px;\"><i class=\"fa fa-snowflake-o\"></i> Correspondence Address & Communication Details</span></div>\n											");
}else if(k==2){ 
      out.write("\n												<div align=\"left\"><span class=\"badge rounded-pill\" style=\"background:");
      out.print(color);
      out.write(";color:black;font-size:12px;\"><i class=\"fa fa-snowflake-o\"></i> Billing Address & Communication Details</span></div>\n											");
} 
      out.write("</th>\n										</tr>																												\n										<tr>\n											<th>Address</th><td>");
      out.print(ADDRESS[k] );
      out.write("</td><th>Eff Date</th><td>");
      out.print(REG_EFF_DT[k] );
      out.write("</td>\n										</tr>\n										<tr>\n											<th>City</th><td>");
      out.print(CITY[k] );
      out.write("</td><th>Zone</th><td>");
      out.print(ZONE[k]);
      out.write("</td>\n										</tr>\n										<tr>\n											<th>State/Province</th><td>");
      out.print(STATE[k] );
      out.write("</td><th>Country</th><td>");
      out.print(COUNTRY[k] );
      out.write("</td>\n										</tr>\n										<tr>\n											<th>PIN/ZIP Code</th><td>");
      out.print(PIN[k] );
      out.write("</td><th>Alternate Phone</th><td>");
      out.print(ALT_PHONE[k] );
      out.write("</td>\n										</tr>\n										<tr>\n											<th>Phone</th><td>");
      out.print(PHONE[k]);
      out.write("</td><th>Fax-1</th><td>");
      out.print(FAX1[k]);
      out.write("</td>\n										</tr>\n										<tr>\n											<th>Cell</th><td>");
      out.print(MOBILE[k]);
      out.write("</td><th>E-mail</th><td>");
      out.print(EMAIL[k] );
      out.write("</td>\n										</tr>\n										<tr>\n											<th>Fax-2</th><td>");
      out.print(FAX2[k] );
      out.write("</td><th></th><th></th>\n										</tr>\n									");
}
      out.write("							\n										\n									");
...
if(entity_role.equals("R")){ 
      out.write("\n											<tr align=\"left\">\n												<th colspan = 4><div  align=\"left\"><span class=\"badge rounded-pill\" style=\"background:");
      out.print(color);
      out.write(";color:black;font-size:12px;\"><i class=\"fa fa-snowflake-o\"></i>Entry/Exit Point Address & Communication Details</span></div></th>\n											</tr>\n										");
}else{ 
      out.write("\n											<tr align=\"left\">\n												<th colspan = 4><div  align=\"left\"><span class=\"badge rounded-pill\" style=\"background:");
      out.print(color);
      out.write(";color:black;font-size:12px;\"><i class=\"fa fa-snowflake-o\"></i>Plant(s)/Office(s) Address & Communication Details</span></div></th>\n											</tr>\n										");
} 
      out.write("			\n										");
if(VPLANT_SEQ_NO.size()>0){ 
      out.write("\n												");
for(int i=0; i<VPLANT_SEQ_NO.size(); i++){
      out.write("\n										<thead style = \"vertical-align: middle\">													\n											<tr>\n												<th>Plant Name</th><td><div>");
      out.print(VPLANT_NAME.elementAt(i));
      out.write("</div></td><th>State</th><td><div>");
      out.print(VPLANT_STATE.elementAt(i) );
      out.write("</div></td>\n											</tr>\n											<tr>\n												<th>Plant ABBR	</th><td><div>");
      out.print(VPLANT_ABBR.elementAt(i) );
      out.write("</div></td><th>Zone</th><td><div>");
      out.print(VPLANT_ZONE_NM.elementAt(i) );
      out.write("</div></td>\n											</tr>\n											<tr>\n												<th>Address</th><td><div>");
      out.print(VPLANT_ADDR.elementAt(i) );
      out.write("</div></td><th>Sector</th><td><div>");
      ...
      out.write("</div></td><th>Tax/ID</th><td><div>");
...
if(entity_role.equals("R") || entity_role.equals("G") || entity_role.equals("V") || entity_role.equals("H") || entity_role.equals("S")){ 
      out.write("\n											<tr align=\"left\">\n											<th colspan = 4><div  align=\"left\"><span class=\"badge rounded-pill\" style=\"background:");
      out.print(color);
      out.write(";color:black;font-size:12px;\"><i class=\"fa fa-snowflake-o\"></i>Business Unit Address & Communication Details</span></div></th>\n										</tr>	\n										<thead style = \"vertical-align: middle\">\n										");
if(VBU_PLANT_SEQ_NO.size()>0){ 
      out.write("\n											");
for(int i=0; i<VBU_PLANT_SEQ_NO.size(); i++){
      out.write("\n											<tr>\n												<th>Name</th><td><div>");
      out.print(VBU_PLANT_NAME.elementAt(i));
      out.write("</div></td><th>Abbreviation</th><td><div>");
      out.print(VBU_PLANT_ABBR.elementAt(i) );
      out.write("</div></td>\n											</tr>\n											<tr>\n												<th>Address	</th><td><div>");
      out.print(VBU_PLANT_ADDR.elementAt(i) );
      out.write("</div></td><th>City</th><td><div>");
