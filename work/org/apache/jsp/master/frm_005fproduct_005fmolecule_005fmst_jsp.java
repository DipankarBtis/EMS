 ...
 * Generated at: 2026-04-03 13:32:35 UTC
...
public final class frm_005fproduct_005fmolecule_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0; i<VMOLE_CD.size(); i++){ 
      ...
      out.print(VPROD_MOLE_CD.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VMOLE_CD.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VMOLE_NM.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VMOLE_ABBR.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VMOLE_DESC.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VMOLE_FLAG.elementAt(i));
      out.write("')\">\n													</i>\n												</font>\n											</td>\n											<td align=\"center\">");
      out.print(VMOLE_NM.elementAt(i));
      out.write("</td>\n											<td align=\"center\">");
      out.print(VMOLE_ABBR.elementAt(i));
      out.write("</td>\n											<td align=\"center\">");
      out.print(VPROD_MOLE_NM.elementAt(i));
      out.write("</td>\n											<td align=\"center\">");
      out.print(VMOLE_DESC.elementAt(i));
      out.write("</td>\n											<td align=\"center\">\n												<div align=\"center\">\n													<font style=\"color:");
...
if(VMOLE_FLAG.elementAt(i).equals("Y")){
      ...
      out.print(utilmsg.infoMessage("<b>Product Molecule List is not Available!</b>") );
      out.write("\n											</td>\n										</tr>\n									");
} 
...
for(int i=0;i<VPROD_CD.size();i++){ 
      out.write("\n										<option value=\"");
      out.print(VPROD_CD.elementAt(i));
      out.write('"');
      out.write('>');
      out.print(VPROD_ABBR.elementAt(i));
      out.write(' ');
      out.write('-');
      out.write(' ');
