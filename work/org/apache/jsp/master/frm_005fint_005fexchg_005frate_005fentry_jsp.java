 ...
 * Generated at: 2026-04-04 06:53:06 UTC
...
public final class frm_005fint_005fexchg_005frate_005fentry_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0; i < VRATE_CD.size();i++){ 
      out.write("\n											<option value=\"");
      out.print(VRATE_CD.elementAt(i));
      out.write('"');
      out.write('>');
      out.print(VRATE_NM.elementAt(i));
      out.write("</option>\n										");
} 
      out.write("\n									</select>\n									<script>document.forms[0].component.value=\"");
      out.print(component);
      out.write("\"</script>\n								</div>\n				  			</div>\n						</div>\n						<div class=\"col-sm-3 col-xs-3 col-md-3\" ");
...
for(int j=0; j<VCURRENCY_CD.size(); j++){ 
      out.write("\n										<option value=\"");
      out.print(VCURRENCY_CD.elementAt(j));
      out.write('"');
      out.write('>');
      out.print(VCURRENCY_ABR.elementAt(j));
      out.write("</option>\n										");
} 
      out.write("\n									</select>\n									<script>document.forms[0].currency_from.value=\"");
      out.print(currency_from);
      out.write("\"</script>\n									<input type=\"hidden\" name=\"temp_currency_from\" value=\"");
      out.print(currency_from);
...
for(int j=0; j<VCURRENCY_CD.size(); j++){ 
      ...
      out.write("\n									</select>\n									<script>document.forms[0].currency_to.value=\"");
      out.print(currency_to);
      out.write("\"</script>\n									<input type=\"hidden\" name=\"temp_currency_to\" value=\"");
      out.print(currency_to);
      out.write("\">\n								</div>\n					  		</div>\n						</div>\n					</div>\n					");
...
for(int i=0; i<VRATE_EFF_DT.size(); i++){ 
      out.write("\n										<tr>\n											<td align=\"center\">\n												<div style=\"width:100px;\">\n													<div class=\"input-group input-group-sm\">\n								      					<input type=\"text\" class=\"form-control form-control-sm date\" name=\"rate_eff_dt\" value=\"");
      out.print(VRATE_EFF_DT.elementAt(i));
      out.write("\" maxLength=\"10\" onblur=\"validateDate(this);\" onchange=\"validateDate(this);\" readOnly>\n								      					<span class=\"input-group-text\"><i class=\"fa fa-calendar fa-lg\"></i></span>\n								      				</div>\n							      				</div> \n											</td>\n											");
if(rate_mode.equals("EXCHANGE")){ 
      out.write("\n												<td align=\"center\">\n													<div style=\"width:200px;\">\n														<div class=\"row m-b-5\">\n															<div class=\"col-auto\">\n																1\n															</div>\n															<div class=\"col-auto\">\n																");
      out.print(VCURRENCY_ABR.elementAt(VCURRENCY_CD.indexOf(currency_from)));
      out.write("\n															</div>\n															<div class=\"col-auto\">\n																=\n															</div>\n															<div class=\"col\">\n																<input type=\"text\" class=\"form-control form-control-sm\" name=\"rate_value\" value=\"");
      out.print(VRATE_VALUE.elementAt(i));
...
if(component_flag.equals("Y")){ 
      ...
      out.write(">\n															</div>\n															<div class=\"col-auto\">\n																");
      out.print(VCURRENCY_ABR.elementAt(VCURRENCY_CD.indexOf(currency_to)));
      out.write("\n															</div>\n														</div>\n													</div>\n												</td>\n											");
}else{ 
      out.write("\n												<td align=\"center\">\n													<div style=\"width:100px;\">\n														<input type=\"text\" class=\"form-control form-control-sm\" name=\"rate_value\" value=\"");
      out.print(VRATE_VALUE.elementAt(i));
      out.write("\"  onblur=\"checkNumber1(this,4,2);\" style=\"text-align:right;background:");
      out.print(VCOLOR.elementAt(i));
      out.write("\">\n													</div>\n												</td>\n											");
} 
      out.write("\n											<td align=\"center\">\n												<div style=\"width:400px;\">\n													<textarea class=\"form-control form-control-sm\"  name=\"remark\" rows=\"1\" maxlength=\"150\" style=\"background:");
      out.print(VCOLOR.elementAt(i));
      out.write('"');
      out.write('>');
      out.print(VRATE_REMARK.elementAt(i));
      out.write("</textarea>\n												</div>\n											</td>\n										</tr>\n									");
} 
      out.write("\n									</tbody>\n								</table>\n							</div>\n						</div>\n						<div class=\"col-md-2 col-sm-2 col-xs-2\"></div>\n					</div>\n					");
} 
