 ...
 * Generated at: 2026-04-20 07:46:36 UTC
...
public final class rpt_005fwalkforward_005fexposure_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("	    newWindow= window.open(url,\"rpt_walkforward_expo_detail_list\",\"top=10,left=10,width=1200,height=600,scrollbars=1\");\n	}\n}\n\n</script>\n\n</head>\n\n");
...
for(int i=0; i < VLIMIT_CALCULATION.size(); i++){ 
      out.write("\n									<td><div align=\"right\">");
      out.print(VLIMIT_CALCULATION.elementAt(i));
      out.write("</div></td>\n									");
} 
...
int m=-1; int n =0; int size1 = (int)VEXPOSURE_DT.size();
      ...
      out.print(VPARENT_NM.elementAt(i));
      out.write("</div></td>\n										");
for(n=n; n < VPARENT_LIMIT.size(); n++){ 
											...
											{
      out.write("\n											<td><div align=\"right\">");
      out.print(VPARENT_LIMIT.elementAt(n));
      out.write("</div></td>\n											");
}
										}
      out.write("\n									</tr>\n									");
...
for(int i=0; i < VSETTLEMENTSELLCREDIT.size(); i++){ 
      out.write("\n									<td><div align=\"right\">");
      out.print(VSETTLEMENTSELLCREDIT.elementAt(i));
      out.write("</div></td>\n									");
}
...
int k=-1; int j =0; int size = (int)VEXPOSURE_DT.size();
 ...
 k=-1;
      ...
      out.write("</div></td>\n										<td><div align=\"center\">");
      out.print(originalDealId);
      out.write("</div></td>\n										<td><div align=\"center\">");
      out.print(VBUYSELL.elementAt(i));
      out.write("</div></td>\n										");
...
if(!VCUSTWISESETTLEMENTSELLCREDIT.elementAt(j).equals("0.00")){ 
      out.write("onclick=\"showDetails('");
      out.print(V_EXPOSURE_DATE.elementAt(j));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(clearance);
      ...
      out.write(',');
      out.write('\'');
      out.print(VCUSTWISESETTLEMENTSELLCREDIT.elementAt(j));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VCUSTWISESETTLEMENTSELLCREDITFORPREVDT.elementAt(j));
      out.write('\'');
      out.write(')');
      out.write('"');
} 
...
for(int i=0; i < VSETTLEMENTSELLEXPOSUR.size(); i++){ 
      out.write("\n									<td><div align=\"right\">");
      out.print(VSETTLEMENTSELLEXPOSUR.elementAt(i));
      out.write("</div></td>\n									");
}
...
int f=-1; int z =0; int size_1 = (int)VEXPOSURE_DT.size();
      ...
      out.write("\n									<tr>\n										<td></td>\n										<td><div align=\"left\">");
      out.print(VSEC_COUNTERPARTY_NM.elementAt(i));
      out.write("</div></td>\n										");
 f=-1;
											String originalDealId = "";
      ...
      out.write("\n										<td><div align=\"center\">");
      out.print(VSEC_DIS_CONTRACT_TYPE.elementAt(i));
      out.write("</div></td>\n										<td><div align=\"center\">");
      out.print(originalDealId);
      out.write("</div></td>\n										<td><div align=\"center\">");
      out.print(VSEC_BUYSELL.elementAt(i));
      out.write("</div></td>\n										");
for(z=z; z < VCUSTWISESETTLEMENTSELLEXPOSURE.size(); z++){ 
      ...
      out.write("\n												<td title=\"Click to view detail\" ");
if(!VCUSTWISESETTLEMENTSELLEXPOSURE.elementAt(z).equals("0.00")){ 
      out.write("onclick=\"showDetails('");
      out.print(VSEC_EXPOSURE_DATE.elementAt(z) );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(clearance);
      ...
      out.write(',');
      out.write('\'');
      out.print(VCUSTWISESETTLEMENTSELLEXPOSURE.elementAt(z));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VCUSTWISESETTLEMENTSELLEXPOSUREFORPREVDT.elementAt(z));
      out.write('\'');
      out.write(')');
      out.write('"');
} 
...
for(int i=0; i < VAVAILABLECREDIT.size(); i++){ 
      out.write("\n									<td><div align=\"right\">");
      out.print(VAVAILABLECREDIT.elementAt(i));
      out.write("</div></td>\n									");
} 
      out.write("\n								<tr>\n							</tbody>\n						</table>\n					</div>\n					");
}else{ 
