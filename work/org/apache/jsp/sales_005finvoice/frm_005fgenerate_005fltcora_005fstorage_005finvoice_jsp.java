 ...
 * Generated at: 2026-04-20 10:42:17 UTC
...
public final class frm_005fgenerate_005fltcora_005fstorage_005finvoice_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(applicable_abbr.equals("TDS")) {
      out.write("&nbsp;&nbsp;<span class=\"badge bg-info text-dark\"><font id=\"display_tds_amt\">");
      out.print(tds_amt);
      out.write("</font> INR</span>");
} 
      out.write("\n							</h5>\n							<div class=\"col-1\">\n							</div>\n						</div>\n					</div>\n				</div>\n				");
...
if(correction_needed){ 
      ...
      out.write("\n				<div class=\"card-body cdbody\">\n					<div class=\"row m-b-5\">\n						<label class=\"form-label subheader\"><i class=\"fa fa-snowflake-o\"></i> Storage Charge Details</label>\n					</div>\n					<div class=\"row\">\n						<div class=\"col-md-12 col-sm-12 col-xs-12\">\n							<div class=\"table-responsive\">\n								<table class=\"table table-bordered table-hover\">\n									<thead>\n										<tr>\n											<th rowspan=\"2\">Skip Date</th>\n											<th rowspan=\"2\">Select Discount Days</th>\n											<th rowspan=\"2\">Date</th>\n											<th rowspan=\"2\">Storage Inventory<br>(MMBTU)</th>\n											<th rowspan=\"2\">Offtake Qty<br>(MMBTU)</th>\n											<th colspan=\"2\">Storage Charge (");
      out.print(price_cd_nm);
      out.write("/MMBTU)</th> <!-- JD -->\n											<th rowspan=\"2\">Amount</th>\n										</tr>\n										<tr>\n											<th><input type=\"radio\" class=\"form-check-input\" name=\"rate_type\" id=\"rate_type_u\" value=\"U\" ");
if(VRATE_TYPE.contains("U")) {
      out.write("checked");
} 
      out.write(" onclick=\"enableUserDefine(this);\">&nbsp;User Defined</th>\n											<th><input type=\"radio\" class=\"form-check-input\" name=\"rate_type\" id=\"rate_type_c\" value=\"C\" ");
if(VRATE_TYPE.contains("C")) {
      out.write("checked");
}else if(!VRATE_TYPE.contains("U")) { 
      out.write("checked");
} 
      out.write(" onclick=\"enableUserDefine(this);\">&nbsp;Contactual</th> <!-- JD --> \n										</tr>\n									</thead>\n									<tbody>\n									");
for(int i=0; i<VSTORAGE_DATE.size(); i++){ 
      out.write("\n										<tr>\n											<td align=\"center\">\n												<input type=\"checkbox\" class=\"form-check-input\" name=\"skip_chk\" id=\"skip_chk_");
      out.print(i);
      out.write("\" \n												onclick=\"enableSkipRow(this,");
      out.print(i);
      out.write(',');
      out.print(VSTORAGE_DATE.size()-1);
      out.write(");calculateStorageAmt(");
      out.print(i);
      out.write(");\" \n												");
if((VSTORAGE_DATE.size()-1)!=i) {
      out.write(" disabled");
}else if(i==0 && (VSTORAGE_DATE.size()-1)==0){ 
      out.write("disabled");
} 
      out.write(">\n											</td>\n											<td align=\"center\">\n												<input type=\"checkbox\" class=\"form-check-input\" name=\"chk\" id=\"chk_");
      out.print(i);
      out.write("\" \n												onclick=\"calculateStorageAmt(");
      out.print(i);
      out.write(");\" ");
if(VDISCOUNT_FLAG.elementAt(i).equals("Y")) {
      out.write("checked");
} 
      out.write(" \n												");
if(!discount_days.equals("Y")) {
      out.write("disabled");
} 
      out.write(">\n												<input type=\"hidden\" name=\"disc_day_flag\" id=\"disc_day_flag_");
      out.print(i);
      out.write("\" value=\"");
      out.print(VDISCOUNT_FLAG.elementAt(i));
      out.write("\">\n											</td>\n											<td align=\"center\">\n												");
      out.print(VSTORAGE_DATE.elementAt(i) );
      out.write("\n												<input type=\"hidden\" name=\"storage_dt\" id=\"storage_dt_");
      out.print(i);
      out.write("\" value=\"");
      out.print(VSTORAGE_DATE.elementAt(i) );
      out.write("\">\n											</td>\n											<td align=\"right\">\n												");
      out.print(VSTORAGE_INVENTORY.elementAt(i) );
      out.write("\n												<input type=\"hidden\" name=\"storage_inventory\" id=\"storage_inventory_");
      out.print(i);
      out.write("\" value=\"");
      out.print(VSTORAGE_INVENTORY.elementAt(i) );
      out.write("\">\n											</td>\n											<td align=\"right\">\n												");
      out.print(VOFFTAKE_QTY.elementAt(i) );
      out.write("\n												<input type=\"hidden\" name=\"offtake_qty\" id=\"offtake_qty_");
      out.print(i);
      out.write("\" value=\"");
      out.print(VOFFTAKE_QTY.elementAt(i) );
      out.write("\">\n											</td>\n											<td align=\"center\">\n												<div style=\"width:100px;\">\n													<input type=\"text\" class=\"form-control form-control-sm\" name=\"user_define\" id=\"user_define_");
      out.print(i);
      out.write("\" value=\"");
      out.print(VUSER_DEFINE.elementAt(i));
...
if(price_cd.equals("1")){ 
      ...
      out.write("\n												<input type=\"hidden\" name=\"storage_charge\" id=\"storage_charge_");
      out.print(i);
      out.write("\" value=\"");
      out.print(VSTORAGE_CHARGE.elementAt(i) );
      out.write("\">\n											</td>\n											<td align=\"center\">\n												<div style=\"width:100px;\">\n													<input type=\"text\" class=\"form-control form-control-sm\" name=\"storage_amt\" id=\"storage_amt_");
      out.print(i);
      out.write("\" value=\"");
      out.print(VSTORAGE_AMT.elementAt(i));
      out.write("\" \n													style=\"text-align:right;\" \n													onblur=\"negNumber(this);checkNumber1(this,9,2);\" disabled>\n												</div>\n											</td>\n										</tr>\n									");
} 
      out.write("\n										<tr style=\"font-weight: bold;\">\n											<td colspan=\"7\" align=\"right\">Total Amount in ");
      out.print(price_cd_nm);
      out.write(" : </td>\n											<td align=\"center\">\n												<div style=\"width:100px;\">\n													<input type=\"text\" class=\"form-control form-control-sm\" name=\"total_storage_amt\" value=\"");
      out.print(gross_amt);
...
if(buyerTurnoverFlag.equals("Y")){ 
      ...
      out.write("\">\n<input type=\"hidden\" name=\"skip_period_start_dt\" value=\"");
      out.print(period_start_dt);
      out.write("\">\n<input type=\"hidden\" name=\"skip_period_end_dt\" value=\"");
      out.print(period_end_dt);
      ...
      out.print(inv_flag);
      out.write("\">\n\n<input type=\"hidden\" name=\"discount_days\" value=\"");
