 ...
 * Generated at: 2026-03-26 09:57:06 UTC
...
public final class frm_005fsales_005finvoice_005fpreperation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(accroid.equals(heading)){
      ...
      out.print(heading);
      out.write("\">\r\n								      		<div class=\"accordion-body accor-body\">\r\n												<div class=\"row\">\r\n													<div class=\"col-md-12 col-sm-12 col-xs-12\">\r\n														<div class=\"table-responsive\">\r\n															<table class=\"table table-bordered table-hover serchtbl\" id=\"example");
      out.print(j);
      out.write("\">\r\n																<thead id=\"tbsearch");
      out.print(j);
      out.write("\">\r\n																	<tr>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Customer</th>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Contract No<br>[Contract/Trade Ref#]</th>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Contract Period</th>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Plant</th>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Business Unit</th>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Billing Cycle</th>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Billing Period</th>\r\n																		<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Invoice#</th>\r\n																		<th rowspan=\"2\">Generate/<br>View IRP</th>\r\n																		<th rowspan=\"2\">Modify IRP</th>\r\n																		<th rowspan=\"2\">IRP Check</th>					\r\n																		<th rowspan=\"2\">Fin Ops<br>Finalization</th>\r\n																		<th rowspan=\"2\">SAP XML</th>\r\n																		");
...
if(VBILLING_FREQ_NM.elementAt(i).equals("1st-Fortnight")){ 
      ...
      out.write("</b></span>																								\r\n																		</td>\r\n																		<td align=\"center\" title=\"Alloc MMBTU : ");
...
if(VINVOICE_SEQ.elementAt(i).equals("")){ 
      ...
      out.write(',');
      out.write('\'');
      out.print(VTEMP_PERIOD_START_DT.elementAt(i));
      out.write("',\r\n																								'");
      out.print(VTEMP_PERIOD_END_DT.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
...
if(accroid.equals(accro2)){
      ...
      out.write("\" aria-controls=\"collapse01\">\r\n							    			Sales Free Flow Invoice Generation&nbsp;<font color=\"blue\">(");
...
if(accroid.equals(accro2)){
      ...
      out.write("\" rowspan=\"2\">Billing Period</th>\r\n																	<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Invoice#</th>\r\n																	<th rowspan=\"2\">View IRP</th>\r\n																	<th rowspan=\"2\">Modify IRP</th>\r\n																	<th rowspan=\"2\">IRP Check</th>					\r\n																	<th rowspan=\"2\">Fin Ops<br>Finalization</th>\r\n																	<th rowspan=\"2\">SAP Xml</th>\r\n																	<th rowspan=\"2\">IRN Status</th>\r\n																	<th colspan=\"3\">\r\n																		<div align=\"center\">\r\n																			<select class=\"form-select form-select-sm\" name=\"ff_pdf_type\" style=\"width:80px;\" onchange=\"refresh('");
      out.print(accro2);
      out.write("');\">\r\n																				<option value=\"O\">Original</option>\r\n																				<option value=\"D\">Duplicate</option>\r\n																				<option value=\"T\">Triplicate</option>\r\n																				<option value=\"All\">All</option>\r\n																			</select>\r\n																			<script>document.forms[0].ff_pdf_type.value=\"");
      out.print(ff_pdf_type);
      out.write("\"</script>		\r\n																		</div>\r\n																	</th>\r\n																</tr>\r\n																<tr>\r\n																	<th>Print PDF</th>\r\n																	<th>View PDF</th>\r\n																	<th>Send Mail</th>\r\n																</tr>\r\n															</thead>\r\n															<tbody>\r\n															");
...
if(VOTH_BILLING_FREQ_NM.elementAt(i).equals("1st-Fortnight")){ 
      ...
      out.write("\r\n								    									><b>");
      out.print(VOTH_BILLING_FREQ_NM.elementAt(i));
      out.write("</b></span>												\r\n																	</td>\r\n																	<td align=\"center\">\r\n																	");
...
if(VOTH_IS_IRN_GENERATED.elementAt(i).equals("Y")) {
      ...
      out.print(accro2);
      out.write("');\"\r\n																		\r\n																			style=\"");
if(VOTH_RE_PRINT_PDF.elementAt(i).equals("Y") && !VOTH_PDF_TYPE.elementAt(i).equals(ff_pdf_type)){
      out.write("\r\n																			color:#800000;\r\n																			");
