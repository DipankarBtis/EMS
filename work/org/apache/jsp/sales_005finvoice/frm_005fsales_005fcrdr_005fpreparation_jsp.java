 ...
 * Generated at: 2026-04-13 09:27:54 UTC
...
public final class frm_005fsales_005fcrdr_005fpreparation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//=accro2
      out.write("','CRDR_IMB');\"><i class=\"fa fa-plus-circle\"></i>&nbsp;Create New Credit/Debit With Imbalance/Ship or Pay</label>\r\n												</div>\r\n								  			</div>\r\n										</div>\r\n									<!-- </div> -->\r\n						  		</div>\r\n						  		<div class=\"col-md-2 col-sm-6 col-xs-6\">\r\n							  		<div class=\"d-flex justify-content-end\">\r\n							  			<div class=\"form-group row\">\r\n											<div class=\"col-auto\">\r\n												<div class=\"btn-group\">\r\n													<a href=\"");
      out.print(url);
...
if(accroid.equals(heading)){
      ...
      out.print(j);
      out.write("\" rowspan=\"2\">Invoice Type</th>\r\n																	<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Credit/Debit Note Date</th>\r\n																	<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Criteria</th>\r\n																	<th class=\"tbser");
      out.print(j);
      out.write("\" rowspan=\"2\">Credit/Debit#<br>[Ref#]</th>\r\n																	<th rowspan=\"2\">View IRP</th>\r\n																	<th rowspan=\"2\">Modify IRP</th>\r\n																	<th rowspan=\"2\">IRP Check</th>					\r\n																	<th rowspan=\"2\">Fin Ops<br>Finalization</th>\r\n																	<th rowspan=\"2\">SAP XML</th>\r\n																	");
...
if(VAGMT_BASE.elementAt(i).equals("D")){ 
      ...
      out.write(',');
      out.write('\'');
      out.print(VCRDR_GEN_TYPE.elementAt(i));
      ...
      out.print(VCRDR_GEN_TYPE.elementAt(i));
      out.write("');\"\r\n																			style=\"");
if(VINV_CHECKED_FLAG.elementAt(i).equals("Y")){ 
      ...
      out.print(VREF_NO.elementAt(i));
      out.write("');\"\r\n																			style=\"");
if(VINV_APPROVED_FLAG.elementAt(i).equals("Y")){ 
      out.write("\r\n																					pointer-events: none; opacity: .65; color: gray;\r\n																					");
} else {
      out.write("\r\n																						color:#ff3399;\r\n																					");
}
