 ...
 * Generated at: 2026-03-25 05:48:56 UTC
...
public final class frm_005fforward_005fpricing_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0; i<VFORWARD_REPORT_DATE.size(); i++) {
      out.write("\n												<option value='");
      out.print(VFORWARD_REPORT_DATE.elementAt(i));
      out.write('\'');
      out.write('>');
      out.print(VFORWARD_REPORT_DATE.elementAt(i));
      out.write("</option>\n											");
}
      out.write("\n										</select>\n			    					</div>\n				    				<script>\n										document.forms[0].settlement_dt.value=\"");
      out.print(settlement_dt);
...
for(int i=0; i<VPHYS_FIN_MST.size(); i++) {
      out.write("\n												<option value='");
      out.print(VPHYS_FIN_MST.elementAt(i));
      out.write('\'');
      out.write('>');
      out.print(VPHYS_FIN_MST.elementAt(i));
      out.write("</option>\n											");
}
      out.write("\n										</select>	\n									</div>								\n								</div>\n								<script>\n									document.forms[0].phy_fin.value=\"");
      out.print(phy_fin);
      out.write("\"\n								</script>\n							</div>\n						</div>\n						");
      out.write("\n					</div>\n				</div>\n				<div class=\"card-body cdbody\">\n					");
