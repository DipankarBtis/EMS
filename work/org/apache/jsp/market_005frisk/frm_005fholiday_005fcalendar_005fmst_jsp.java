 ...
 * Generated at: 2026-04-03 14:30:51 UTC
...
public final class frm_005fholiday_005fcalendar_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0; i<VSETTLE_TYPE.size(); i++) {
      out.write("\n												<option value='");
      out.print(VSETTLE_TYPE.elementAt(i));
      out.write('\'');
      out.write('>');
      out.print(VSETTLE_TYPE.elementAt(i));
      out.write("</option>\n											");
}
      out.write("\n										</select>\n									</div>\n								</div>\n								<script>\n									document.forms[0].holiday_type.value=\"");
      out.print(holiday_type);
...
k=0; for(l=l; l<VHOLIDAY_DT.size(); l++)
      ...
      out.write(',');
      out.write('\'');
      out.print(VHOLIDAY_DT.elementAt(l));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VHOLIDAY_NM.elementAt(l));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(VCURVE_NM.elementAt(i));
      ...
      out.write(',');
      out.write('\'');
      out.print(VHOLIDAY_STATUS.elementAt(l));
      out.write("')\"></i>\n																			</font>\n																		</div>\n																	</td>\n																	<td align=\"center\">");
      out.print(VHOLIDAY_NM.elementAt(l) );
      out.write("</td>\n																	<td align=\"center\">");
      out.print(VHOLIDAY_DT.elementAt(l) );
...
if(k==index){
      ...
      out.write("\n					&nbsp;\n					<div align=\"center\">");
      out.print(utilmsg.infoMessage("<b>Holiday Calendar is not Available!</b>"));
      out.write("</div>\n				");
} 
