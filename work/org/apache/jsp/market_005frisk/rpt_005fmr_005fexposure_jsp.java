 ...
 * Generated at: 2026-03-21 04:49:41 UTC
...
public final class rpt_005fmr_005fexposure_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!msg.equals("")){
      ...
      out.print(storage_collapse_info);
...
for(int i=0;i<VSTORAGE_ROW_HEADING.size();i++){ 
      out.write("\n														<tr ");
if((i+1) == VSTORAGE_ROW_HEADING.size()){
      out.write("style=\"font-weight: bold;\"");
}
      out.write(">	\n															<td>");
      out.print(VSTORAGE_ROW_HEADING.elementAt(i));
      out.write("</td>\n															");
for(int j=0;j<VCOMPANY_ABBR.size();j++){ 
      ...
      out.write("\n															<td align=\"right\">");
      out.print(VSTORAGE_MMSCM.elementAt(k));
      out.write("</td>\n															<td align=\"right\">");
      out.print(VSTORAGE_MMBTU.elementAt(k));
      out.write("</td>\n															<td>");
      out.print(VSTORAGE_LAST_DT.elementAt(k));
      out.write("</td>\n															");
} 
      out.write("\n														</tr>\n													");
} 
...
for(int i=0; i<VCOUNTERPARTY_CD.size(); i++){ 
      ...
      out.print(i+1);
      out.write("\n										</td>	\n										<td align=\"center\" ");
if(VIS_EOD_PROCESS_DONE.elementAt(i).equals("Y")){ 
      out.write(" style=\"background: #99ffcc;\" ");
} 
      out.write(">\n											<i class=\"fa fa-floppy-o fa-lg\"  \n											onclick=\"showFreezedDealExposure('");
      out.print(VLEGAL_ENTITY_CD.elementAt(i));
      out.write('\'');
      out.write(',');
      out.write('\'');
...
if(VACCOUNT.elementAt(i).equals("Buy")){ 
      ...
      out.write("\n											");
      out.write("	\n										</td>\n										<td align=\"center\">");
      out.print(VFIN_CURVE_NM.elementAt(i));
      out.write("</td>\n										<td align=\"center\">");
      out.print(VPHYS_CURVE_NM.elementAt(i) );
      out.write("</td>										\n									</tr>\n									");
} 
      out.write("\n									");
}else{ 
      ...
      out.write("		\n								</tbody>\n							</table>\n						</div>\n					</div>\n				</div>				\n			</div>\n		</div>\n	</div>\n</div>						\n\n<input type=\"hidden\" name=\"temp_report_dt\" value=\"");
      out.print(yesdate);
      out.write("\">\n<input type=\"hidden\" name=\"isEodDone\" value=\"");
      out.print(VIS_EOD_PROCESS_DONE.contains("Y"));
