 ...
 * Generated at: 2026-03-03 05:56:29 UTC
...
public final class frm_005fdlng_005fcontract_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("	var dda_time = document.forms[0].dda_time.value;\r\n	var signing_dt = document.forms[0].signing_dt.value;\r\n	var signing_time = document.forms[0].signing_time.value;\r\n	var ent_dt = document.forms[0].ent_dt.value;\r\n	var ent_time = document.forms[0].ent_time.value;\r\n	var start_dt = document.forms[0].start_dt.value;\r\n	var end_dt = document.forms[0].end_dt.value;\r\n	var rate = document.forms[0].rate.value;\r\n	var rate_unit = document.forms[0].rate_unit.value;\r\n	var tcq = document.forms[0].tcq.value;\r\n	var quantity_unit = document.forms[0].quantity_unit.value;\r\n	var dcq = document.forms[0].dcq.value;\r\n	var cont_status_flg = document.forms[0].cont_status_flg.value;\r\n	var supplied_qty = document.forms[0].supplied_qty.value;\r\n	\r\n	var no_of_billing_dtl = document.forms[0].no_of_billing_dtl.value;\r\n	var no_of_security_dtl = document.forms[0].no_of_security_dtl.value;\r\n	\r\n	var agreement_type = document.forms[0].agreement_type;\r\n	var agreement_base = document.forms[0].agreement_base;\r\n	\r\n	var chk_plant = document.forms[0].chk_plant;\r\n");
...
if(clearance.equals("IGX")){ 
      out.write("<label class=\"form-label\"><b>Trade Type<span class=\"s-red\">*</span></b></label>");
}else{ 
...
if(clearance.equals("IGX")){ 
      out.write("\r\n				    			title=\"Trade Delivery Mode : ");
      out.print(agmt_agmt_base);
      out.write('"');
}else{ 
      out.write("\r\n				    			title=\"Agreement AGMT BASE : ");
      out.print(agmt_agmt_base);
      out.write('"');
} 
      out.write("><b>\r\n								");
...
if(clearance.equals("IGX")){ 
      ...
      out.write("\"</script>				    								    								    				\r\n						      			</div>\r\n						  			</div>\r\n								</div>\r\n				  			</div>\r\n						</div>\r\n						<div class=\"col-sm-2 col-xs-2 col-md-2\">\r\n							<label class=\"form-label\"><b>Credit Exceed Days</b></label>\r\n						</div>\r\n						<div class=\"col-sm-4 col-xs-4 col-md-4\">\r\n							<div class=\"form-group row\">								\r\n				    			<div class=\"col\">\r\n				    				<input type=\"button\" name=\"credit_exceed_btn\" class=\"btn btn-sm config_btn\" value=\"Credit Exceed Config\" onclick=\"creditExceedDaysConfig('");
      out.print(contract_type);
      out.write('\'');
      out.write(',');
      out.write('\'');
...
if(is_allocated.equals("Y")){ 
      ...
      out.write("\r\n				    			</div>\r\n				    			<div class=\"col-auto\">\r\n		      						<i name=\"price_hist\" id=\"price_hist\" class=\"fa fa-info-circle fa-lg\" aria-hidden=\"true\" style=\"pointer-events: auto; color:#800040;\" title=\"");
      out.print(price_change_history);
      out.write("\"></i>\r\n				    			</div>\r\n				    			");
if(opration.equals("MODIFY")){ 
      out.write("\r\n				    			<div class=\"col-auto\">\r\n				    				<input type=\"button\" class=\"btn btn-sm config_btn\" value=\"Variable Price Config\" onclick=\"variablePriceConfig('");
      out.print(contract_type);
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.write('\'');
      out.print(cont_status_flg);
      out.write("');\">\r\n				  				</div>\r\n				  				<div class=\"col-auto\">\r\n		      						<i name=\"variable_price\" id=\"var_price\" class=\"fa fa-info-circle fa-2x\" aria-hidden=\"true\" style=\"pointer-events: auto; color:#0000FF; vertical-align: middle;\" onclick=\"openVariablePriceInfo('");
      out.print(contract_type);
      out.write('\'');
      out.write(',');
      out.write('\'');
...
if(!tcq_sign.equals("")) {
      ...
      out.print(var_tcq);
      out.write("\" onblur=\"negNumber(this);checkNumber1(this,10,2);\">\r\n				    			</div>\r\n				    			<div class=\"col-auto\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"TCQ Change Request\" onclick=\"doTcqRequest();\" ");
if(!fcc_flg.equals("Y") || cont_status_flg.equals("X")||cont_status_flg.equals("C")||cont_status_flg.equals("T")){
...
if(!delta_tcq_sign.equals("")){
      out.write("\r\n		      							<script>document.forms[0].delta_tcq_sign.value=\"");
      out.print(delta_tcq_sign);
      out.write("\"</script>\r\n		      						");
}
      out.write("\r\n		      						<input type=\"hidden\" name=\"delta_tcq_sign1\" value=\"");
      out.print(delta_tcq_sign);
      out.write("\">\r\n		      					</div>\r\n					  			<div class=\"col-auto\">\r\n					      			<input type=\"text\" class=\"form-control form-control-sm\" name=\"closure_mmbtu\" value=\"");
      out.print(balance_qty );
      out.write("\" readOnly>\r\n					    		</div>\r\n					    		<div class=\"col-auto\">\r\n					    			<label class=\"form-label\"><b>Eff. Date</b></label>\r\n					    		</div>\r\n					    		<div class=\"col-auto\">\r\n					    			<div class=\"input-group input-group-sm\" >\r\n			      						<input type=\"text\" class=\"form-control form-control-sm date\" name=\"closure_eff_dt\" value=\"");
...
if(opration.equals("MODIFY")){ 
      out.write("\r\n				    			<div class=\"col\">\r\n				    				<input type=\"button\" class=\"btn btn-sm config_btn\" value=\"Variable DCQ Config\" onclick=\"variableDCQ('");
      out.print(contract_type);
      out.write('\'');
      out.write(',');
      out.write('\'');
...
for(int i=0; i<VTRUCK_TRANS_CD.size(); i++){ 
      ...
      out.write("\" title=\"");
      out.print(VTRUCK_TRANS_NM.elementAt(i));
      out.write("\" onchange=\"checkNom_Status('");
      out.print(clearance);
      out.write("','truck_trans');\" >&nbsp;");
      out.print(VTRUCK_TRANS_ABBR.elementAt(i));
      out.write("&nbsp;&nbsp;\r\n					    					<input type=\"hidden\" name=\"truck_trans_nom\" value=\"");
      out.print(VNOM_SEL_TRUCK_TRANS_CHK.elementAt(i));
      out.write("\" >\r\n					    				");
}
      out.write("\r\n				    				");
}else{ 
...
for(int i=0; i<VPLANT_SEQ_NO.size(); i++){ 
      ...
      out.write("\" onchange=\"checkNom_Status('");
      out.print(clearance);
      out.write("','cust_plant')\">&nbsp;");
      out.print(VPLANT_ABBR.elementAt(i));
      out.write("&nbsp;&nbsp;\r\n					    					<input type=\"hidden\" name=\"cust_plant_nom\" value=\"");
      out.print(VNOM_SEL_CUST_CHK.elementAt(i));
      out.write("\">\r\n					    				");
}
...
for(int i=0; i<VFILL_STATION_CD.size(); i++){ 
      ...
      out.write("\" onchange=\"checkNom_Status('");
      out.print(clearance);
      out.write("','fill_station')\">&nbsp;");
      out.print(VFILL_STATION_ABBR.elementAt(i));
      out.write("&nbsp;&nbsp;\r\n					    					<input type=\"hidden\" name=\"fill_nom\" value=\"");
      out.print(VNOM_SEL_FILL_CHK.elementAt(i));
      out.write("\">\r\n					    				");
}
      out.write("\r\n				    				");
}else{ 
...
if(write_access.equals("Y") && !tcq_request_flag.equals("Y") 
      ...
      out.write("\r\n					</div>\r\n				</div>\r\n			</div>	\r\n		</div>\r\n	</div>\r\n	&nbsp;\r\n	<div class=\"row\">\r\n		<div class=\"col-md-12 col-sm-12 col-xs-12\">\r\n			<div class=\"card cardmain\">\r\n				<div class=\"card-header cdheader\">\r\n					<div class=\"d-flex justify-content-between\">\r\n					    <div class=\"topheader\">\r\n					    	DLNG Contract - Change Request(s)\r\n					    </div>\r\n					</div>\r\n				</div>\r\n				<div class=\"card-body cdbody\">\r\n					<div class=\"row m-b-5\">\r\n						<div class=\"col-sm-12 col-xs-12 col-md-12\">  \r\n							<div class=\"form-group row\">\r\n								<div class=\"col-auto\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Modify Contract Duration\" onclick=\"\" data-bs-toggle=\"modal\" data-bs-target=\"#ChangeDurationModal\" ");
if(!fcc_flg.equals("Y") ||cont_status_flg.equals("X")||cont_status_flg.equals("C")||cont_status_flg.equals("T")){
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
}
      out.write(">\r\n				    			</div>\r\n								<div class=\"col-auto\"> \r\n									<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Price Change Request\" onclick=\"doPriceChangeRequest();\" ");
if(!fcc_flg.equals("Y") || !is_allocated.equals("Y")||cont_status_flg.equals("X")||cont_status_flg.equals("C")||cont_status_flg.equals("T")){
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
}
      out.write(">\r\n								</div>				    			\r\n				    			<div class=\"col-auto\" title=\"");
if(cont_status_flg.equals("R")){
      out.write("If contract Re-Opened then, closure request button will be enabled once fcc is completed!");
}else if(closure_request_flag.equals("Y")){
      out.write("Closure request generated");
}else if(cont_status_flg.equals("C")){
      out.write("Contract Closed");
}else if(!is_allocated.equals("Y")){
      out.write("Closure can be done once qty is allocated to the contract!");
}else if(!is_expired.equals("Y") && !cont_status_flg.equals("T")){
      out.write("Closure can be applied on expired contract only, use Terminate Request!");
}
      out.write("\">\r\n				    				<!-- <input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Closure Request\" style=\"background:#e6e6e6;color:black;\"> -->\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Closure Request\" ");
if((opration.equals("MODIFY")&&is_allocated.equals("Y")&&!closure_request_flag.equals("Y")&&!cont_status_flg.equals("C") &&!cont_status_flg.equals("T") &&!cont_status_flg.equals("R"))&&(is_expired.equals("Y"))){
      out.write("onclick=\"doClosureRequest('C');\"");
}else{
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
} 
      out.write(">\r\n				    			</div>\r\n				    			<div class=\"col-auto\" title=\"");
if(is_allocated.equals("Y") && !cancel_flag && !closure_request_flag.equals("A") && !closure_request_flag.equals("O")){
      out.write("Can't cancel the contract if qty is allocate, close the contract!");
}
      out.write("\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Cancel Contract\" data-bs-toggle=\"modal\" data-bs-target=\"#CancelModal\" ");
if(opration.equals("MODIFY") && !cont_status_flg.equals("X")){if((is_allocated.equals("Y") || cont_no.equals("0") || cont_no.equals(""))&&!cancel_flag){ 
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
}}else{
      out.write("style=\"background:#e6e6e6;color:black;\" disabled");
} 
      out.write(">\r\n				    			</div>\r\n				    			<div class=\"col-auto\" title=\"");
 if(!closure_request_flag.equals("O")){
      out.write("Activates when contract is closed or terminated!");
}else if(closure_request_flag.equals("O")){
      out.write("Contract Reopen Request generated!");
}
      out.write("\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Re-Open Request\" onclick = \"doReopenRequest();\"  ");
if((opration.equals("INSERT") ||(!cont_status_flg.equals("C")&&!cont_status_flg.equals("T")))||closure_request_flag.equals("O")){
      out.write(" style=\"background:#e6e6e6;color:black;\" disabled ");
} 
      out.write(">\r\n				    			</div>\r\n								<div class=\"col-auto\" title=\"");
if(cont_status_flg.equals("R")){
      out.write("If contract Re-Opened then, terminate request button will be enabled once fcc is completed!");
}if(is_expired.equals("Y")){
      out.write("Contract is expired, so close contract!");
}else if(!termination_forced.equals("Y")){
      out.write("Configure Termination/Suspention (Force Majeure) to enable!");
}else if(closure_request_flag.equals("R")){
      out.write("Termination request is generated for the contract!");
}else if(cont_status_flg.equals("T")){
      out.write("Contract Terminated!");
}
      out.write("\">\r\n				    				<input type=\"button\" class=\"btn btn-sm request_btn\" value=\"Terminate Request\" onclick=\"doClosureRequest('T');\"  ");
if(opration.equals("INSERT")||!termination_forced.equals("Y")|| cont_status_flg.equals("C") ||cont_status_flg.equals("T")||closure_request_flag.equals("X")||cont_status_flg.equals("R") || is_expired.equals("Y") || !is_allocated.equals("Y") || closure_request_flag.equals("R")){
      out.write(" style=\"background:#e6e6e6;color:black;\" disabled ");
} 
      out.write(">\r\n				    			</div>\r\n				  			</div>\r\n						</div>\r\n					</div>\r\n					<br>\r\n					");
...
if((no_of_security_dtl.equals("0") || no_of_security_dtl.equals("") || adv_adjust.equals("")) && clearance.equals("KYC")){ 
      out.write("\r\n							<div class=\"row m-b-5\">\r\n								<div class=\"col-sm-12 col-xs-12 col-md-12\">\r\n									");
      out.print(utilmsg.errorMessage("<b>Security Detail/Adjust Advance not Configured. The Contract will not appear for FCC!</b>"));
      out.write("\r\n								</div>\r\n							</div>\r\n						");
} 
      out.write("\r\n						");
...
if(closure_request_flag.equals("Y")) {
      ...
      out.print(dealMapping);
      out.write("] Duration Modification\r\n				</div>\r\n        		<input type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\" onclick=\"(function() {document.forms[0].new_start_dt.value='';document.forms[0].new_end_dt.value='';})();\">\r\n      		</div>\r\n      		<div class=\"modal-body mdbody\">\r\n      			<div class=\"cdbody\">\r\n      				<div class=\"row m-b-5\">\r\n						<div class=\"col-sm-2 col-xs-2 col-md-2\">  \r\n							<div class=\"form-group row\">\r\n				    			<label class=\"form-label\"><b>New Start Date<span class=\"s-red\">*</span></b></label>\r\n				  			</div>\r\n						</div>\r\n						<div class=\"col-sm-4 col-xs-4 col-md-4\"> \r\n							<div class=\"form-group row\">\r\n				    			<div class=\"col\">\r\n				    				<div class=\"input-group input-group-sm\" >\r\n			      						<input type=\"text\" class=\"form-control form-control-sm date fmsdtpick\" name=\"new_start_dt\" value=\"");
      out.print(start_dt);
      out.write("\" maxLength=\"10\" onblur=\"validateDate(this);checkStartEndDate(this,document.forms[0].new_end_dt,'F');\" onchange=\"validateDate(this);checkStartEndDate(this,document.forms[0].new_end_dt,'F');\" autocomplete=\"off\">\r\n			      						<span class=\"input-group-text\"><i class=\"fa fa-calendar fa-lg\"></i></span>\r\n		      						</div>\r\n		      					</div>\r\n				  			</div> \r\n						</div>\r\n						<div class=\"col-sm-2 col-xs-2 col-md-2\">  \r\n							<div class=\"form-group row\">\r\n				    			<label class=\"form-label\"><b>New End Date<span class=\"s-red\">*</span></b></label>\r\n				  			</div>\r\n						</div>\r\n						<div class=\"col-sm-4 col-xs-4 col-md-4\"> \r\n							<div class=\"form-group row\">\r\n				    			<div class=\"col\">\r\n				    				<div class=\"input-group input-group-sm\" >\r\n			      						<input type=\"text\" class=\"form-control form-control-sm date fmsdtpick\" name=\"new_end_dt\" value=\"");
      out.print(end_dt);
      out.write("\" maxLength=\"10\" onblur=\"validateDate(this);checkStartEndDate(document.forms[0].new_start_dt,this,'T');\" onchange=\"validateDate(this);checkStartEndDate(document.forms[0].new_start_dt,this,'T');\" autocomplete=\"off\">\r\n			      						<span class=\"input-group-text\"><i class=\"fa fa-calendar fa-lg\"></i></span>\r\n		      						</div>\r\n		      					</div>\r\n				  			</div> \r\n						</div>\r\n					</div>\r\n      			</div>\r\n      		</div>\r\n			<div class=\"modal-footer cdfooter\">\r\n				<div class=\"\" align=\"right\">\r\n					<input type=\"button\" class=\"btn btn-warning com-btn\" value=\"Submit\" onclick=\"doContractDurationChangeRequest();\">\r\n				</div>\r\n			</div>\r\n		</div>\r\n	</div>\r\n</div>\r\n\r\n<!-- Cancel Modal -->\r\n<div class=\"modal fade\" id=\"CancelModal\" data-bs-backdrop=\"static\" data-bs-keyboard=\"false\">\r\n	<div class=\"modal-dialog modal-dialog-scrollable modal-xl\">\r\n		<div class=\"modal-content\">\r\n			<div class=\"modal-header cdheader\">\r\n        		<div class=\"topheader\">\r\n					Contract [");
      out.print(dealMapping);
      ...
      out.write("						<input type=\"button\" class=\"btn btn-warning com-btn\" value=\"Submit\" onclick=\"cancelContract();\">\r\n					</div>\r\n				</div>\r\n	      	</div>\r\n		</div>\r\n	</div>\r\n</div>\r\n<!-- /Cancel Modal -->\r\n\r\n<input type=\"hidden\" name=\"option\" value=\"DLNG_CONT_MST\">\r\n<input type=\"hidden\" name=\"old_value\" value=\"");
      out.print(old_value);
      ...
      out.print(sysdate);
      out.write("\">\r\n<input type=\"hidden\" name=\"is_inv_submitted\" value=\"");
      out.print(is_inv_submitted);
