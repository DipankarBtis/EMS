 ...
 * Generated at: 2026-03-07 11:01:44 UTC
...
public final class frm_005fcontract_005fmst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String execute_access = menu_access.getExecute_access();
      ...
      out.write("				flag=false;\r\n			}\r\n		}\r\n		if(opration==\"MODIFY\")\r\n		{\r\n			var cont_no = document.forms[0].cont_no.value;\r\n			if(cont_no == \"\" || cont_no == \"0\")\r\n			{\r\n				msg+=\"Select Contact!\\n\";\r\n				flag=false;\r\n			}\r\n		}\r\n		if(trim(dda_dt) == \"\")\r\n		{\r\n			msg+=\"Enter DDA Date!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(dda_time) == \"\")\r\n		{\r\n			msg+=\"Enter DDA Time!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(signing_dt) == \"\")\r\n		{\r\n			msg+=\"Enter Contract/Trade Date!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(signing_time) == \"\")\r\n		{\r\n			msg+=\"Enter Signing Time!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(ent_dt) == \"\")\r\n		{\r\n			msg+=\"Enter Deal Enter Date!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(ent_time) == \"\")\r\n		{\r\n			msg+=\"Enter Deal Enter Time!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(start_dt) == \"\")\r\n		{\r\n			msg+=\"Enter Start Date!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(end_dt) == \"\")\r\n		{\r\n			msg+=\"Enter End Date!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(rate) == \"\")\r\n		{\r\n			msg+=\"Enter Gas Price!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(rate_unit) == \"\")\r\n");
      out.write("		{\r\n			msg+=\"Select Rate Unit!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(tcq) == \"\")\r\n		{\r\n			msg+=\"Enter TCQ!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(quantity_unit) == \"\")\r\n		{\r\n			msg+=\"Select Quantity Unit!\\n\";\r\n			flag=false;\r\n		}\r\n		if(trim(dcq) == \"\")\r\n		{\r\n			msg+=\"Enter DCQ!\\n\";\r\n			flag=false;\r\n		}\r\n		\r\n		if(agreement_type[0].checked == false && agreement_type[1].checked == false)\r\n		{\r\n			msg+=\"Select Agreement Type!\\n\";\r\n			flag=false;\r\n		}\r\n		if(agreement_base[0].checked == false && agreement_base[1].checked == false)\r\n		{\r\n			msg+=\"Select Agreement Base!\\n\";\r\n			flag=false;\r\n		}\r\n		\r\n		//FOR CUSTOMER PLANT\r\n		var chkFlg = false;\r\n		if(chk_plant!=null && chk_plant!=undefined)\r\n		{\r\n			if(chk_plant.length!=undefined)\r\n			{\r\n				for(var i=0;i<chk_plant.length;i++)\r\n				{\r\n					if(chk_plant[i].checked)\r\n					{\r\n						chkFlg = true;	\r\n						if(agreement_base[1].checked == true)\r\n						{\r\n							if(charge_abbr!=null && charge_abbr.length!=undefined)\r\n						 	{\r\n						  		for(var j=0;j<charge_abbr.length;j++)\r\n						  		{\r\n");
      out.write("						  			var temp = document.getElementById(\"charge_abbr_\"+j).value;\r\n						  			//alert(temp)\r\n						  			if(temp==\"TC\")\r\n						  			{\r\n						  				var chrRate=document.getElementById(temp+\"_\"+i+\"_\"+j).value;\r\n							  			var chrEff=document.getElementById(\"eff_dt_\"+temp+\"_\"+i+\"_\"+j).value;\r\n							  			\r\n							  			if(trim(chrRate)==\"\")\r\n										{\r\n											msg+=\"Enter Transportation Charges for \"+chk_plant_abbr[i].value+\"!\\n\";\r\n											flag=false;\r\n										}\r\n							  			\r\n							  			if(trim(chrEff)==\"\")\r\n										{\r\n											msg+=\"Select Transportation Charges Eff.Dt for \"+chk_plant_abbr[i].value+\"!\\n\";\r\n											flag=false;\r\n										}\r\n									}\r\n						  		} \r\n						 	}\r\n						 	else if(charge_abbr!=null)\r\n						 	{\r\n						 		var temp = document.getElementById(\"charge_abbr_0\").value;\r\n					  			//alert(temp)\r\n					  			if(temp==\"TC\")\r\n					  			{\r\n					  				var chrRate=document.getElementById(temp+\"_\"+i+\"_0\").value;\r\n						  			var chrEff=document.getElementById(\"eff_dt_\"+temp+\"_\"+i+\"_0\").value;\r\n");
...
if(clearance.equals("IGX")){ 
      ...
      out.write("\r\n				      			</div>\r\n				  			</div>\r\n						</div>\r\n					</div>\r\n					<div class=\"row m-b-5\">\r\n						<div class=\"col-sm-2 col-xs-2 col-md-2\">  \r\n							<div class=\"form-group row\">\r\n								<div class=\"col-sm-12 col-xs-12 col-md-12\">\r\n				    				<input type=\"button\" class=\"btn btn-sm config_btn\" value=\"Delivery Pt Config\" title=\"Transporter Entry Point / Delivery Point-");
      out.print(owner_abbr);
...
if(VTRANS_CD.elementAt(j).equals(VTEMP_TRANS_CD.elementAt(i))){ 
      ...
      out.write(',');
      out.write('\'');
      out.print(VNOM_SEL_TRANS_CHK.elementAt(j));
      out.write("')\">&nbsp;");
...
if(!cont_status_flg.equals("X")&&!cont_status_flg.equals("C")&&!cont_status_flg.equals("T")){
      ...
      out.print(utilmsg.errorMessage("<b>Same Eff. Date will overwrite the Charges details, Different Eff. Date will create new entry!</b>"));
...
for(int i=0; i<VPLANT_SEQ_NO.size(); i++){ 
      ...
      out.write("&nbsp;\r\n				      							<i name=\"history_btn_");
      out.print(VPLANT_SEQ_NO.elementAt(i));
      out.write("\" id=\"history_btn_");
      out.print(VPLANT_SEQ_NO.elementAt(i));
      out.write("\" class=\"fa fa-info-circle fa-lg\" aria-hidden=\"true\" style=\"pointer-events: auto; color:#800040\"></i>\r\n				      							<input type=\"hidden\" name=\"chk_plant_abbr\" value=\"");
      out.print(VPLANT_ABBR.elementAt(i));
      out.write("\">\r\n				      						</td>\r\n								    		");
 for(int j=0; j<VCHARGE_ABBR.size(); j++){ 
      ...
      out.write('_');
      out.print(j);
      out.write("\" maxLength=\"10\" \r\n							      						onblur=\"validateDate(this);checkChargesEffDate(this,'");
      out.print(VCHARGE_NAME.elementAt(j));
      out.write("','max_eff_dt_");
      out.print(VCHARGE_ABBR.elementAt(j));
      out.write('_');
      out.print(i);
      out.write('_');
      out.print(j);
      out.write("');\"\r\n							      						onchange=\"validateDate(this);checkChargesEffDate(this,'");
      out.print(VCHARGE_NAME.elementAt(j));
      out.write("','max_eff_dt_");
      out.print(VCHARGE_ABBR.elementAt(j));
      out.write('_');
      ...
      out.write('_');
      out.print(j);
      out.write("');\" \r\n							      						autocomplete=\"off\" disabled>\r\n							      						<input type=\"hidden\" name=\"max_eff_dt_");
      out.print(VCHARGE_ABBR.elementAt(j));
      out.write("\" id=\"max_eff_dt_");
      out.print(VCHARGE_ABBR.elementAt(j));
      out.write('_');
      out.print(i);
      out.write('_');
