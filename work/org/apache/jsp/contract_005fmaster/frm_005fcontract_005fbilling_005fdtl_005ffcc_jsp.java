 ...
 * Generated at: 2025-10-06 04:50:09 UTC
...
public final class frm_005fcontract_005fbilling_005fdtl_005ffcc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0;i<VPLANT_SEQ.size();i++)
{
	strPlant = strPlant + VPLANT_SEQ.elementAt(i)+"@";
      ...
      out.write("\r\n<body style=\"pointer-events: none;\" onload=\"setBillingPeriod(document.forms[0].billing_flag);setBillingDays(document.forms[0].freq);setExchgVal(document.forms[0].exchng_rate);enablechk();setValues('");
      out.print(sat_days);
