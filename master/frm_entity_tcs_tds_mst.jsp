				...
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
						<div class="topheader">
							...
							<%=tax_app%> Structure Details (<font style="background:#99ffcc;font-size:20px;font-weight:bold;">For Tax/Retail Invoice</font>)
						</div>
					</div>
				</div>
				<div class="card-body cdbody">
				...
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
						<div class="topheader">
							<%if(entity_role.equals("C")){ %>Customer
							<%}else if(entity_role.equals("T")){ %>Trader
							<%}else if(entity_role.equals("R")){ %>Transporter<%}%> Service <%=tax_app%> Structure Details (<font style="background:#99ffcc;font-size:20px;font-weight:bold;">For Service Invoice</font>)
						</div>
					</div>
				</div>
				<div class="card-body cdbody">
							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<tr>
										...
										<td align="center">
											<div style="width:50px;">
												<input type="button" class="btn btn-info btn-sm select_btn" value="Select" onclick="openTaxStructMst('S','<%=tax_pay_recv%>');">
											</div>
										</td>
									</tr>
									<%{int m=0,n=0; %>
