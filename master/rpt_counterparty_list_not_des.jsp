								...
								<%if(VCOUNTERPARTY_CD.size() > 0){ %>
									...
									<tr>
										<td width="5px" align="center">
											<input type="radio" name="rdo" onclick="setValue(this,'<%=VCOUNTERPARTY_CD.elementAt(i)%>')" <%if(VSTATUS.elementAt(i).equals("N")){ %>disabled<%} %>>
										</td>
										<td><%=VCOUNTERPARTY_ABBR.elementAt(i)%></td>
										<td><%=VCOUNTERPARTY_NM.elementAt(i)%></td>
										<td align="center">
											<div align="center">
												<font style="color:<%if(VSTATUS.elementAt(i).equals("Y")){%>#a6ff4d
