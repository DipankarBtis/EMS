...
function exportToXls()
{
	...
	if(flag==true)
	{
		var url = "xls_entity_turnover_dtl.jsp?fileName=Entity Turnover Entry.xls&financial_year="+financial_year+"&turnover_cd="+turnover_cd+"&entity_role="+entity_role;
				...
				<div class="card-body cdbody">
					<div class="row m-b-5">
						...
						<div class="col-sm-4 col-xs-4 col-md-4">
							<div class="form-group row">
								<div class="col-auto">
									<label class="form-label"><b><%if(entity_role.equals("T")){ %>TCS Certificate<%}else{%>Turnover <%} %><span class="s-red">*</span></b></label>
								</div>
								<div class="col-auto">
									<div class="btn-group">
							...
							<table class="table table-bordered table-hover" id="example">
								...
								<%}else{ %>
									...
									<tr>
										...
										<td align="center">
											<input type="radio" name="turnover_flag<%=i%>" id="rdY<%=i%>" value="Y" 
											<%if(VTURNOVER_FLAG.elementAt(i).equals("Y")){%>checked class="form-check-input"<%}%> 
											<%if(VTURNOVER_FLAG.elementAt(i).equals("")){%>checked<%}%> 
											disabled>&nbsp;&nbsp;<span>Yes</span>
										</td>
										<td align="center">
											<input type="radio" name="turnover_flag<%=i%>" id="rdN<%=i%>" value="N" 
											<%if(VTURNOVER_FLAG.elementAt(i).equals("N")){%>checked class="form-check-input"<%}%>
