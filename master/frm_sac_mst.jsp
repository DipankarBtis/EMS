...
function doSubmit()
{
	...
	var sac_code = document.forms[0].sac_code.value;
	var sac_cd = document.forms[0].sac_cd.value;
	var desc = document.forms[0].desc.value;
	if(sac_code=="" || sac_code=="0" || trim(sac_code)=="")
	{
		msg+="Enter SAC Name!\n";
		flag=false
	}
...
function doClear()
{
	...
	document.forms[0].sac_code.value="";
...
function doModify(VSAC_CD,VSAC_NM,VSAC_DESC,VSAC_REMARKS,VSAC_FLAG)
{
	...
	document.forms[0].sac_code.value=VSAC_NM;
...
Vector VSAC_CODE = sacMst.getVSAC_CODE();
										...
										<tr>
											<td align="center">
												<font title="Click to Edit" style="color:var(--header_color)">
													...
													onclick="doModify('<%=VSAC_CD.elementAt(i)%>','<%=VSAC_CODE.elementAt(i)%>','<%=VSAC_DESC.elementAt(i)%>','<%=VSAC_REMARKS.elementAt(i)%>','<%=VSAC_FLAG.elementAt(i)%>')">
													</i>
												</font>
											</td>
											<td><%=VSAC_CODE.elementAt(i)%></td>
					...
					<div class="row m-b-5">
						<div class="col-sm-2 col-xs-2 col-md-2">  
							<div class="form-group row">
								<label class="form-label"><b>SAC Code<span class="s-red">*</span></b></label>
				  			</div>
						</div>
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				      				<input type="text" class="form-control form-control-sm" name="sac_code" value="" maxLength="20" 
				      				onchange="checkForNumber(this);" onblur="checkForNumber(this);">
