...
function refresh()
{
	...
	var chk_diff = document.forms[0].chk_diff;//RG20251006 added for all invoices filter in Sales Actual Report
	...
	var url = "frm_invoice_accounting_approval.jsp?u="+u+"&segment="+segment+
			"&from_dt="+from_dt+"&to_dt="+to_dt+"&chk_diff="+chk_diff;
...
function exportToXls()
{
	...
	var to_dt = document.forms[0].to_dt.value;
	var segment = document.forms[0].segment.value;
	var chk_diff = document.forms[0].chk_diff;//RG20251006 added for all invoices filter
	...
	var url = "xls_invoice_accounting_approval.jsp?segment="+segment+"&from_dt="+from_dt+"&to_dt="+to_dt+"&chk_diff="+chk_diff;
...
String chk_diff = request.getParameter("chk_diff")==null?"Y":request.getParameter("chk_diff");//RG20251006 added for aadding all invoice filter
...
accounting.setChk_diff(chk_diff);
accounting.init();
...
Vector VFIN_SYS = accounting.getVFIN_SYS();		//PB 20250627 for Sun
%>
<body>
							...
							<div class="form-group row">
								...
								<div class="col">
									<div class="input-group input-group-sm" >
										...
										onblur="validateDate(this);" onchange="validateDate(this);" autocomplete="off"><!-- RG20251006 Removed autorefresh from onchange -->
							...
							<div class="form-group row">
								<div class="col-auto">
									<label class="form-label">
										<b>
											<input type="checkbox" class="form-check-input" name="chk_diff" <%if(chk_diff.equals("Y")){%>checked<%}%>>		
											&nbsp;All Invoices
										</b>
									</label>
					  			</div>
								...
								<thead>
									<tr>
										...
										<th rowspan="2">TCS/TDS
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_tcstds" onkeyup="Search(this,'18');" placeholder="Search.." style="width:100px"/></div>
										</th>
										<th rowspan="2">TCS/TDS%</th>
										<th rowspan="2">+TCS/-TDS Amount</th>
										<th rowspan="2">Net Receivable</th>
										<th rowspan="2">Billing Period
											<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_billinng period" onkeyup="Search(this,'22');" placeholder="Search.." style="width:100px"/></div>
										</th>
