							...
							<div class="accordion">
								<div class="accordion-item accor_item">
									<h2 class="accordion-header" id="heading1">
										...
										<%=VSEGMENT.elementAt(l) %>&nbsp;&nbsp;<font color="blue">(<%=index%> Items)</font>
										</button>	
							    	</h2>
														...
														<table class="table table-bordered table-hover" id="example<%=l%>">
															...
															<%if(VSEGMENT.elementAt(l).equals("Derivatives")){ %>
																<tr>
																	<th rowspan="2">SR#</th>
																	<th rowspan="2">Month
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_month<%=l%>" onkeyup="Search(this,'1','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th rowspan="2">Segment
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_segment<%=l%>" onkeyup="Search(this,'2','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th rowspan="2">Counterparty
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_counterparty<%=l%>" onkeyup="Search(this,'3','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																...
																<tr>	
																	<th>Contract#<br> [Contract/Trade Ref]
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_contract<%=l%>" onkeyup="Search(this,'4','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>										
																	<th>Contract Period</th>
																	<th>BU
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_BU<%=l%>" onkeyup="Search(this,'6','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th>Plant
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_plant<%=l%>" onkeyup="Search(this,'7','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th>Booked MMBTU</th>
																	<th>Invoice Type
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_invoice_type<%=l%>" onkeyup="Search(this,'9','<%=l%>');" placeholder="Search.." style="width:100px"/></div>										
																	</th>										
																	<th>Invoice#
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_invoice_no<%=l%>" onkeyup="Search(this,'10','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th>Invoice Date</th>
																	...
																	<th>Sales Rate</th>
																	<th>Rate Unit/MMBTU
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_rate<%=l%>" onkeyup="Search(this,'16','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
															...
															<%}else{ %>
																...
																<tr>	
																	...
																	<th>Balance MMBTU</th>
																	<th>Invoice Type
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_invoice_type<%=l%>" onkeyup="Search(this,'11','<%=l%>');" placeholder="Search.." style="width:100px"/></div>										
																	</th>										
																	<th>Invoice#
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_invoice_no<%=l%>" onkeyup="Search(this,'12','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th>Invoice Date</th>
																	<th>Invoice Due Date</th>
																	<th>Billing Period</th>
																	...
																	<th>Sales Rate</th>
																	<th>Rate Unit/MMBTU
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_rate<%=l%>" onkeyup="Search(this,'18','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th>Sales Amount</th>
																	<th>Exchange Rate (INR/USD)</th>
																	<th>Invoice Raised In
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_invoiced_in<%=l%>" onkeyup="Search(this,'21','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<%if(!VSEGMENT.elementAt(l).equals("LTCORA") ){%>
																	...
																	<th>Total Gross Amount</th>
																	<th>Tax Structure
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_tax_str<%=l%>" onkeyup="Search(this,'26','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th>Tax </th>
																	<th>Invoice Amount</th>
																	<th>TCS/TDS
																		<br><div align="center"><input class="form-control form-control-sm" type="text" id="table_tcstds<%=l%>" onkeyup="Search(this,'29','<%=l%>');" placeholder="Search.." style="width:100px"/></div>
																	</th>
																	<th>TCS/TDS%</th>
