...
String chk_diff = request.getParameter("chk_diff")==null?"":request.getParameter("chk_diff");//RG20251006 added for aadding all invoice filter
...
%>
<span style="font-weight: bold;font-size: 40px;">Sales Invoice (FO) Approval<%if(chk_diff.equals("Y")){ %> For All Invoices<%} %></span>
<br><br>
