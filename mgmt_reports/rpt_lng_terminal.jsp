...
function refresh()
{
	...
	if(flag==true)
	{
		var url="rpt_lng_terminal.jsp?month="+month+"&year="+year+"&month_to="+month_to+"&year_to="+year_to+"&u="+u;
...
function exportToXls()
{
	...
	var fileName = comp_abbr+"_"+"4A_LNG_Terminal"+".xls";
	
	var url="xls_lng_terminal.jsp?month="+month+"&year="+year+"&fileName="+fileName+"&month_to="+month_to+"&year_to="+year_to;
	location.replace(url);
}
</script>
</head>
