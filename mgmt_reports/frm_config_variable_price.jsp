...
<jsp:useBean class="com.etrm.fms.mgmt_reports.DataBean_DealActivePrice" id="dealActive" scope="request"></jsp:useBean>
							...
							<table class="table table-bordered table-hover" id="example">
								...
								<%if(VPRICE_TYPE.size()>0) {%>
									...
									<tr>
										<td align="center">
											<input type="radio" name="rd" 
												...
												onclick="doModify('<%=VSEQ_NO.elementAt(i)%>','<%=VSTART_DT.elementAt(i)%>','<%=VEND_DT.elementAt(i)%>',
													...
													'<%=counterparty_abbr%>','<%=counterparty_cd%>','<%=contract_no%>','<%=cont_ref%>','<%=cont_status%>','<%=VPRICE_DECI.elementAt(i)%>','<%=VPREM_DISC_RATE.elementAt(i)%>','<%=VFINAL_PRICE_DECI.elementAt(i)%>');">&nbsp;&nbsp;
											<%=i+1%>
										</td>
										<td align="center">
										...
										<td align="center"><%=VPREM_DISC_RATE.elementAt(i)%></td>									
				...
				<!-- SagarB20251231 Added till here -->	
					...
					<!-- SagarB20251231 -->
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
								<div class="col-sm-12 col-xs-12 col-md-12">	
									<select class="form-select form-select-sm" name="MIN_price_deci" id="<%=fin_curv_ele%>_price_deci" value="" onBlur="checkNumber1(this,1,0);" disabled>	<!-- SagarB20260213 -->
										<option value="">-Select-</option>
										<option value="0">0 Decimal</option>
										<option value="1">1 Decimal</option>
										<option value="2">2 Decimal</option>
									...
									<%-- <input type="text" class="form-control form-control-sm" name="MIN_price_deci2" id="<%=fin_curv_ele%>_price_deci2" value="" onBlur="checkNumber1(this,1,0);" disabled>  --%>
				  				</div>
				  			</div>
						</div>
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
								<div class="col-sm-12 col-xs-12 col-md-12">		
									<input type="text" class="form-control form-control-sm" name="MIN_prem_disc_rate" id="<%=fin_curv_ele%>_prem_disc_rate" value="" onBlur="checkNumber1(this,8,4);" disabled> 
				  				</div>
				  			</div>
						</div>
