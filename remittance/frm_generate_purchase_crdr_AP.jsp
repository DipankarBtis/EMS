...
function enableNewValues(obj)
{
	...
	if(obj.value=="QTY")
	{
		...
		if(obj.checked)
		{
			document.forms[0].new_alloc_qty.readOnly=false;
		}
		else
		{
			document.forms[0].new_alloc_qty.readOnly=true;
		}
...
async function calc()
{
	...
	if(trim(alloc_qty) != "")
	{
		/* if(document.getElementById("criteria_QTY").checked)
		{
...
function difference(changed_flg)
{
	...
	fields.forEach(field => {
        ...
        if (mainValue !== "" && newValue !== "") 
        {
			...
			if(field=="gross_amt1" && gross_amt1!=diff.toFixed(2) && gross_amt1!="" && gross_amt1!="0.00" && changed_flg=="Y")
			{
				is_changed="Y";
			...
			if(field=="gross_include_transport_tariff" && gross_include_transport_tariff!=diff.toFixed(2) && gross_include_transport_tariff!="" && changed_flg=="Y")
			{
				is_changed="Y";
	...
	if(sub_tax_amt.length > 0)
	{
		...
		for(var i=0; i<sub_tax_amt.length; i++)
    	{
	        ...
	        if (mainValue !== "" && newValue !== "") 
	        {
	        	...
	        	if(sub_tax_amt[i].value!=diff && sub_tax_amt[i].value!="" && sub_tax_amt[i].value!="0.00" && changed_flg=="Y")
        		{
										...
										<tbody>
											...
											<tr>
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="new_alloc_qty" value="<%=new_qty_mmbtu %>" onblur="negNumber(this);calc();" readOnly>
															<span class="input-group-text">MMBTU</span>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="gross_amt1" value="<%=gross_amt1%>" onchange="difference('Y')">
															<span class="input-group-text"><%=invoice_raised_in_nm%></span>
														</div>
											...
											<tr <%if(!isMainGrossIncTriff){ %>style="display:none;"<%} %>>
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="gross_include_transport_tariff" value="<%=gross_include_transport_tariff %>" onchange="difference('Y')">
															<span class="input-group-text"><%=invoice_raised_in_nm%></span>
														</div>
													</div>
												</td>
													...
													{%>
														<tr style="background: #cff4fc;"><%-- <%if(((Vector) temp.elementAt(0)).size()==1){%>display:none;<%} %>" > --%>
															...
															<td align="center">
																<div style="width:200px;">
																	<div class="input-group input-group-sm" >
																		<input type="text" class="form-control form-control-sm" name="sub_tax_amt" value="<%=((Vector) temp.elementAt(2)).elementAt(j)%>" onchange="difference('Y')">
																		<span class="input-group-text"><%=invoice_raised_in_nm%></span>
																	</div>
											...
											<tr>
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="new_tcs_amt" value="<%=main_tcs_amount%>" readOnly>
												...
												<td align="center">
													<div style="width:200px;">
														<div class="input-group input-group-sm" >
															<input type="text" class="form-control form-control-sm" name="tcs_amt" value="<%=main_tcs_amount%>" readOnly>
...
async function calcExsitingTaxStructure(tax_struct_cd,gross_amt)
{
	...
	{
		$.post("../servlet/DB_pur_invoice_Ajax?setCallType=CALC_EXISTING_TAX_DTL_FOR_CR_DR&tax_struct_cd="+tax_struct_cd+"&gross_amt="+gross_amt, function(responseJson) {
