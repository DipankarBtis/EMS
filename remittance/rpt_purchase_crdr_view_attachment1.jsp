			...
			<div align="center">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<div align="right">
								<font size="1.5px" face="Arial"><b><%=NormalFont%> No:&nbsp;</b></font>
							</div>
						</td>
					</tr>
					<tr>
...
<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
	...
	<tr valign="top">
		...
		<td><div align="center"><font size="1.5px" face="Arial"><%=invoice_raised_in_nm%></font>&nbsp;</div></td>
		<td><div align="right"><font size="1.5px" face="Arial">(<%=main_tcs_factor%>%) <%=main_tcs_amount%></font>&nbsp;</div></td>
		<td><div align="right"><font size="1.5px" face="Arial">(<%=main_tcs_factor%>%)<%=new_tcs_amount%></font>&nbsp;</div></td>
		<td><div align="right"><font size="1.5px" face="Arial"><%=tcs_amount%></font>&nbsp;</div></td>
	</tr>
	<%} %>
