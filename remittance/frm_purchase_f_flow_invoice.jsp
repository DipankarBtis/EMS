...
function refresh(opration)
{
	...
	if(flag)
	{
		var url = "frm_purchase_f_flow_invoice.jsp?u="+u+"&counterparty_cd="+counterparty_cd+"&entity="+entity+
				...
				"&address_type="+address_type+"&bu_unit="+bu_unit+"&invoice_category="+invoice_category+"&invoice_type="+invoice_type+"&opration="+opration+
			...
			<div class="card cardmain">
				<div class="card-header cdheader">
					<div class="d-flex justify-content-between">
					    ...
					    <div class="btn-group">
							<select class="btn btn-outline-secondary btngrp <%if(!entity.equals("")){%>btnactive<%}%>" name="entity" onchange="refresh('<%=opration%>');">
						...
						<script>
							document.forms[0].entity.value="<%=entity%>"
						</script>	
					</div>
				</div>
				...
				<div class="card-body cdbody">
					<div class="row m-b-5">
						...
						<%-- <div class="col-auto" id="row_tds" style="display: none">  
						...
						<div class="col-sm-4 col-xs-4 col-md-4">  
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
									...
									<script>document.forms[0].invoice_head.value="<%=invoice_head%>"</script>				
				    			</div>
				    		</div>
				    	</div>
				    </div>
							...
							<div class="form-group row">
				    			<div class="col-sm-12 col-xs-12 col-md-12">
				    				<select class="form-select form-select-sm" name="linked_invoice">
										...
										<option value="<%=VLINK_INVOICE_NO.elementAt(i)%>"><%=VLINK_INVOICE_NO.elementAt(i)%> [<%=VSYS_LINK_INVOICE_NO.elementAt(i)%>]</option>
										<%} %>
									</select>
							...
							<div class="form-group row">
				    			...
				    			<div class="col-4">								
				    				<select class="form-select form-select-sm" name="qty_unit">
		      						...
		      						<script>document.forms[0].qty_unit.value="<%=energy_unit%>"</script>
				    			</div>
				    		</div>
				    	</div>			
				    </div>
									...
									<table class="table table-bordered table-hover">
										...
										<tbody id="itemTab">
											...
											<tr>
												...
												<td align="center">
													<input type="text" class="form-control form-control-sm" name="qty" value="<%=VQTY.elementAt(i)%>" maxlength='25' style="width:100px;text-align:right;">
												</td>
												<td align="center">
