							...
							<div class="form-group row">
								...
								<div class="col-auto">
									<select class="form-select form-select-sm" name="counterparty_cd" onchange="refresh()">
										...
										{ %>
										<option value="<%=VCOUNTERPARTY_CD.elementAt(i)%>"><%=VMST_COUNTERPARTY_ABBR.elementAt(i)%> - <%=VMST_COUNTERPARTY_NM.elementAt(i) %></option>
										<%} %>
									</select>
							...
							<%if(VLAST_UPDATE.size()>0) {%>
								...
								<tr>
									...
									<td align="center">
										...
										<%}else if(VDEAL_STATUS.elementAt(i).equals("Approved") || VDEAL_STATUS.elementAt(i).equals("Confirmed")){ %>
											class="alert" style="background:#b3ffb3;color: #008000;"
										<%}else if(VDEAL_STATUS.elementAt(i).equals("Not Approved")|| VDEAL_STATUS.elementAt(i).equals("Cancelled")){%>
											class="alert alert-danger"
										<%}else if(VDEAL_STATUS.elementAt(i).equals("Pending Approval") || VDEAL_STATUS.elementAt(i).equals("Not-Confirmed")){ %>
