...
<jsp:useBean class="com.etrm.fms.util.CommonVariable" id="CommonVariable" scope="request"></jsp:useBean>
<%
							...
							<div class="form-group row">
								...
								<div class="col-auto">
									<select class="form-select form-select-sm" name="segmentType" onchange="refresh()">
										...
										<option value="VS">Hedge Deal(Sell)</option>
											...
											<table id="pur_table" name="pur_table" class="table table-bordered table-hover">
												...
												if(index > 0){ %>
													...
													<tr <%if(!ld_status.equals("0")) {%> <%if(VPURCHASE_LATE_DEAL_FLAG.elementAt(i).equals("")){%>hidden="hidden"<%} %> <%} %>id="pur_row<%=i%>" name="pur_row">
														...
														<td align="center"><%=VPURCHASE_CONT_NO.elementAt(i)%></td><%-- <%if(!VPURCHASE_TEMP_SEGMENT_TYPE.elementAt(j).equals("N")){%><%=VPURCHASE_CONTRACT_TYPE.elementAt(i)%><%}%> --%>
														...
														<%if(VPURCHASE_TEMP_SEGMENT_TYPE.elementAt(j).equals("VB")){ %>
														<td align="right"><%=VPURCHASE_QTY_UNIT.elementAt(i) %></td>
														<%}else{ %>
											...
											<table class="table table-bordered table-hover">
												...
												if(index > 0){ %>
													...
													<tr <%if(!ld_status.equals("0")) {%> <%if(VSELL_LATE_DEAL_FLAG.elementAt(l).equals("")){ %>hidden="hidden"<%} %> <%} %>>
														...
														<%if(VSELL_TEMP_SEGMENT_TYPE.elementAt(n).equals("VS")){ %>
														<td align="right"><%=VSELL_QTY_UNIT.elementAt(l) %></td>
														<%}else{%>
