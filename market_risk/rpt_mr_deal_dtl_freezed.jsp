							...
							<table class="table table-bordered table-hover" id="filterbysearch">
								<thead id="tbsearch">
									<tr style="background: skyblue;color:black;">										
										...
										<th rowspan="2"  style="background: #000066; color: white;">Allocated <br><%=qty_unit_nm%></th>										
										<th rowspan="2">Physical Curve</th>
										<th rowspan="2">Financial Price Type</th>
										<th rowspan="2">Contract Price ($/<%=qty_unit_nm%>)</th>
										...
										<th rowspan="2"  style="background: #000066; color: white;" title="(Settle Price * Slope) + Constant"> Effective<br>Contract Price<br>($/<%=qty_unit_nm%>)</th>
