									...
									<table class="table table-bordered">
										...
										if(VL_REF_NO.size()!=0){ 
											...
											<tr>
												...
												<td align="right" title="Click to View Detail" onclick="showDetails('NET_USAGE','<%=clearance%>','<%=entity%>','<%=entity_cd%>','<%=limit_status%>','<%if(VCOUNTERPARTY_NAME.size()!=0){%><%=VCOUNTERPARTY_NAME.elementAt(0)%><%}%>','<%=VUSAGE.elementAt(i)%>');"><%=VNET_USAGE.elementAt(i) %></td>
												<td align="right" title="Click to View Detail" onclick="showDetails('USAGE','<%=clearance%>','<%=entity%>','<%=entity_cd%>','<%=limit_status%>','<%if(VCOUNTERPARTY_NAME.size()!=0){%><%=VCOUNTERPARTY_NAME.elementAt(0)%><%}%>','<%=VUSAGE.elementAt(i)%>');"><%=VUSAGE.elementAt(i) %></td>
