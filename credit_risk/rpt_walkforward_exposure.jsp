...
Vector VSEC_DIS_CONTRACT_TYPE = db_walkforward.getVSEC_DIS_CONTRACT_TYPE();
Vector VDIS_CONTRACT_TYPE = db_walkforward.getVDIS_CONTRACT_TYPE();
%>
<body>
					...
					<div class="table-responsive">
						<table class="table table-bordered">
							<thead>
								<tr>
									<th></th>
									<th colspan="4" align="center">Exposure Type</th>
							...
							<tbody>
								...
								<tbody class="body" id="body" style="display:none;">
									...
									<tr>
										<td></td>
										<td colspan="2"><div align="center" >Limit</div></td>
									...
									<%}%>
									<tr><td colspan="<%=VEXPOSURE_DT.size()+5%>"></td></tr>
								</tbody>
								<tr>
									<td align="right" valign="middle"><i id="expand1" class="fa fa-expand" onclick="showTableRow1()"></i></td>
									<td colspan="4"><b>Settlement Sell Open Credit (INR) <font color='blue'>(Cumulative)</font></b></td>
								...
								<tbody class="body1" id="body1" style="display:none;">
									...
									<tr>
										<td></td>
										<td><div align="left"><%=VCOUNTERPARTY_NM.elementAt(i)%></div></td>
										<% k=-1;
										...
										%>
										<td><div align="center"><%=VDIS_CONTRACT_TYPE.elementAt(i)%></div></td>
								...
								<tr>
									...
									<td colspan="4"><b>Settlement Sell Exposures (INR)</b></td>
								...
								<tbody class="body2" id="body2" style="display:none;">
									...
									<tr>
										...
										%>
										<td><div align="center"><%=VSEC_DIS_CONTRACT_TYPE.elementAt(i)%></div></td>
										<td><div align="center"><%=originalDealId%></div></td>
								...
								<tr>
									<td></td>
									<td colspan="4"><b>Available Credit (INR)</b></td>
