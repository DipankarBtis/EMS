...
function refresh()
{
	var report_dt = document.forms[0].rpt_dt.value;
						...
						<div class="col-sm-3 col-xs-3 col-md-3">
							<div class="form-group row">
								...
								<div class="col-auto">
		      						...
		      						<script>
										document.forms[0].rpt_dt.value="<%=report_dt%>"
									</script>
				    			</div>
							</div>
						</div>
					...
					<div class="row m-b-5">
      					<div class="table-responsive">
							<table class="table table-bordered">
								...
								if(count==0){%>
								<tr>
									<td colspan="15" align="center"><%=utilmsg.infoMessage("<b>Bank Limit Data Is Not Available!</b>") %></td>
								</tr>
								<%} %>
								</tbody>
							</table>
