					...
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<tbody>
								<tr>	
									<td></td>
									<td colspan="3" style="color:var(--tb_header_font_color);"><b>BG Value</b></td>
								...
								<tr>
									...
									<td colspan="3" style="color:var(--tb_header_font_color);"><b>Margin Used</b><br><span style="color:#000066;font-size:10px;text-transform: none;">*upto end of Exposure period</span>
									</td>
							    ...
							    { 
									...
									while (o1.hasNext()) 
									{
									    ...
									    <tr >
									    	...
									    	<td style="background:#f0f0f5;"><%=HLEGAL_ENTITY.get(keyNm1) %></td>
								...
								<tr>
									<td></td>
									<td colspan="3" style="color:var(--tb_header_font_color);"><b>Margin Available</b></td>
