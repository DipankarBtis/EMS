						...
						<table id="search_by_filter" class="table table-bordered" id="filterbysearch">
							<thead>
								<tr>
									...
									<th align="center">CO CODE<br><div align="center"><input class="form-control form-control-sm" type="text" id="company_code" onkeyup="Search(this,'1');" placeholder="Search.." style="width:100px"/></div></th>
									...
									<th align="center">CUSTOMER CATEGORY<br><div align="center"><input class="form-control form-control-sm" type="text" id="counterparty_category" onkeyup="Search(this,'5');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">TYPE OF INVOICE<br><div align="center"><input class="form-control form-control-sm" type="text" id="inv_type" onkeyup="Search(this,'6');" placeholder="Search.." style="width:100px"/></div></th>
									...
									<th align="center">ASSIGNMENT<br><div align="center"><input class="form-control form-control-sm" type="text" id="assignment" onkeyup="Search(this,'15');" placeholder="Search.." style="width:100px"/></div></th>
									<th align="center">TYPE<br><div align="center"><input class="form-control form-control-sm" type="text" id="cont_type" onkeyup="Search(this,'16');" placeholder="Search.." style="width:100px"/></div></th>
