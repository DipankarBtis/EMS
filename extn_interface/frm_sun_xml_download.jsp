...
function refresh()
{
	...
	if(flag==true)
	{
		var url = "../extn_interface/frm_sun_xml_download.jsp?u="+u+
...
accounting.setCallFlag("INVOICE_SUN_XML_DOWNLOAD");
					...
					<div class="row">
						<div class="table-responsive">
							<table class="table table-bordered table-hover" id="example">
									...
									<%if(VINVOICE_NO.size()>0){%>
										<%for(int i=0; i<VINVOICE_NO.size();i++){%>
											<tr>
												...
												<td></td>
												<td></td>
												<%if(VJOURNAL_TYPE.elementAt(i).equals("FMSSL")){%>
								...
								<%}else{%>
									<tr>
											<td colspan="33" align="center"><%=utilmsg.infoMessage("<b>No Files available for download!</b>") %></td>
									</tr>
								<%} %>
								</tbody>
							</table>
