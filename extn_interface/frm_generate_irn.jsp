...
function refresh()
{
	...
	var url = "../extn_interface/frm_generate_irn.jsp?&u="+u+"&month="+month+"&year="+year+"&invoice_type="+invoice_type;
...
function doUploadExcel()
{
	...
	if(upload_file.includes(".xlsx"))
	{
		...
		if(a)
		{
			document.forms[0].option.value="UPLOAD_RESPONSE_IRN_EXCEL";
			document.getElementById("loading").style.visibility = "visible";
			document.forms[0].submit();
		}	
	}
...
irn_gen.setCallFlag("INVOICE_LIST_FOR_IRN_GEN");
											...
											<div class="col-auto">
								  			...
								  			<div class="col">
								  				<select class="form-select form-select-sm" name="invoice_type" onchange="refresh();">
													...
													<option value="TLU">TLU Charges (TLU)</option>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group row">
										<div class="col-auto">
							  			...
							  			<div class="col">
							  				<a id="multisheetIcon" href = "../work_data<%=owner_cd%>/IRN_EXCEL/Generated/<%=file_nm%>"><%=file_nm%>&nbsp;<i class="fa fa-arrow-circle-down fa-lg"></i></a>
							  			</div>
							  		</div>
							  	</div>
							</div>
...
<input type="hidden" name="option" value="GENERATE_EXCEL_FOR_IRN">
