...
function generateSunXML()
{
	...
	if(flag==true)
	{
		var a=confirm("On your Re-Approval SUN XML will be generated!\n\nDo you want to Proceed and Generate SUN XML?");
		if(a)
		{
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="card cardmain">
				...
				<div class="card-footer cdfooter d-flex justify-content-center">
					 <div >
					 	<input type="button" class="btn btn-warning com-btn" value="Re-Approve" onclick="generateSunXML();">
					 </div>
				</div>
			</div>
		</div>
