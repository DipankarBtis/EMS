...
function refresh()
{
	...
	if(flag==true)
	{
		var url = "../extn_interface/frm_sales_sun_xml_generation.jsp?u="+u+
...
accounting.setCallFlag("INVOICE_SUN_XML_GENERATION");
...
<input type="hidden" name="option" value="GENERATE_SUN_XML">
