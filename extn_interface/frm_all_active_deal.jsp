...
<jsp:useBean class="com.etrm.fms.extn_interface.DataBean_sf_interface" id="db_intrface" scope="request"></jsp:useBean>
...
Vector VCONT_SF_NO =  db_intrface.getVCONT_SF_NO();
...
Vector VSF_ROW_COLOR =  db_intrface.getVSF_ROW_COLOR();
								...
								<div class="form-group row">
									...
									<%-- <div class="col-auto">
										<div class="input-group input-group-sm" >
						      				...
						      				onchange="validateDate(this);refresh();" style="">
						      				<span class="input-group-text"><i class="fa fa-calendar fa-lg"></i></span>
															...
															<tbody>
																<%if(VCOUNTERPARTY_CD.size()>0 && index>0){
																	...
																	for(l=l; l<VCOUNTERPARTY_CD.size();l++){
																		k+=1;%>
																	<tr style="background:<%=VSF_ROW_COLOR.elementAt(l)%>"
																		<%if(VSF_ROW_COLOR.elementAt(l).equals("#f2f2f2")){ %>title="Purchased MMBTU is not mapped for contract."<%}%>>
																		<td align="center">
																			<div align="center">
																		...
																		<td align="center"><%=VCONT_NO.elementAt(l) %><br>(<%=VCONT_SF_NO.elementAt(l)  %>)</td>
